    ...
    >
      ...
      >
        <div className="p-8 lg:p-12">
          ...
          {/* Cookie Categories — CSS height transition */}
          <div
            className="overflow-hidden mb-8 transition-all duration-300 ease-in-out"
      ...
      {/* Keyframe animations injected inline — avoids adding to global CSS */}
      <style>{`
