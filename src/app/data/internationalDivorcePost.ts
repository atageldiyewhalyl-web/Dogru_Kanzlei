...
export const internationalDivorcePost: BlogPost = {
...
Uluslararası boşanma davaları ve tanıma-tenfiz süreçleri bizim uzmanlık alanımızdır. Davanızı Türkiye'deki mahkemeler nezdinde bizzat takip ediyoruz.`,
  ...
  metaTitleDE: "Internationale Scheidungsverfahren - Was Sie wissen müssen | Doğru Kanzlei",
  metaTitleTR: "Uluslararası Boşanma Davalarında Bilinmesi Gerekenler | Doğru Kanzlei",
  metaDescriptionDE: "Eine Scheidung zwischen Deutschland und der Türkei ist rechtlich komplex. Wir erklären Zuständigkeiten und die Anerkennung nach türkischem Recht.",
  metaDescriptionTR: "Almanya ve Türkiye arasındaki boşanma süreçleri hukuken karmaşıktır. Yetkili mahkemeler ve tanıma-tenfiz konularını Türk hukukuna göre açıklıyoruz.",
  faqDE: [
    {
      question: "Gilt ein deutsches Scheidungsurteil in der Türkei automatisch?",
      answer: "Nein. Damit ein in Deutschland ausgesprochenes Scheidungsurteil in der Türkei rechtliche Wirkung entfaltet, muss vor einem türkischen Gericht ein Anerkennungs- und Vollstreckbarerklärungsverfahren (Tanıma ve Tenfiz) durchgeführt werden."
    },
    {
      question: "Das Anerkennungsverfahren (Tanıma-Tenfiz) in der Türkei",
      answer: "In der Türkei sind seit 2017 Verfahren zur Anerkennung ausländischer Urteile teilweise auch über die Bevölkerungsämter möglich, sofern beide Parteien gemeinsam erscheinen. Ist dies nicht der Fall, muss die Klage vor einem türkischen Familiengericht erhoben werden."
    },
    {
  ...
  faqTR: [
    {
      question: "Almanya'da verilen boşanma kararı Türkiye'de otomatik geçerli mi?",
      answer: "Hayır. Almanya'da verilen bir boşanma kararının Türkiye'de hukuki sonuç doğurabilmesi için Türk mahkemelerinde tanıma ve tenfiz davası açılması veya idari tanıma sürecinin işletilmesi gerekir."
    },
    {
      question: "Tanıma ve tenfiz için hangi belgeler gerekir?",
      answer: "Boşanma kararının aslı veya onaylı örneği, kesinleşme belgesi, apostil ve onaylı Türkçe tercüme gerekir."
    },
    {
      question: "Mal paylaşımı ve nafaka hangi hukuka göre değerlendirilir?",
      answer: "Türkiye'de yürüyen boşanma ve bağlantılı talepler Türk Medeni Kanunu ve ilgili milletlerarası özel hukuk kurallarına göre değerlendirilir."
    }
  ],
