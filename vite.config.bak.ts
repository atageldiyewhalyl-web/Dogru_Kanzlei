  ...
  plugins: [
    ...
    prerender({
      routes: [
        ...
        '/en/services/power-of-attorney-apostille',
        '/en/services/immigration-law',
        '/en/services/criminal-law',
        '/en/services/recognition-and-enforcement',
        '/en/services/blue-card',
        '/en/services/debt-collection-enforcement',
        '/en/services/inheritance-law',
        '/en/services/child-custody',
        '/en/services/real-estate-law',
        '/en/blog',
        ...
        '/en/blog/certificate-of-inheritance-turkey-how-to-get',
        '/en/blog/blue-card-turkey-inheritance-property-rights',
        '/en/blog/criminal-defense-turkey-from-germany',
        '/en/blog/debt-collection-germany-turkey-enforcement',
        '/en/blog/joint-custody-germany-turkey-enforcement',
        '/en/blog/inheritance-fraud-turkey-deed-cancellation',
        '/en/blog/divorce-germany-turkey-property-division',
        '/en/blog/inheritance-law-guide-turkey',
        '/en/blog/international-divorce-guide',
        '/en/blog/real-estate-rights-turkey',
        '/en/blog/recognition-enforcement-guide-turkey',
        '/en/blog/reserved-portion-reduction-lawsuit-turkey',
        '/en/blog/partition-lawsuit-turkey-property',
        '/en/blog/blue-card-rights-guide-turkey',
        '/en/blog/power-of-attorney-guide-germany-turkey',
        '/en/blog/summons-arrest-warrant-turkey',
        '/en/blog/criminal-complaint-turkey-guide',
        '/en/blog/divorce-guide-turkey',
        '/en/blog/divorce-lawyer-mannheim',
        '/en/blog/family-law-consultation-mannheim',
        '/en/blog/custody-lawyer-mannheim',
        '/en/blog/power-of-attorney-turkish',
        '/en/blog/tenant-law-mannheim',
        '/en/blog/travel-to-turkey-with-child-custody',
        '/en/blog/cost-of-turkish-law-lawyer',
        '/en/blog/turkish-will-in-germany',
        '/en/blog/divorce-turkey-duration-cost',
        '/en/blog/turkish-lawyer-mannheim-initial-consultation',
        '/en/privacy-policy',
        '/en/legal-notice',
      ],
