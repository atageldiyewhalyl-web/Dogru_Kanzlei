const o="/assets/blog_real_estate-CL2cxqrQ.avif",g="/assets/blog_veraset_ilami-2vuU_Aue.avif",r="/assets/blog_tanima_tenfiz-Bzl2Hm9Z.avif",b="/assets/blog_sakli_pay-CaDzDHL-.avif",y="/assets/blog_izale_i_suyu-B4HRTQAe.avif",f="/assets/blog_mavi_kart-C7k2Yvnk.avif",v="/assets/blog_criminal_summons-CD-hbMQC.avif",z="/assets/blog_criminal_complaint-lS_-gF0E.avif",t="/assets/blog_divorce-CA3VfhUH.avif",s="/assets/blog_vekaletname-B29lN8at.avif",T="/assets/blog_property_division-DPIjs0hp.avif",a="/assets/inheritance_fraud_law-BP6Tta1T.avif",l="/assets/joint_custody_law-CcyZclRo.avif",p="/assets/debt_collection_law-aboYjGlf.avif",m="/assets/criminal_defense_law-wki5Ahfo.avif",w="/assets/blue_card_rights_law-DK8e4Lqn.avif",e="/assets/criminal_defense_turkey-DF8Mxh2l.avif",A={slug:"muris-muvazaasi-erbrecht-tuerkei-tapu-iptal-klage",slugDE:"muris-muvazaasi-erbrecht-tuerkei-tapu-iptal-klage",slugTR:"mirastan-mal-kacirma-muris-muvazaasi-tapu-iptal",slugEN:"muris-muvazaasi-inheritance-fraud-turkey-property-cancellation",titleDE:"Muris Muvazaası: Tapu-Iptal-Klage aus Deutschland",titleTR:"Mirastan Mal Kaçırma (Muris Muvazaası): Almanya'dan Tapu İptal Davası Rehberi (2026)",titleEN:"Muris Muvazaası: When Turkish Heirs Abroad Lose Their Inheritance — Property Cancellation, the Blue Card Trap, and Bank Account Abuse (2026)",excerptDE:"Ihr Elternteil ist verstorben. Beim Blick ins türkische Grundbuch stellen Sie fest: Die Immobilie gehört längst einem Geschwisterteil — übertragen noch zu Lebzeiten, angeblich durch Verkauf. Tatsächlich floss nie ein Kaufpreis. Was können Sie aus Deutschland tun?",excerptTR:`Ebeveynleriniz Türkiye'deki taşınmazı vefatından önce kardeşinize "sattı" mı — ama hiç para el değiştirmedi mi? Bu rehber, mirastan mal kaçırma davası nedir, nasıl ispatlanır ve Türkiye'ye gitmeden nasıl açılır sorularını yanıtlıyor.`,excerptEN:"A Turkish parent transferred the family property to one sibling before death — but no money ever changed hands. Turkish law lets you challenge this. Here is how to file from Germany without travelling to Turkey.",metaTitleDE:"Muris Muvazaası: Wenn Erben ihr türkisches Erbe verlieren — Tapu Iptal Klage 2026",metaTitleTR:"Mirastan Mal Kaçırma (Muris Muvazaası): Tapu İptal Davası Rehberi 2026",metaTitleEN:"Muris Muvazaası: Inheritance Fraud & Property Cancellation in Turkey — 2026 Guide",metaDescriptionDE:"Elternteil hat die Immobilie in der Türkei vor dem Tod auf ein Geschwisterteil übertragen? Muris Muvazaası-Klage aus Deutschland — Grundbuchsperre, Beweise, direkte Vertretung.",metaDescriptionTR:"Ebeveynleriniz Türkiye'deki evi kardeşinize sattı mı? Mirastan mal kaçırma (muris muvazaası) davası ile tapu iptali sağlanabilir. Almanya'dan avukata gerek yok.",metaDescriptionEN:"Did a Turkish parent transfer property to one sibling before death — with no real payment? Muris muvazaası law lets you reclaim it. File from Germany. No travel needed.",ogDescriptionDE:"Elternteil hat die türkische Immobilie vor dem Tod auf ein Geschwisterteil übertragen? Grundbuchsperre, Klage und direkte Vertretung aus Deutschland.",ogDescriptionTR:"Ebeveynleriniz Türkiye'deki evi kardeşinize sattı mı? Mirastan mal kaçırma davası ile tapu iptali sağlanabilir. Almanya'dan tam temsil.",ogDescriptionEN:"Did a Turkish parent transfer property to one sibling before death with no real payment? Muris muvazaası law lets you reclaim it. File from Germany — no travel needed.",schemaHeadlineDE:"Muris Muvazaası: Wenn Erben in Deutschland um ihr türkisches Erbe betrogen werden — Tapu Iptal Davası, Mavi-Kart-Falle und Bankkonto-Missbrauch",schemaHeadlineTR:"Mirastan Mal Kaçırma (Muris Muvazaası): Tapu İptal ve Tescil Davası Rehberi 2026",schemaHeadlineEN:"Muris Muvazaası: Inheritance Fraud and Property Cancellation in Turkey — Complete Guide 2026",schemaDescriptionDE:"Elternteil hat die türkische Immobilie vor dem Tod auf ein Geschwisterteil übertragen? Grundbuchsperre, Klage und direkte Vertretung aus Deutschland.",schemaDescriptionTR:"Ebeveynleriniz Türkiye'deki evi kardeşinize sattı mı? Mirastan mal kaçırma davası ile tapu iptali sağlanabilir. Almanya'dan tam temsil.",schemaDescriptionEN:"Did a Turkish parent transfer property to one sibling before death with no real payment? Muris muvazaası law lets you reclaim it. File from Germany — no travel needed.",articleAuthor:"Av. Hasan Doğru",articleSectionDE:"Erbrecht",articleSectionTR:"Miras Hukuku",articleSectionEN:"Inheritance Law",articleTagsDE:["Muris Muvazaası","Tapu Iptal","Türkisches Erbrecht"],articleTagsTR:["muris muvazaası","tapu iptal davası","mirastan mal kaçırma"],articleTagsEN:["muris muvazaasi","inheritance fraud Turkey","tapu iptal"],exactHreflangs:!0,exactSchema:!0,schemaImage:"https://www.hasandogru.de/assets/inheritance_fraud_law-BxjZQ9m1.png",contentDE:`> *Dieser Artikel befasst sich ausschließlich mit dem türkischen Recht. Die Doğru Kanzlei berät gemäß § 207 BRAO ausschließlich im türkischen Recht.*

---

Ihr Elternteil ist verstorben. Die Nachricht erreicht Sie in Mannheim, Köln oder Hamburg — und gleichzeitig die erste Ahnung, dass mit dem Erbe in der Türkei etwas nicht stimmt. Ein Anruf bei einem Verwandten bestätigt den Verdacht: Das Haus in Ankara, das Grundstück in Izmir, die Wohnung in Istanbul — alles ist längst auf den Namen eines Geschwisterteils übertragen. Angeblich verkauft, vor Jahren. Kein Kaufpreis wurde je besprochen, kein Geld jemals gezahlt.

Sie sind Erbe. Aber das türkische Grundbuch sagt etwas anderes.

Dieses Szenario wiederholt sich jedes Jahr tausende Male in der türkisch-deutschen Diaspora. Im türkischen Recht gibt es dafür einen präzisen Begriff: **Muris Muvazaası** — die Erblasser-Kollusion, im Volksmund auch **Mirastan Mal Kaçırma** (Mirasentzug durch Scheinübertragung). Und das türkische Recht gibt Ihnen ein wirksames Mittel dagegen: die **Tapu İptal ve Tescil Davası** — die Grundbuchberichtigungsklage. Diese Klage können Sie aus Deutschland führen, ohne auch nur einmal in die Türkei zu reisen.

---

## Was ist Muris Muvazaası?

Der Begriff Muris Muvazaası bezeichnet eine Scheinübertragung von Vermögen durch den Erblasser zu Lebzeiten mit dem Ziel, bestimmte Erben zu benachteiligen. Das typische Muster: Der Erblasser überträgt eine Immobilie an ein bevorzugtes Kind. Im Grundbuch wird ein Kaufvertrag eingetragen. Tatsächlich handelt es sich nicht um einen echten Verkauf, sondern um eine verdeckte Schenkung. Ein Kaufpreis wird entweder gar nicht oder nur zum Schein gezahlt.

Dieses Phänomen ist in der türkischen Gesellschaft so verbreitet, dass der Yargıtay (türkisches Bundesgericht) bereits 1974 eine Grundsatzentscheidung getroffen hat, die bis heute für alle Gerichte bindend ist: **Yargıtay İçtihadı Birleştirme Kararı 01.04.1974, E. 1974/1, K. 1974/2**.

**Weitere Rechtsgrundlagen:**
- TBK Art. 19 (Muvazaa — allgemeine Scheingeschäftsregelung)
- TMK Art. 1023 (Gutgläubiger Erwerb — Grenze der Anfechtbarkeit bei Kettenverkauf)
- HMK Art. 12 (ausschließliche örtliche Zuständigkeit am Ort der Immobilie)
- TBK Art. 49 (Schadensersatz bei unerlaubter Handlung)
- TCK Art. 155 (Güveni Kötüye Kullanma — Untreue)
- Yargıtay HGK 2010/1-295 (Erben als Dritte — freie Beweisführung)

---

## Warum die Diaspora besonders betroffen ist

In der Kanzleipraxis zeigt sich ein klares Muster: Muris Muvazaası betrifft überproportional häufig Familien, bei denen Erben in Deutschland leben. Die Gründe sind strukturell:

**Räumliche Distanz:** Wer in Mannheim lebt, kann die Vermögensbewegungen in Ankara nicht überwachen. Der Erblasser wird vom in der Türkei lebenden Kind beeinflusst — oft über Jahre hinweg, schleichend.

**Informationsdefizit:** Viele Auslandstürken kennen die Grundbuchverhältnisse ihrer Eltern nicht. Das türkische Tapu-System (Grundbuchsystem) ist für in Deutschland aufgewachsene Erben oft ein unbekanntes Terrain.

**Familiärer Druck:** Das in der Türkei lebende Kind argumentiert mit Pflegeleistungen für das Alter des Elternteils. Dies erzeugt emotionalen Druck auf den Erblasser — und liefert im Streitfall eine Schutzbehauptung.

**Spätes Erfahren:** Der in Deutschland lebende Erbe erfährt erst nach dem Todesfall, dass die Immobilie längst übertragen wurde. Dann beginnt der Wettlauf gegen die Zeit — und gegen das Risiko des Kettenverkaufs.

> ⚠️ **Wichtig:** Sobald Sie vom Todesfall erfahren, prüfen Sie umgehend den türkischen Grundbuchstand. Ein türkischer Avukat kann über UYAP den aktuellen Eigentümer in wenigen Stunden feststellen. Jeder verlorene Tag erhöht das Risiko eines Weiterverkaufs an gutgläubige Dritte.

---

## Die Mavi-Kart-Falle: Wenn der Statuswechsel zum Problem wird

Ein in der Praxis häufig übersehenes Problem betrifft Erben mit **Mavi Kart** (5901 SK Art. 28): ehemalige türkische Staatsangehörige, die die deutsche Staatsbürgerschaft erworben und dabei die türkische aufgegeben haben.

**Was die Mavi Kart garantiert:** Mavi-Kart-Inhaber haben grundsätzlich dieselben erbrechtlichen Ansprüche wie türkische Staatsbürger. Sie können erben, Immobilien besitzen, Bankkonten führen und vor türkischen Gerichten klagen.

**Problem 1 — Nüfus-Register nicht aktualisiert:** Wenn der Mavi-Kart-Status nicht korrekt im türkischen Personenstandsregister (Nüfus Müdürlüğü) erfasst ist, verweigern Gerichte und Banken die Kooperation. In der Zwischenzeit kann der in der Türkei lebende Erbe allein den Erbschein (Veraset İlamı) beantragen und die Immobilie auf sich übertragen lassen.

**Problem 2 — Verzögerungstaktik der Gegenseite:** In streitigen Erbfällen bestreitet die Gegenseite die Klageberechtigung des Mavi-Kart-Inhabers und beantragt zusätzliche Statusnachweise. Das kostet Monate — Monate, in denen die Immobilie weiterverkauft werden kann.

**Problem 3 — Bankzugang:** Türkische Banken verlangen von Mavi-Kart-Inhabern umfangreiche Zusatzdokumente. Während der Diaspora-Erbe Unterlagen beschafft, hat der in der Türkei lebende Erbe das Konto bereits geleert.

**Lösung — vorausschauend handeln:** Stellen Sie sicher, dass Ihr Mavi-Kart-Status korrekt im türkischen Personenstandsregister eingetragen ist. Prüfen Sie regelmäßig den Grundbuchstand Ihrer Eltern. Konsultieren Sie einen Avukat, bevor der Erbfall eintritt, wenn Sie Unregelmäßigkeiten ahnen.

---

## Beweisführung: Wie Muris Muvazaası nachgewiesen wird

Der Kläger muss die Muvazaa nachweisen. Gemäß Yargıtay HGK 2010/1-295 sind Erben als Dritte von der Urkundenbindung befreit und können mit **allen** Beweismitteln arbeiten.

Der Yargıtay 1. Hukuk Dairesi prüft in ständiger Rechtsprechung folgende Indizien:

| Indiz | Beispiel aus der Praxis |
|---|---|
| Auffallendes Kaufpreis-Marktwert-Missverhältnis | Haus im Wert von €150.000, eingetragener Kaufpreis €15.000 |
| Fehlende wirtschaftliche Fähigkeit des Käufers | Empfänger war zu diesem Zeitpunkt arbeitslos oder verschuldet |
| Weiteres Bewohnen durch den Erblasser | Elternteil blieb bis zum Tod in der übertragenen Wohnung |
| Enge Familienbeziehung | Übertragung an Kind oder Enkel |
| Auslandserben als Benachteiligungsindiz | Geschwister lebt in Deutschland, hat keinen Überblick über türkische Vermögensverhältnisse |
| Höheres Alter oder Krankheit des Erblassers | Übertragung erfolgte in gesundheitlich schwacher Phase |
| Fehlende wirtschaftliche Notwendigkeit | Kein erkennbarer Grund für den Verkauf zu diesem Zeitpunkt |

**Verfügbare Beweismittel:** Sachverständigengutachten zum Grundstückswert, Kontoauszüge und Zahlungsbelege (Nachweis, dass kein Kaufpreis geflossen ist), Zeugenaussagen (Nachbarn, Verwandte, Freunde), Familienkorrespondenz (Nachrichten, Briefe, E-Mails), Gesundheitsunterlagen des Erblassers.

**Praxistipp:** Drei bis vier dieser Indizien gelten dem Yargıtay als ausreichend für eine stattgebende Entscheidung. Je mehr zusammenkommen, desto stärker die Beweislage.

---

## Sofortmaßnahme: Ihtiyati Tedbir (Grundbuchsperre)

Die wichtigste erste Maßnahme ist die **Ihtiyati Tedbir** — eine einstweilige Verfügung, die das türkische Grundbuch für die Dauer des Verfahrens sperrt und verhindert, dass die Immobilie an gutgläubige Dritte weiterverkauft wird (HMK Art. 389–399).

**Warum ist sie so dringend?** Das Hauptverfahren dauert in der Regel 1,5 bis 2 Jahre in der ersten Instanz, weitere 1 bis 1,5 Jahre in der Berufung. In dieser Zeit kann die Immobilie weiterverkauft werden. Erwirbt ein Dritter die Immobilie gutgläubig (TMK Art. 1023), wird die Klage erheblich schwieriger — in manchen Fällen praktisch unmöglich.

**Wie wird sie beantragt?** Der Antrag wird beim Asliye Hukuk Mahkemesi am Ort der Immobilie gestellt. Erforderlich sind: Sterbeurkunde des Erblassers, Nachweis der Erbenstellung (Erbschein oder vorläufige Bescheinigung), Grundbuchauszug und Darlegung der Dringlichkeit. Das Gericht entscheidet in der Regel innerhalb von 1–3 Werktagen.

**Der entscheidende Punkt:** Die Ihtiyati Tedbir kann auch beantragt werden, bevor die Hauptklage eingereicht wird — und sogar bevor ein vollständiger Erbschein vorliegt.

> ⚠️ **Wichtig:** Beantragen Sie die Ihtiyati Tedbir sofort nach dem Todesfall, wenn Sie einen Verdacht auf Muvazaa haben. Jeder Tag Verzögerung ist ein Tag, an dem die Immobilie weiterverkauft werden kann.

---

## Kettenverkauf: Wenn die Immobilie bereits weiterverkauft wurde

Ein besonders tückisches Szenario: Der Erbe, der die Immobilie durch Muvazaa erhalten hat, verkauft sie anschließend an einen Dritten weiter — oft bewusst, um die Anfechtbarkeit zu erschweren.

Der Yargıtay 1. Hukuk Dairesi hat in ständiger Rechtsprechung klargestellt: Wenn der Dritte zum Zeitpunkt des Erwerbs **nicht gutgläubig** war — d.h. er wusste oder hätte wissen müssen, dass ein Erbstreit bestand —, ist auch die Weiterübertragung anfechtbar.

Indizien gegen Gutgläubigkeit: Der Dritte ist Verwandter des Beklagten. Die Übertragung erfolgte zu einem auffällig niedrigen Preis. Der Dritte ist Geschäftspartner des Beklagten. Die Übertragung erfolgte kurz nach dem Todesfall oder während eines laufenden Verfahrens.

Dies ist genau der Grund, warum die **Ihtiyati Tedbir sofort beantragt werden muss** — bevor ein Kettenverkauf stattfinden kann.

---

## Die zweite Front: Bankkonto des Erblassers

Muris Muvazaası beschränkt sich selten auf Immobilien. In vielen Fällen hat der bevorzugte Erbe auch Zugang zu Bankkonten des Erblassers und räumt diese vor oder unmittelbar nach dem Todesfall leer.

**Zivilrechtlicher Weg — Schadensersatz (TBK Art. 49):** Der geschädigte Erbe kann eine Schadensersatzklage wegen unerlaubter Handlung (Haksız Fiil) erheben. Der Anspruch umfasst den Betrag, der dem Kläger nach seiner Erbquote zugestanden hätte.

**Strafrechtlicher Weg — Untreue (TCK Art. 155):** Wenn der Erbe eine Kontovollmacht oder den Kontozugang missbraucht hat, liegt Güveni Kötüye Kullanma (Untreue) nach TCK Art. 155 vor. Die Strafanzeige wird über den Avukat bei der zuständigen Cumhuriyet Başsavcılığı eingereicht.

**Strategie:** In der Praxis werden beide Wege parallel beschritten. Die Strafanzeige erzeugt erheblichen Druck auf die Gegenseite und bewegt sie häufig zu einer außergerichtlichen Einigung — was das Gesamtverfahren beschleunigt und günstiger macht.

---

## Typischer Praxisfall (anonymisiert)

Eine Mandantin aus Stuttgart erfuhr drei Wochen nach dem Tod ihrer Mutter, dass das Elternhaus in Ankara bereits seit sechs Jahren auf den Namen ihres Bruders eingetragen war. Im Grundbuch stand ein Kaufvertrag über einen Betrag, der einem Viertel des tatsächlichen Marktwertes entsprach. Bankbelege für eine Kaufpreiszahlung gab es nicht. Die Mutter hatte bis zu ihrem Tod in dem Haus gewohnt.

Erste Maßnahme: Ihtiyati Tedbir — Grundbuchsperre — wurde innerhalb von 24 Stunden beantragt und zwei Tage später vom Gericht bewilligt.

In der anschließenden Tapu-İptal-Klage wurden vier Yargıtay-Indizien dokumentiert: Kaufpreis-Marktwert-Missverhältnis von 4:1, fehlende Zahlungsbelege, weiteres Bewohnen durch die Erblasserin bis zum Tod, und ein Zeuge, der die Überredung der Mutter bestätigte.

Das erstinstanzliche Gericht gab der Klage statt. Die Mandantin hatte die Türkei während des gesamten Verfahrens kein einziges Mal betreten.

---

## Doğru Kanzlei: Direkte Vertretung — keine Kooperationspartner
...
[Mirastan Mal Kaçırma (Muris Muvazaası): Tapu İptal Davası Rehberi →](/tr/blog/mirastan-mal-kacirma-muris-muvazaasi-tapu-iptal)

Und auf Englisch:
[Muris Muvazaası: Inheritance Fraud and Property Cancellation in Turkey →](/en/blog/muris-muvazaasi-inheritance-fraud-turkey-property-cancellation)
...
**Was ist Muris Muvazaası?**
Eine Scheinübertragung von Immobilien durch den Erblasser zu Lebzeiten, bei der im Grundbuch ein Kaufvertrag steht, tatsächlich aber keine Gegenleistung floss. Erben können diese Übertragung per Tapu-İptal-Klage anfechten — ohne Verjährungsfrist.

**Gibt es eine Verjährungsfrist?**
Nein. Aber je länger gewartet wird, desto größer das Risiko eines Kettenverkaufs und desto mehr Beweise gehen verloren.

**Kann ich ohne Reise in die Türkei klagen?**
Ja. Eine notarielle Vollmacht (Vekaletname) genügt. Die Doğru Kanzlei führt das Verfahren direkt aus Deutschland.

**Was ist die Ihtiyati Tedbir?**
Die türkische Grundbuchsperre — eine einstweilige Verfügung, die verhindert, dass die Immobilie während des Verfahrens weiterverkauft wird. Sofort nach dem Todesfall zu beantragen.

**Wie wird Muvazaa bewiesen?**
Mit Sachverständigengutachten, Kontoauszügen, Zeugen und Familienkorrespondenz. Drei bis vier Yargıtay-Indizien gelten als ausreichend.

**Was ist die Mavi-Kart-Falle?**
Mavi-Kart-Inhaber haben dieselben Erbrechte wie türkische Staatsbürger — aber wenn ihr Status im Nüfus-Register nicht korrekt erfasst ist, nutzt die Gegenseite das als Verzögerungstaktik.

**Was wenn das Konto schon geleert wurde?**
Zivilrechtlich: Schadensersatzklage nach TBK Art. 49. Strafrechtlich: Strafanzeige nach TCK Art. 155. Beide Wege parallel — der Strafweg erzeugt oft den entscheidenden Druck zur Einigung.

**Was wenn die Immobilie schon verkauft wurde?**
Wenn der Dritte nicht gutgläubig war, ist auch der Kettenverkauf anfechtbar. Deshalb ist die Grundbuchsperre so dringend.

---

> *Dieser Artikel befasst sich ausschließlich mit dem türkischen Recht. Die Doğru Kanzlei berät gemäß § 207 BRAO ausschließlich im türkischen Recht.*`,contentTR:`> *Bu makale yalnızca Türk hukukuna ilişkin genel bilgi amaçlıdır. Doğru Kanzlei, §207 BRAO kapsamında yalnızca Türk hukuku konularında danışmanlık vermektedir.*

---

Anneniz ya da babanız vefat etti. Türkiye'deki aile evini sormak için Tapu Müdürlüğü'ne başvurdunuz ya da bir yakınınızdan öğrendiniz: ev, yıllarca önce kardeşinizin üzerine geçmiş. Tapuda bir satış belgesi var. Ama aile içinde kimse bu satıştan haberdar değildi — ve para hiç el değiştirmedi.

Almanya'dasınız. Ne yapacağınızı bilmiyorsunuz. Ve her geçen gün o ev, bir başkasına satılıyor olabilir.

Bu senaryo, Almanya'daki Türk diasporasında yılda binlerce kez yaşanmaktadır. Türk hukukunda buna **muris muvazaası** — halk dilinde **mirastan mal kaçırma** — denir. Ve Türk hukuku, bu durumu düzeltmek için güçlü bir hukuki araç sunmaktadır: **tapu iptal ve tescil davası**. Bu davayı Türkiye'ye gitmeden, Almanya'dan açmak mümkündür.

---

## Muris Muvazaası Nedir?

Muris muvazaası, bir kişinin hayattayken bazı mirasçılarını zarara uğratmak amacıyla gerçekte bağış niteliğindeki bir taşınmaz devrini, tapuda satış olarak göstermesidir. Yargıtay İçtihadı Birleştirme Kararı 01.04.1974, E.1974/1, K.1974/2 bu konudaki temel içtihattır ve bugün hâlâ tüm mahkemeler için bağlayıcıdır.

Tipik örüntü şöyledir: Erblasser (muris), tapuda bir satış sözleşmesiyle taşınmazı bir çocuğuna devreder. Belgeler eksiksizdir. Ama gerçekte hiçbir satış bedeli ödenmez — ya da sembolik, piyasa değerinin çok altında bir bedel ödenir. Asıl amaç, Türkiye'de yaşayan çocuğu kayırmak ve Almanya'daki ya da uzakta yaşayan diğer mirasçıları dışlamaktır.

**Yasal dayanaklar:**
- Yargıtay İBK 01.04.1974 E.1/K.2 — muris muvazaasında temel içtihat
- TBK m. 19 — muvazaanın genel hükmü
- TMK m. 1023 — iyi niyetli üçüncü kişi koruması ve sınırları
- HMK m. 12 — taşınmazın bulunduğu yer mahkemesinin kesin yetkisi
- Yargıtay HGK 2010/1-295 — mirasçıların senet sınırlamasından bağımsız her türlü delille ispat hakkı

---

## Neden Diaspora Özellikle Etkileniyor?

Kanzlei pratiğimizde açık bir örüntü görüyoruz: Muris muvazaası, mirasçılardan biri ya da birkaçı Almanya'da yaşadığında orantısız biçimde sık ortaya çıkıyor.

**Mesafe ve gözetim açığı:** Mannheim'da yaşayan biri, Ankara'daki tapu hareketlerini izleyemez. Türkiye'de yaşayan çocuk, erblasseri yavaş yavaş etkisi altına alır.

**Bilgi eksikliği:** Almanya'da büyümüş pek çok kişi, ebeveynlerinin tapu sicilindeki durumu ile Türk tapu sistemini yeterince bilmez.

**Aile baskısı:** Türkiye'deki çocuk yaşlı ebeveyne bakım argümanını öne sürer. Bu, hem duygusal baskı yaratır hem de hukuki bir koz olarak kullanılır.

**Geç öğrenme:** Almanya'daki mirasçı, vefat haberini alır almaz taşınmazın çoktan başka birinin üzerine geçtiğini öğrenir. O anda başlar zaman yarışı.

> ⚠️ **Önemli:** Vefat haberini aldığınız anda tapu sicilini kontrol edin. UYAP veya e-Devlet üzerinden ya da bir avukat aracılığıyla taşınmazın kime kayıtlı olduğunu derhal öğrenin. Her geçen gün, taşınmazın üçüncü kişiye satılması riskini artırır.

---

## Mavi Kart Sahipleri İçin Özel Tuzak

Almanya'da Alman vatandaşlığına geçmiş ve Türk vatandaşlığından çıkmış kişiler, Mavi Kart (5901 Sayılı Kanun m. 28) alabilmektedir. Mavi Kart sahipleri, prensipte Türk vatandaşlarıyla aynı miras haklarına sahiptir: Türkiye'de taşınmaz edinebilir, veraset ilamı alabilir ve Türk mahkemelerinde dava açabilirler.

Ancak pratikte ciddi sorunlar ortaya çıkmaktadır:

**Sorun 1: Nüfus kaydının güncellenmemiş olması**
Vatandaşlık değişikliği Türk nüfus kaydına (Nüfus Müdürlüğü) doğru şekilde işlenmemişse, mahkemeler ve bankalar bu durumu ya reddeder ya da geciktirme gerekçesi olarak kullanır. Karşı taraf veraset ilamını önce alarak taşınmazı tek başına üzerine geçirebilir.

**Sorun 2: Karşı tarafın geciktirme taktiği**
Davalı avukatı, Mavi Kart sahibi davacının Türk vatandaşı olmadığını öne sürerek dava ehliyetini tartışmaya açar. Bu gereksiz itiraz aylar alır.

**Sorun 3: Bankalar ve Mavi Kart**
Türk bankaları, Mavi Kart sahiplerinden Türk vatandaşlarına kıyasla çok daha fazla ek belge ister. Siz belgelerinizi toplarken, Türkiye'deki mirasçı hesabı çoktan boşaltmış olur.

**Çözüm — Vefattan Önce:**
Mavi Kart statünüzü Türk nüfus kaydında doğru tescil ettirin. Ebeveynlerinizin tapu durumunu düzenli aralıklarla kontrol edin. Hukuki bir risk seziyorsanız, vefat öncesinde bir avukata danışın.

---

## Delil Stratejisi: Muvazaa Nasıl İspatlanır?

Yargıtay HGK 2010/1-295 kararına göre mirasçılar, senet sınırlamasından bağımsız olarak her türlü delille ispat yapabilir. Yargıtay 1. Hukuk Dairesi'nin yerleşik içtihadına göre aşağıdaki olgular muvazaaya işaret eder:

| Yargıtay İndisi | Pratik Örnek |
|---|---|
| Bedel-değer oransızlığı | Piyasa değeri 500.000 TL olan ev, 50.000 TL'ye satılmış |
| Alıcının ekonomik yetersizliği | Satın alan çocuğun o dönemde bu bedeli ödeyecek geliri yok |
| Erblasserin taşınmazda yaşamaya devam etmesi | Satıştan sonra da aynı evde ikamet etmeye devam etmiş |
| Yakın akraba ilişkisi | Satın alan kişi çocuk veya torun |
| Yurtdışında mirasçılar bulunması | Almanya'daki çocukların dışlanmak istenmesi |
| Erblasserin ileri yaşı veya hastalığı | Satış döneminde murisin sağlık durumu |
| Ekonomik zorunluluk yokluğu | Satış için somut bir finansal neden bulunmuyor |

**Pratik ipucu:** Bu olgulardan üç ya da dördü bir arada bulunduğunda Yargıtay tapu iptali için yeterli delil kabul etmektedir. Her birini belgeleyen bir dosya hazırlamak davanın can damarıdır.

Kullanılabilecek deliller: taşınmaz değerleme raporu (ekspertiz), banka hesap hareketleri ve ödeme dekontları, tanık beyanları (komşular, akrabalar, aile dostları), aile içi yazışmalar (mesaj ekranları, mektuplar), nüfus kayıtları ve sağlık belgeleri.

---

## Acil Adım: İhtiyati Tedbir (Tapu Blokesi)

Tapu iptal davasında en kritik ilk adım, taşınmazın dava sonuçlanmadan üçüncü kişilere satılmasını önleyen **ihtiyati tedbir** kararıdır (HMK m. 389-399).

İhtiyati tedbir neden bu kadar önemli? Dava 1,5 ile 3 yıl sürebilir. Bu süre içinde taşınmaz satılabilir. Satış iyi niyetli bir üçüncü kişiye yapılmışsa TMK m. 1023 kapsamında iptal davası çok daha güçleşir — neredeyse imkânsız hale gelir.

**İhtiyati tedbir nasıl alınır:**
Taşınmazın bulunduğu yerdeki Asliye Hukuk Mahkemesi'ne başvurulur. Vefat belgesi, mirasçılık belgesi veya veraset ilamı ve muvazaa şüphesini destekleyen deliller sunulur. Mahkeme kararı genellikle 1-3 iş günü içinde çıkar. Dava açılmadan önce bile talep edilebilir.

> ⚠️ **Önemli:** Muvazaa şüphesi varsa ihtiyati tedbiri vefatın hemen ardından, hatta dava açılmadan önce talep edin. Taşınmazın üçüncü kişiye devredildiğini öğrenir öğrenmez saatler içinde harekete geçin.

---

## Tapu İptal ve Tescil Davası

**Yetkili mahkeme:** Asliye Hukuk Mahkemesi (HMK m. 12 — kesin yetki, taşınmazın bulunduğu yer).

**Dava nasıl açılır:** Türkiye'ye gitmek zorunlu değildir. Almanya'da düzenlenecek bir vekaletname ile dava Almanya'dan tam olarak yürütülebilir.

**Talep:** Tapudaki sahte satışın iptali ve taşınmazın miras payı oranında mirasçı adına tescili.

**Süreç:** İlk derece mahkemesi ortalama 1,5-2 yıl. İstinaf 1-1,5 yıl. Yargıtay 1-2 yıl. Toplam potansiyel süre: 3-5 yıl. Bu nedenle ihtiyati tedbir olmadan dava açmak son derece risklidir.

**Kettenverkauf (zincir satış) durumu:** Taşınmaz bir üçüncü kişiye devredilmişse Yargıtay 1. Hukuk Dairesi'ne göre, üçüncü kişi iyiniyetli değilse — yakın akraba, iş ortağı veya düşük bedeldi ise — bu devir de iptal edilebilir. İhtiyati tedbir tam da bu riski bertaraf eder.

---

## İkinci Cephe: Banka Hesabının Boşaltılması

Muris muvazaası çoğu zaman yalnızca taşınmazla sınırlı kalmaz. Birçok davada, ölümden önce veya hemen sonra banka hesabı da boşaltılmaktadır.

**Hukuki yol — Tazminat:** TBK m. 49 kapsamında haksız fiil nedeniyle tazminat davası. Talep, miras payınıza düşen tutarı kapsar.

**Cezai yol — Suç duyurusu:** Hesap sahibi bir vekaletname veya hesap erişimini kötüye kullanmışsa TCK m. 155 kapsamında güveni kötüye kullanma (Untreue) suçu oluşur. Suç duyurusu avukat aracılığıyla ilgili Cumhuriyet Başsavcılığı'na yapılır.

**Strateji:** Her iki yol paralel yürütülür. Ceza davası çoğunlukla karşı tarafı uzlaşmaya iter — bu da sonucu hem hızlandırır hem de maliyeti düşürür.

---

## Tipik Praxis Vakası (Anonim)

Mannheim'da yaşayan Müvekkil A., annesinin vefatından iki ay sonra öğrendi: Ankara'daki aile taşınmazı, sekiz yıl önce, annesinin sağlığının hızla bozulduğu dönemde, Türkiye'de yaşayan kardeşinin adına geçirilmişti. Tapuda satış sözleşmesi vardı. Ama taşınmazın satış bedeli piyasa değerinin beşte biri kadardı ve hiçbir banka transferi kaydı bulunmuyordu.

Müvekkil, vefat haberini alır almaz Doğru Kanzlei'ye başvurdu. İlk adım: ihtiyati tedbir talebi. Mahkeme, tapu üzerine bloke koydu — o gün.

Ardından açılan tapu iptal ve tescil davasında; değerleme oransızlığı, alıcının o dönemki ekonomik yetersizliği ve annenin Türkiye'deki evde yaşamaya devam etmiş olması üç temel delil olarak sunuldu. Yargıtay içtihadı göz önünde bulundurularak karar, ilk derece mahkemesinde müvekkil lehine sonuçlandı.

Müvekkil, Türkiye'ye tek bir kez gitmedi.

---

## Mavi Kart Statüsünü Önceden Güvenceye Alın

Henüz miras uyuşmazlığınız başlamadıysa ama ebeveynleriniz yaşlı ya da hasta ise şimdi harekete geçin:

Türk nüfus kaydınızın güncel ve doğru olduğunu teyit edin. Mavi Kart belgenizin geçerliliğini kontrol edin. Ebeveynlerinizin taşınmazlarının kim adına kayıtlı olduğunu e-Devlet veya avukat aracılığıyla öğrenin. Bir sorun seziyorsanız, vefat öncesinde bir avukate danışın — bu, ileride çok daha büyük bir hukuki süreçten kaçınmanızı sağlayabilir.

---

## Doğru Kanzlei: Almanya'dan Doğrudan Temsil

Muris muvazaası davaları, Türk miras hukukunun en karmaşık ve maddi olarak en değerli davalarına girmektedir. Bir avukat gerektirir: Türk mahkemelerinde temsil yetkisine sahip, muvazaa delil stratejisine hâkim, acil durumlarda saatler içinde ihtiyati tedbir talebinde bulunabilen ve diasporanın — özellikle Mavi Kart sorunlarının — gerçekten ne anlama geldiğini anlayan biri.

[Doğru Kanzlei](https://www.hasandogru.de/tr/hizmetler), Ankara Barosu üyesi (Sicil No: 47068) ve Karlsruhe Rechtsanwaltskammer'a §207 BRAO kapsamında kayıtlı olarak, tapu iptal ve tescil davalarını ile tazminat ve suç duyurusu süreçlerini Türkiye'de doğrudan yürütür. UYAP sistemi üzerinden tüm dava hareketlerini, tapu kayıtlarını ve tebligatları Almanya'dan gerçek zamanlı olarak takip ederim. Ceza yolu da dahil olmak üzere tüm süreci tek elden yönetirim.
...
[Muris Muvazaası: Türk Erbrecht'te Mirastan Mal Kaçırma →](/de/blog/muris-muvazaasi-erbrecht-tuerkei-tapu-iptal-klage)
...
**Muris muvazaası nedir?**
Erblasserin hayattayken bir taşınmazını, gerçekte bağış niteliğinde olmasına karşın tapuda satış olarak göstererek belirli bir mirasçıya devretmesidir. 1974 tarihli Yargıtay İçtihadı Birleştirme Kararı bu durumu mahkeme yoluyla düzeltilebilir kabul etmektedir.

**Zamanaşımı var mı?**
Hayır. Muris muvazaasına dayalı tapu iptal davasında zamanaşımı yoktur. Ama her geçen gün taşınmazın üçüncü kişilere satılma riski artar.

**Almanya'dan dava açılabilir mi?**
Evet. Vekaletname ile avukatınız sizi doğrudan temsil eder. Türkiye'ye gitmek zorunlu değildir.

**Muvazaa nasıl ispatlanır?**
Ekspertiz raporu, banka hareketleri, tanık beyanları ve aile yazışmaları kullanılabilir. Yargıtay üç ya da dört indisi yeterli bulmaktadır.

**İhtiyati tedbir nedir?**
Taşınmazın dava süresince satılmasını önleyen acil tapu blokesidir. Vefatın hemen ardından talep edilmelidir.

**Mavi Kart sahibi dava açabilir mi?**
Evet. Mavi Kart sahipleri Türk vatandaşlarıyla aynı miras haklarına sahiptir — ancak nüfus kaydının güncel olması kritiktir.

**Taşınmaz üçüncü kişiye satılmışsa ne olur?**
Üçüncü kişi iyiniyetli değilse zincir satış da iptal edilebilir. Bu nedenle ihtiyati tedbir acilen alınmalıdır.

**Banka hesabı boşaltıldıysa ne yapabilirim?**
TBK m. 49 kapsamında tazminat davası ve TCK m. 155 kapsamında suç duyurusu paralel yürütülebilir.

---

> *Bu makale yalnızca Türk hukukuna ilişkin genel bilgi amaçlıdır. Doğru Kanzlei, §207 BRAO kapsamında yalnızca Türk hukuku konularında danışmanlık vermektedir.*`,contentEN:`> *This article addresses Turkish law exclusively. Doğru Kanzlei advises on Turkish law under § 207 BRAO and does not advise on German domestic law.*
...
|---|---|
| Gross price-to-value disparity | Property worth €200,000, sale price €20,000 |
| Buyer lacked financial means | Sibling was unemployed or in debt at the time |
| Deceased continued living in the property | Parent stayed in the home after the "sale" |
| Close family relationship | Transfer was to a child or grandchild |
| Overseas heirs as a sign of deliberate exclusion | German-resident children kept uninformed |
| Advanced age or illness of deceased | Transfer happened during deteriorating health |
| No economic reason for the sale | No debts, no financial pressure to sell |
...
And in German:
[Muris Muvazaası: Wenn Erben ihr türkisches Erbe verlieren — Tapu Iptal Klage →](/de/blog/muris-muvazaasi-erbrecht-tuerkei-tapu-iptal-klage)
...
> *This article addresses Turkish law exclusively. Doğru Kanzlei advises on Turkish law under § 207 BRAO and does not advise on German domestic law.*`,category:"Miras Hukuku / Gayrimenkul Hukuku",categoryDE:"Erbrecht / Immobilienrecht Türkei",categoryEN:"Inheritance Law / Property Law Turkey",image:a,dateDE:"14. Mai 2026",dateTR:"14 Mayıs 2026",dateEN:"14 May 2026",readTimeDE:"13 Min. Lesezeit",readTimeTR:"13 dk okuma",readTimeEN:"13 min read",publishedAt:"2026-05-14",modifiedAt:"2026-05-14",keywordsDE:"muris muvazaası erbrecht türkei, tapu iptal klage türkei deutschland, mirastan mal kaçırma deutsch, grundbuchsperre türkei erbstreit, erbschleicherei türkei immobilien, mavi kart erbrecht türkei, bankkonto erbe türkei, kettenverkauf immobilie türkei, tck 155 strafanzeige türkei, türkisches erbrecht klage deutschland",keywordsTR:"muris muvazaası, mirastan mal kaçırma, tapu iptal davası almanya, tapu iptal ve tescil davası, ihtiyati tedbir muvazaa, mavi kart miras hakları, yargıtay muvazaa, banka hesabı miras hakkı, tck 155, muvazaa ispatı 2026",keywordsEN:"muris muvazaasi Turkey Germany, inheritance fraud Turkey property cancellation, tapu iptal davasi Germany heir, Turkish property fraud heirs abroad, mavi kart inheritance rights Turkey, emergency injunction Turkish property, bank account inheritance Turkey, chain sale Turkish property fraud, muris muvazaasi how to prove, Turkish deed cancellation lawsuit 2026",faqDE:[{question:"Was ist Muris Muvazaası?",answer:"Muris Muvazaası (wörtlich: Erblasser-Kollusion) bezeichnet eine Scheinübertragung von Vermögen durch den Erblasser zu Lebzeiten mit dem Ziel, bestimmte Erben zu benachteiligen. Der Erblasser überträgt eine Immobilie an ein bevorzugtes Kind — im Grundbuch steht ein Kaufvertrag, tatsächlich floss kein oder kaum Kaufpreis. Das türkische Recht erlaubt Erben, diese Übertragung per Klage rückgängig zu machen. Rechtsgrundlage: Yargıtay-Grundsatzentscheid vom 01.04.1974, E.1/K.2."},{question:"Gibt es eine Verjährungsfrist für die Tapu-Iptal-Klage?",answer:"Nein. Die Tapu-Iptal-Klage (Grundbuchberichtigungsklage) wegen Muris Muvazaası unterliegt keiner Verjährung. Sie kann auch 20 oder 30 Jahre nach der Übertragung erhoben werden. Aber: Die fehlende Verjährung ist kein Grund zur Untätigkeit. Je länger gewartet wird, desto größer das Risiko eines Kettenverkaufs an gutgläubige Dritte und desto mehr Beweise gehen verloren."},{question:"Kann ich die Klage aus Deutschland führen, ohne in die Türkei zu reisen?",answer:"Ja. Mit einer notariell beglaubigten türkischen Vollmacht (Vekaletname) kann Ihr Avukat in der Türkei das gesamte Verfahren für Sie führen. Die Doğru Kanzlei ist als Mitglied der Ankara Barosu (Sicil-Nr. 47068) direkt vor türkischen Gerichten zugelassen — kein Kooperationspartner, keine doppelten Kommunikationswege."},{question:"Was ist eine Ihtiyati Tedbir (Grundbuchsperre) und wann muss ich sie beantragen?",answer:"Die Ihtiyati Tedbir (türkische Grundbuchsperre, HMK Art. 389-399) ist eine einstweilige Verfügung, die verhindert, dass die Immobilie während des laufenden Verfahrens an Dritte verkauft wird. Sie muss sofort nach dem Todesfall beantragt werden — im Idealfall noch bevor die Klage selbst eingereicht wird. Das Gericht entscheidet in der Regel binnen 1-3 Werktagen. Ohne Grundbuchsperre kann die Immobilie an gutgläubige Dritte verkauft werden, was die Klage erheblich erschwert."},{question:"Wie beweist man Muris Muvazaası?",answer:"Gemäß Yargıtay HGK 2010/1-295 können Erben als Dritte mit ALLEN Beweismitteln arbeiten — sie sind nicht an die Urkundenbindung gebunden. Der Yargıtay 1. Hukuk Dairesi prüft: Missverhältnis zwischen Kaufpreis und Marktwert, fehlende wirtschaftliche Fähigkeit des Käufers, weiteres Bewohnen der Immobilie durch den Erblasser, enge Familienbeziehung, Erben im Ausland als Indiz für Benachteiligungsabsicht. Drei bis vier dieser Indizien gelten als ausreichend."},{question:"Was ist die Mavi-Kart-Falle beim türkischen Erbrecht?",answer:"Mavi-Kart-Inhaber (ehemalige türkische Staatsangehörige mit deutscher Staatsbürgerschaft) haben grundsätzlich dieselben Erbrechte wie türkische Staatsbürger. In der Praxis entstehen jedoch Probleme: Wenn der Mavi-Kart-Status nicht korrekt im türkischen Personenstandsregister erfasst ist, können Gerichte und Banken die Kooperation verweigern. Die Gegenseite nutzt dies als Verzögerungstaktik, während in der Zwischenzeit Immobilien verkauft und Bankkonten geleert werden können."},{question:"Was kann ich tun, wenn das Bankkonto des Erblassers geleert wurde?",answer:"Es gibt zwei Wege, die parallel beschritten werden können: Erstens eine Schadensersatzklage nach TBK Art. 49 (türkisches Schuldrecht) für den Betrag, der dem Kläger nach seiner Erbquote zugestanden hätte. Zweitens eine Strafanzeige nach TCK Art. 155 (Güveni Kötüye Kullanma — Untreue), wenn der Erbe eine Kontovollmacht oder den Kontozugang missbraucht hat. Die Strafanzeige erzeugt erheblichen Druck und bewegt die Gegenseite häufig zu einer außergerichtlichen Einigung."},{question:"Was passiert, wenn die Immobilie schon an einen Dritten weiterverkauft wurde?",answer:"Wenn der Dritte zum Zeitpunkt des Erwerbs nicht gutgläubig war — etwa weil er Verwandter des Beklagten ist, ein Geschäftspartner, oder weil die Übertragung zu einem auffällig niedrigen Preis erfolgte — ist auch dieser Kettenverkauf anfechtbar (Yargıtay 1. Hukuk Dairesi, ständige Rechtsprechung). Das ist der entscheidende Grund, warum die Ihtiyati Tedbir sofort beantragt werden muss."}],faqTR:[{question:"Muris muvazaası nedir?",answer:"Muris muvazaası (mirastan mal kaçırma), bir kişinin hayattayken mirasçılarını zarara uğratmak amacıyla taşınmazını gerçek bir satış gibi göstererek belirli bir mirasçıya devretmesidir. Tapuda satış görünmesine karşın aslında bir bağış söz konusudur ve satış bedeli ya hiç ödenmez ya da sembolik düzeyde kalır. Yargıtay İçtihadı Birleştirme Kararı 01.04.1974 E.1/K.2 bu durumu ispat edildiğinde tapu iptali ve tescil davasıyla düzeltilebilir olarak kabul etmiştir."},{question:"Muris muvazaasında zamanaşımı var mı?",answer:"Hayır. Muris muvazaasına dayalı tapu iptal ve tescil davasında zamanaşımı yoktur. Vefattan 20 veya 30 yıl sonra bile dava açılabilir. Ancak zamanaşımı olmaması beklemek için bir neden değildir: Her geçen gün taşınmazın iyi niyetli üçüncü kişilere satılması (kettenverkauf) riski artar, deliller kaybolur ve banka hesaplarındaki para çekilir."},{question:"Almanya'dan Türkiye'deki tapu iptal davası açılabilir mi?",answer:"Evet. Türkiye'ye gitmeden, Almanya'dan bir avukate vekaletname vererek tapu iptal ve tescil davası açılabilir. Doğru Kanzlei, Ankara Barosu üyesi (Sicil No: 47068) olarak Türkiye'deki mahkemelerde doğrudan temsil sağlar. Taşınmazın bulunduğu yer asliye hukuk mahkemesi yetkilidir (HMK m. 12)."},{question:"Mirastan mal kaçırma nasıl ispatlanır?",answer:"Yargıtay HGK 2010/1-295 kararına göre mirasçılar, senet sınırlamasından bağımsız olarak her türlü delille ispat yapabilir: taşınmaz değeri ile ödenen bedel arasındaki oransız fark, alıcının ekonomik kapasitesinin yetersizliği, erblasserin vefatından sonra da taşınmazda oturmaya devam etmesi, yakın akraba ilişkisi, tanık beyanları, banka hareketleri ve aile yazışmaları."},{question:"İhtiyati tedbir (grundbuchsperre) nedir ve ne zaman istenir?",answer:"İhtiyati tedbir, taşınmazın davayı beklerken üçüncü kişilere satılmasını önleyen acil bir tapu blokesidir (HMK m. 389-399). Muvazaa şüphesi varsa vefatın hemen ardından — hatta dava açılmadan önce — mahkemeden talep edilmelidir. Tedbir kararı genellikle 1-3 iş günü içinde çıkar. Doğru Kanzlei bu talebi acil olarak yönetir."},{question:"Mavi Kart sahibi tapu iptal davası açabilir mi?",answer:"Evet. Mavi Kart (5901 SK m. 28) sahipleri, Türk vatandaşlarıyla aynı miras haklarına sahiptir. Tapu iptal davası açabilir, Türkiye'de taşınmaz edinebilir ve Türk mahkemelerinde dava takip edebilirler. Ancak nüfus kaydındaki statünün doğru ve güncel olması kritiktir; aksi takdirde karşı taraf bu durumu geciktirme taktiği olarak kullanabilir."},{question:"Taşınmaz üçüncü kişiye satılmışsa ne olur?",answer:"Yargıtay 1. Hukuk Dairesi'ne göre, üçüncü kişi iktisap sırasında iyiniyetli değilse — yani erbstreit'den haberdar olduğunu biliyorsa veya yakın akraba/iş ortağıysa ya da düşük bedelle satın almışsa — kettenverkauf da iptal edilebilir. Bu nedenle ihtiyati tedbirin mümkün olan en kısa sürede alınması hayati önem taşır."},{question:"Banka hesabı da boşaltıldıysa ne yapabilirim?",answer:"İki yol mevcuttur: TBK m. 49 kapsamında haksız fiil nedeniyle tazminat davası (miras payınıza düşen tutar için) ve TCK m. 155 kapsamında güveni kötüye kullanma suçu gerekçesiyle Cumhuriyet Başsavcılığı'na suç duyurusu. Her iki yol paralel olarak izlenebilir; ceza davası çoğu zaman karşı tarafı uzlaşmaya zorlar."}],faqEN:[{question:"What is muris muvazaası?",answer:"Muris muvazaası (literally: testator collusion) is a Turkish legal doctrine describing a situation where a person transfers property to a favoured heir before death through a sham sale — meaning the title deed shows a purchase contract, but no real payment was made. Turkish law allows the other heirs to challenge this transfer in court, regardless of what the title deed says. The legal basis is the Yargıtay (Turkish Court of Cassation) Grand Assembly ruling of 01.04.1974 (E.1/K.2), which is still binding on all Turkish courts today."},{question:"Is there a time limit to file a muris muvazaası claim?",answer:"No. The deed cancellation lawsuit (tapu iptal ve tescil davası) based on muris muvazaası has no statute of limitations. You can file even decades after the transfer. However, the absence of a time limit is not a reason to delay: every day that passes increases the risk that the property is sold on to a third-party buyer, which makes the case significantly harder to win."},{question:"Can I file a muris muvazaası claim from Germany without travelling to Turkey?",answer:"Yes. You grant a notarised power of attorney (vekaletname) to a Turkish lawyer, who then represents you directly before the Turkish court. Doğru Kanzlei holds full membership with the Ankara Bar Association (Sicil No: 47068) and can represent you in Turkish courts without any travel. The entire case — including filing, hearings, and registry updates — is handled from Germany."},{question:"What is an ihtiyati tedbir and why does it matter?",answer:"An ihtiyati tedbir is an emergency court injunction that freezes the Turkish title register, preventing the property from being sold while your case is pending (Turkish Code of Civil Procedure, Arts. 389-399). It is the most critical first step in any muris muvazaası case. Without it, the property can be sold to a third-party buyer during the 1.5–3 year proceedings, which makes the case far harder to win. The court typically rules on an ihtiyati tedbir application within 1–3 business days."},{question:"How do you prove muris muvazaası?",answer:"According to Yargıtay Grand Assembly ruling 2010/1-295, heirs can use any type of evidence — they are not restricted to documents. Turkish courts look for: a glaring gap between the stated sale price and the market value, the buyer lacking the financial means to pay, the deceased continuing to live in the property after the 'sale', a close family relationship between the deceased and the buyer, the presence of overseas heirs as a sign of deliberate exclusion, and the absence of any economic reason for the sale. Three or four of these factors together are typically sufficient."},{question:"What is the Blue Card (Mavi Kart) problem in Turkish inheritance cases?",answer:"Blue Card (Mavi Kart) holders — former Turkish nationals who acquired another citizenship — retain the same inheritance rights as Turkish citizens in principle. However, if their Blue Card status is not correctly registered in the Turkish civil registry (Nüfus Müdürlüğü), courts and banks may refuse cooperation. The opposing party often exploits this as a delay tactic, buying time to sell the property or empty bank accounts while the overseas heir scrambles to gather additional documents."},{question:"What if the property has already been sold to someone else?",answer:"If the property was sold on to a third party who was not acting in good faith — for example, a relative of the defendant, someone who paid a suspiciously low price, or someone who knew about the inheritance dispute — then this chain sale can also be challenged and cancelled under Yargıtay 1st Civil Division case law. This is precisely why applying for an ihtiyati tedbir (title freeze) as soon as possible is so important."},{question:"What can I do if the bank account was emptied before or after the death?",answer:"Two routes can be pursued in parallel. The civil route: a damages claim under Turkish Obligations Law Art. 49 for the share of the account balance that should have been yours. The criminal route: a criminal complaint under Turkish Penal Code Art. 155 (Güveni Kötüye Kullanma — breach of trust) if the other heir abused a power of attorney or unauthorised account access. In practice, the criminal complaint often prompts the other side to agree to an out-of-court settlement."}],ctaTitleDE:"Muris Muvazaası direkt aus Deutschland verfolgen",ctaTitleTR:"Mirastan Mal Kaçırma Davanız İçin Acil Temsil",ctaTitleEN:"Inheritance Fraud in Turkey: Act Before the Property Is Sold",ctaDescriptionDE:"Wir prüfen Grundbuch, Beweise und Ihtiyati Tedbir sofort — direkt vor türkischen Gerichten, ohne Kooperationspartner.",ctaDescriptionTR:"Tapu kaydını, delilleri ve ihtiyati tedbir imkanını hızlıca değerlendirip Türkiye'deki davayı Almanya'dan yürütüyoruz.",ctaDescriptionEN:"We review the title register, evidence, and emergency injunction options quickly, then handle the Turkish case directly from Germany."},d=[A,{slug:"deutsche-scheidung-tuerkei-anerkennen-tanima-tenfiz",slugDE:"deutsche-scheidung-tuerkei-anerkennen-tanima-tenfiz",slugTR:"almanya-bosanma-turkiye-tanima-tenfiz",slugEN:"german-divorce-recognition-turkey-tanima-tenfiz",titleDE:"Deutsche Scheidung in der Türkei anerkennen: Tanıma & Tenfiz 2026",titleTR:"Almanya'da Boşandım, Türkiye'de Hâlâ Evli Görünüyorum: Tanıma ve Tenfiz Davası Rehberi (2026)",titleEN:"German Divorce Recognition in Turkey: The Complete Tanıma & Tenfiz Guide (2026)",excerptDE:"Sie haben sich in Deutschland scheiden lassen — aber in der Türkei gelten Sie weiterhin als verheiratet? Dieser Rechtstipp erklärt das Tanıma-ve-Tenfiz-Verfahren Schritt für Schritt.",excerptTR:`Alman mahkemesinde boşandınız — ama Türk nüfus kütüğünde hâlâ "evli" yazıyor. Bu rehber, tanıma ve tenfiz davasını adım adım açıklıyor ve Türkiye'ye gitmeden sorunu nasıl çözebileceğinizi anlatıyor.`,excerptEN:"Divorced in Germany but still legally married in Turkey? This guide explains the tanıma and tenfiz process step by step — what it is, how long it takes, what it costs, and how to do it without travelling to Turkey.",metaTitleDE:"Deutsche Scheidung Türkei anerkennen: Tanıma Tenfiz 2026 — Verfahren & Kosten",metaTitleTR:"Almanya Boşanma Türkiye Tanıma Tenfiz: Adım Adım Rehber 2026",metaTitleEN:"German Divorce Recognition in Turkey: Tanıma Tenfiz Guide 2026",metaDescriptionDE:"In Deutschland geschieden, in der Türkei noch verheiratet? Das Tanıma-Tenfiz-Verfahren Schritt für Schritt — Kosten, Fristen, häufige Fehler und direkter Anwalt.",metaDescriptionTR:"Almanya'da boşandınız ama Türkiye'de hâlâ evli görünüyorsunuz. Tanıma tenfiz davası ile nüfus kaydınızı düzeltin — belgeler, süreç ve 2026 bilgileri.",metaDescriptionEN:"Divorced in Germany but still married in Turkey? Learn how to get your German divorce recognised through tanıma tenfiz — process, costs, and how to avoid the most common mistakes.",schemaHeadlineDE:"Deutsche Scheidung in der Türkei anerkennen lassen: Tanıma & Tenfiz 2026 — Verfahren, Fristen, Kosten",schemaHeadlineTR:"Almanya'da Boşandım, Türkiye'de Hâlâ Evli Görünüyorum: Tanıma ve Tenfiz Davası Rehberi 2026",schemaHeadlineEN:"German Divorce Recognition in Turkey: The Complete Tanıma & Tenfiz Guide (2026)",articleSectionDE:"Familienrecht",articleSectionTR:"Aile Hukuku",articleSectionEN:"Family Law",articleTagsDE:["Tanıma Tenfiz","deutsche Scheidung Türkei","MÖHUK"],articleTagsTR:["tanıma tenfiz","almanya boşanma türkiye","MÖHUK"],articleTagsEN:["tanima tenfiz","German divorce Turkey","MOHUK"],exactHreflangs:!0,exactSchema:!0,contentDE:`> *Dieser Artikel befasst sich ausschließlich mit dem türkischen Recht. Die Doğru Kanzlei berät gemäß § 207 BRAO ausschließlich im türkischen Recht.*
...
> *This article addresses Turkish law exclusively. Doğru Kanzlei advises on Turkish law under § 207 BRAO and does not advise on German domestic law.*`,category:"Aile Hukuku / Uluslararası Özel Hukuk",categoryDE:"Familienrecht / Internationales Privatrecht",categoryEN:"Family Law / International Private Law",image:r,dateDE:"14. Mai 2026",dateTR:"14 Mayıs 2026",dateEN:"14 May 2026",readTimeDE:"14 Min. Lesezeit",readTimeTR:"14 dk okuma",readTimeEN:"14 min read",publishedAt:"2026-05-14",modifiedAt:"2026-05-14",keywordsDE:"deutsche Scheidung Türkei anerkennen, tanıma tenfiz Verfahren, Scheidung Türkei anerkennen lassen, MÖHUK Art 50-59, Apostille Scheidungsbeschluss Türkei, konsularische Eintragung Scheidung, Anwalt Türkei Deutschland, Zugewinnausgleich nach Tanıma, deutsches Personenstandsregister Türkei, Tenfiz Kosten 2026",keywordsTR:"tanıma tenfiz davası, almanya boşanma türkiye tanıma, yurt dışı boşanma tanıma, möhuk 50-59, aile mahkemesi tenfiz, mavi kart boşanma türkiye, mal paylaşımı tanıma sonrası, konsolosluk boşanma kaydı, vekaletname tenfiz, almanya boşandım türkiye evli",keywordsEN:"recognition German divorce Turkey, tanima tenfiz Germany divorce, German divorce recognition Turkey MOHUK, Turkish civil registry divorce, apostille divorce Turkey, Turkish family court foreign divorce, Blue Card holders divorce Turkey, property division after tanıma, remarry Turkey after German divorce, tanima tenfiz 2026",faqDE:[{question:"Was passiert, wenn ich die deutsche Scheidung in der Türkei nicht anerkennen lasse?",answer:"Ohne Tanıma-Tenfiz-Verfahren bleiben Sie im türkischen Personenstandsregister als verheiratet eingetragen. Sie können in der Türkei nicht erneut heiraten. Erbrechte und Güterrechte des geschiedenen Ehegatten bleiben nach türkischem Recht bestehen. Kinder, die nach der deutschen Scheidung geboren werden, können dem früheren Ehegatten im türkischen Register zugeordnet werden."},{question:"Was ist der Unterschied zwischen Tanıma und Tenfiz?",answer:"Tanıma (Anerkennung, MÖHUK Art. 58) bewirkt, dass der deutsche Scheidungsbeschluss in der Türkei Rechtskraftwirkung entfaltet und das Personenstandsregister aktualisiert wird. Tenfiz (Vollstreckbarerklärung, MÖHUK Art. 50–54) ist zusätzlich erforderlich, wenn der deutsche Beschluss vollstreckbare Regelungen wie Unterhalt, Sorgerecht oder Zugewinnausgleich enthält, die in der Türkei durchgesetzt werden sollen. Die Tenfiz schließt die Tanıma automatisch ein."},{question:"Wie lange dauert das Tanıma-Tenfiz-Verfahren 2026?",answer:"Die Verfahrensdauer hängt davon ab, wie schnell die Zustellung an den Antragsgegner erfolgt. Sind beide Parteien anwaltlich in der Türkei vertreten, dauert das Verfahren 2–4 Monate. Bei Zustellung in der Türkei 3–6 Monate. Bei Auslandszustellung nach Deutschland 6–12 Monate. Bei öffentlicher Zustellung (unbekannte Adresse) 8–14 Monate."},{question:"Muss ich für das Tanıma-Tenfiz-Verfahren in die Türkei reisen?",answer:"Nein. Mit einer notariell beglaubigten Vollmacht (Vekaletname) kann ein türkischer Anwalt Sie vor dem türkischen Familiengericht vertreten. Die Doğru Kanzlei ist sowohl bei der Ankara Barosu (Sicil-Nr. 47068) als auch bei der Rechtsanwaltskammer Karlsruhe (§ 207 BRAO) zugelassen und vertritt Sie direkt — ohne Kooperationspartner."},{question:"Kann ich die Scheidung über das türkische Konsulat in Deutschland eintragen lassen?",answer:"Ja, seit der Gesetzesänderung 2017 (Nüfus Hizmetleri Kanunu Art. 27/A) können beide Ehegatten gemeinsam beim türkischen Konsulat die Eintragung der Scheidung ins Personenstandsregister beantragen. Dieser Weg erfasst jedoch ausschließlich den Scheidungsstatus — Unterhalt, Sorgerecht oder Zugewinnausgleich können auf diesem Weg nicht geregelt werden."},{question:"Was kostet die Anerkennung einer deutschen Scheidung in der Türkei?",answer:"Die türkischen Gerichtskosten (Maktu Harç) betragen derzeit ca. 3.000–5.000 TL. Hinzu kommen Übersetzungskosten (ca. 150–300 EUR), Apostille-Gebühren (ca. 25–50 EUR pro Dokument) sowie das Anwaltshonorar nach individueller Vereinbarung. Insgesamt sollten Sie mit Gesamtkosten im mittleren dreistelligen Euro-Bereich rechnen, je nach Komplexität des Falls."},{question:"Wie lange habe ich nach der Tanıma für den Zugewinnausgleich in der Türkei?",answer:"Die Verjährungsfrist für den güterrechtlichen Ausgleich (Edinilmiş Mallara Katılma Rejiminin Tasfiyesi) beginnt nicht mit der deutschen Scheidung, sondern mit der Rechtskraft der Tanıma in der Türkei — und beträgt 1 Jahr. Dies entspricht der ständigen Rechtsprechung des Yargıtay 8. Hukuk Dairesi. Versäumen Sie diese Frist, verlieren Sie Ihre Ansprüche auf türkische Vermögenswerte dauerhaft."},{question:"Welche Unterlagen brauche ich für das Tanıma-Tenfiz-Verfahren?",answer:"Erforderlich sind: beglaubigte Ausfertigung des deutschen Scheidungsbeschlusses, Rechtskraftbescheinigung vom deutschen Familiengericht, Apostille des zuständigen Oberlandesgerichts (nicht vom Amtsgericht oder Notar), vereidigte türkische Übersetzung aller Dokumente sowie eine notarielle Vollmacht (Vekaletname) für den türkischen Anwalt."}],faqTR:[{question:"Almanya'da boşandım Türkiye'de hâlâ evli görünüyorum ne yapmalıyım?",answer:"Almanya'da verilen boşanma kararı Türkiye'de kendiliğinden hüküm ifade etmez. MÖHUK m. 50-59 kapsamında Türk Aile Mahkemesi'nde tanıma veya tenfiz davası açmanız gerekir. Doğru Kanzlei, Ankara Barosu üyesi olarak Türkiye'ye gitmeksizin bu davayı Almanya'dan sizin adınıza yürütür."},{question:"Tanıma ve tenfiz arasındaki fark nedir?",answer:"Tanıma (MÖHUK m. 58), yabancı mahkeme kararının Türkiye'de kesin hüküm etkisi kazanmasını sağlar ve nüfus kaydınızı günceller. Tenfiz (MÖHUK m. 50-54) ise karardaki nafaka, velayet veya tazminat gibi maddi yükümlülükleri Türkiye'de icra edilebilir hale getirir. Yalnızca boşanma statüsünüz güncellenecekse tanıma yeterlidir; maddi hükümleri uygulatmak istiyorsanız tenfiz de gereklidir."},{question:"Tanıma tenfiz davası ne kadar sürer 2026?",answer:"Her iki taraf Türkiye'de avukatla temsil ediliyorsa 2-4 ay. Davalı Türkiye'deyse 3-6 ay. Davalıya yurt dışına tebligat gerekiyorsa 6-12 ay. Adres bilinmiyorsa ilanen tebligat nedeniyle 8-14 ay sürebilir. En hızlı çözüm her iki tarafın da Türkiye'de ayrı birer avukate vekaletname vermesidir."},{question:"Tanıma tenfiz için Türkiye'ye gitmem gerekiyor mu?",answer:"Hayır. Türkiye'deki bir avukate vekaletname vererek davayı Almanya'dan yürütmek mümkündür. Doğru Kanzlei, Ankara Barosu üyesi (Sicil No: 47068) olarak sizi doğrudan Türk mahkemelerinde temsil eder. Vekaletname Almanya'da noter veya Türk Konsolosluğu'nda düzenlenebilir."},{question:"Konsolosluk yoluyla boşanma kaydı yaptırabilir miyim?",answer:"Evet, Nüfus Hizmetleri Kanunu m. 27/A kapsamında her iki eş konsolosluğa birlikte başvurursa nüfus kaydı idari yoldan güncellenebilir. Ancak bu yol yalnızca boşanma statüsünü kapsar. Nafaka, velayet veya Türkiye'deki mal paylaşımı için mahkeme yolu şarttır."},{question:"Mavi Kart sahibi olarak tanıma tenfiz davası açabilir miyim?",answer:"Evet. Mavi Kart (pembe kart) sahipleri Türkiye ile hukuki bağlarını koruduklarından tanıma tenfiz davası açabilirler. Nüfus Müdürlüğü'ndeki kayıtlarının güncellenmesi için aynı süreç geçerlidir."},{question:"Türkiye'deki mal paylaşımı için ne kadar sürem var?",answer:"Mal paylaşımı davası için süre, Alman boşanma kararından değil Türkiye'deki tanıma kararının kesinleşmesinden itibaren 1 yıldır. Yargıtay 8. Hukuk Dairesi'nin yerleşik içtihadına göre bu süre ancak tanıma kararıyla başlar. Bu nedenle tanıma davası ile mal paylaşımı davasını eş zamanlı açmanızı kesinlikle tavsiye ederiz."},{question:"Tanıma tenfiz için hangi belgeler gerekli?",answer:"Gerekli belgeler: Alman boşanma kararının onaylı sureti, kesinleşme şerhi (Rechtskraftbescheinigung), yetkili Eyalet Yüksek Mahkemesi'nden (Oberlandesgericht) apostil — Amtsgericht'ten alınan apostil geçerli değildir — tüm belgelerin yeminli Türkçe tercümesi ve avukata verilecek vekaletname."}],faqEN:[{question:"Do I have to travel to Turkey to get my German divorce recognised?",answer:"No. You do not need to travel to Turkey. You grant a power of attorney (vekaletname) to a Turkish lawyer, who then represents you directly before the Turkish Family Court. Doğru Kanzlei holds dual bar membership in both Turkey (Ankara Bar Association) and Germany (Karlsruhe Bar, §207 BRAO) and can represent you in Turkish courts without any travel on your part."},{question:"What happens if I don't register my German divorce in Turkey?",answer:"Without tanıma, you remain listed as married in the Turkish civil registry (Nüfus Müdürlüğü). You cannot legally remarry in Turkey. Your former spouse remains your legal heir under Turkish inheritance law — and vice versa. Property acquired during the marriage in Turkey remains subject to marital property rules. Children born after the German divorce may be registered under your former spouse in the Turkish civil registry."},{question:"What is the difference between tanıma and tenfiz?",answer:"Tanıma (recognition, MOHUK Art. 58) means the German divorce decree is accepted as final in Turkey — your civil registry status is updated to divorced. Tenfiz (enforcement, MOHUK Art. 50–54) goes further: it makes the decree's specific orders — such as alimony, custody, or property division — enforceable by Turkish authorities. If your German decree only grants the divorce itself, tanıma alone is sufficient. If it contains financial or custody orders you want enforced in Turkey, you need tenfiz as well."},{question:"How long does tanıma tenfiz take in 2026?",answer:"The timeline depends primarily on how quickly the other party can be served. If both parties appoint lawyers in Turkey, the process typically takes 2–4 months. If the other party lives in Turkey and can be served directly, 3–6 months. If the other party lives in Germany and must be served internationally, 6–12 months. If their address is unknown, public service (ilan yoluyla tebligat) adds 2–4 months, bringing the total to 8–14 months."},{question:"What documents do I need for tanıma tenfiz?",answer:"You will need: a certified copy of the German divorce decree, a certificate of finality (Rechtskraftbescheinigung) from the German family court, an apostille stamp from the relevant Regional Court of Appeal (Oberlandesgericht — not the local court or a notary), a sworn Turkish translation of all documents, and a notarised power of attorney (vekaletname) for your Turkish lawyer."},{question:"Can I get my German divorce registered through the Turkish consulate?",answer:"Yes, since a 2017 law change (Population Services Law Art. 27/A), both spouses can jointly apply at a Turkish consulate to update the civil registry. However, this administrative route only covers the divorce status. It does not address alimony, custody, or property division in Turkey. If your former spouse refuses to cooperate or cannot be located, this route is not available."},{question:"How long do I have to claim property division in Turkey after tanıma?",answer:"The limitation period for property division claims in Turkey (Edinilmiş Mallara Katılma Rejiminin Tasfiyesi) is 1 year — but it runs from the date the tanıma decision becomes final in Turkey, not from the date of the German divorce. This is established case law from the Yargıtay (Turkish Court of Cassation). Missing this deadline means permanently losing your claims to Turkish marital assets. It is strongly recommended to file the property division case at the same time as the tanıma petition."},{question:"Does my German divorce automatically affect Turkish inheritance rights?",answer:"No. Under Turkish law, your former spouse remains your legal heir — and you remain theirs — until a Turkish court formally recognises the divorce through tanıma. This means if your former spouse passes away before tanıma is completed, you may be considered their heir under Turkish law, and vice versa. This is one of the most important reasons to act without delay."}],ctaTitleDE:"Tanıma-Tenfiz-Verfahren direkt aus Deutschland",ctaTitleTR:"Tanıma ve Tenfiz İşlemleriniz İçin Buradayız",ctaTitleEN:"German Divorce Recognition in Turkey",ctaDescriptionDE:"Doğru Kanzlei vertritt Sie direkt vor türkischen Familiengerichten — ohne Kooperationspartner und ohne Reise in die Türkei.",ctaDescriptionTR:"Almanya ve Türkiye'deki çift baro üyeliğimiz ve UYAP tecrübemizle süreci sizin adınıza en hızlı şekilde sonuçlandırıyoruz.",ctaDescriptionEN:"Doğru Kanzlei can represent you directly before Turkish family courts — no travel, no third-party handoff."},{slug:"tck-191-kdae-auslandstuerken",slugDE:"tck-191-kdae-auslandstuerken",slugTR:"tck-191-kdae-yurt-disinda-yasayan-turkler",slugEN:"tck-191-kdae-turks-abroad",titleDE:"TCK Art. 191 und KDAE: Was Auslandstürken vor der Einreise wissen müssen",titleTR:"TCK 191 ve KDAE: Yurt Dışında Yaşayan Türkler Türkiye'ye Gitmeden Önce Ne Bilmeli?",titleEN:"Drug Case in Turkey: TCK Article 191, KDAE and Missing Service of Process",excerptDE:"Ein KDAE-Beschluss wegen Drogenbesitzes zum Eigenkonsum kann in der Türkei jahrelang unbemerkt bleiben. Warum Zustellung, UYAP-Prüfung und rechtzeitige Verteidigung für Auslandstürken entscheidend sind.",excerptTR:"Kullanmak için uyuşturucu bulundurma nedeniyle verilen KDAE kararı yurt dışında yaşayan kişiler tarafından yıllarca fark edilmeyebilir. Tebligat, UYAP kontrolü ve zamanında savunma neden önemlidir?",excerptEN:"A TCK Article 191 drug case in Turkey can move from KDAE to criminal charges without the suspect in Germany ever being notified. Learn why UYAP checks, service defects and early defence matter.",metaTitleDE:"TCK Art. 191 und KDAE: FAQ für Auslandstürken | Doğru Kanzlei",metaTitleTR:"TCK 191 ve KDAE: Yurt Dışındaki Türkler İçin SSS | Doğru Kanzlei",metaTitleEN:"TCK Article 191 and KDAE: Drug Case in Turkey | Doğru Kanzlei",metaDescriptionDE:"KDAE-Beschluss, Denetimli Serbestlik, unwirksame Zustellung und UYAP-Prüfung: Was in Deutschland lebende Türken bei TCK Art. 191 vor einer Türkei-Reise wissen müssen.",metaDescriptionTR:"KDAE kararı, denetimli serbestlik, usulsüz tebligat ve UYAP kontrolü: Almanya'da yaşayan Türklerin TCK 191 dosyalarında bilmesi gerekenler.",metaDescriptionEN:"TCK Article 191, KDAE, Denetimli Serbestlik and missing service of process: what Turkish Germans should check before travelling to Turkey.",schemaHeadlineDE:"Häufige Fragen zu TCK Art. 191 und KDAE für Auslandstürken",schemaHeadlineTR:"Yurt Dışında Yaşayan Türkler İçin TCK 191 ve KDAE Hakkında Sık Sorulan Sorular",schemaHeadlineEN:"TCK Article 191 and the KDAE Problem for Turkish Germans",contentDE:`**RECHTLICHER HINWEIS:** Dieser Artikel befasst sich ausschließlich mit dem türkischen Recht. Die Doğru Kanzlei berät gemäß § 207 BRAO ausschließlich im türkischen Recht.
...
Die wichtigste Schutzmaßnahme ist eine frühzeitige **UYAP-Prüfung** und eine anwaltliche Bewertung der Zustellung. Wenn die Zustellung unwirksam war, kann die Verteidigung genau dort ansetzen.`,contentTR:`**HUKUKİ UYARI:** Bu yazı yalnızca Türk hukukuna ilişkindir. Doğru Kanzlei, § 207 BRAO kapsamında Türk hukuku alanında danışmanlık ve temsil hizmeti verir.
...
**Yasal uyarı:** Bu makale yalnızca genel bilgilendirme amaçlıdır ve somut olayda hukuki danışmanlık yerine geçmez.`,contentEN:`**LEGAL NOTICE:** This article concerns Turkish law only. Doğru Kanzlei advises and represents clients exclusively in Turkish law and international law under Sec. 207 BRAO.
...
**Legal notice:** This article is for general information purposes only and does not constitute legal advice in an individual case.`,category:"Ceza Hukuku",categoryDE:"Strafrecht",categoryEN:"Criminal Law",image:e,dateDE:"11. Mai 2026",dateTR:"11 Mayıs 2026",dateEN:"11 May 2026",readTimeDE:"8 Min. Lesezeit",readTimeTR:"13 dk okuma",readTimeEN:"13 min read",publishedAt:"2026-05-11",modifiedAt:"2026-05-11",keywordsDE:"TCK Art. 191, KDAE, Kamu Davasının Açılmasının Ertelenmesi, Denetimli Serbestlik, UYAP Prüfung, Auslandstürken Strafverfahren Türkei, Haftbefehl Türkei Einreise",keywordsTR:"TCK 191, KDAE, Kamu Davasının Açılmasının Ertelenmesi, denetimli serbestlik, UYAP kontrolü, yurtdışında yaşayan Türkler ceza dosyası",keywordsEN:"TCK Article 191, KDAE, drug case Turkey, Turkish criminal law Germany, UYAP check, Denetimli Serbestlik, defective service Turkey, arrest warrant Turkey",faqDE:[{question:"Was ist ein KDAE-Beschluss?",answer:"KDAE steht für Kamu Davasının Açılmasının Ertelenmesi, also den Aufschub der Anklageerhebung. Bei erstmaligem Drogenbesitz zum Eigenkonsum nach TCK Art. 191 wird die Anklage meist für 5 Jahre aufgeschoben und mit Denetimli-Serbestlik-Auflagen verbunden."},{question:"Kann ein TCK-191-Verfahren gegen mich laufen, ohne dass ich davon weiß?",answer:"Ja. Zustellungen gehen häufig an alte türkische Adressen oder erfolgen öffentlich durch İlanen Tebligat. Formal kann die Zustellung dann als erfolgt gelten, obwohl der Betroffene in Deutschland tatsächlich nichts davon erfahren hat."},{question:"Was passiert, wenn Denetimli-Serbestlik-Auflagen nicht erfüllt wurden?",answer:"Nach Ablauf der Aufschubfrist kann die Staatsanwaltschaft nach TCK Art. 191/4 Anklage erheben. Je nach Verfahrensstand drohen Abwesenheitsverfahren, Urteil, Vorführungsbefehl oder Haftbefehl."},{question:"Sollte ich vor einer Türkei-Reise eine UYAP-Prüfung machen lassen?",answer:"Ja. Eine UYAP-Prüfung durch einen bevollmächtigten Avukat kann vor der Reise klären, ob offene Verfahren, KDAE-Beschlüsse oder Haftbefehle bestehen. Am Flughafen ist es dafür meist zu spät."},{question:"Was hilft bei unwirksamer Zustellung?",answer:"Wenn die Zustellung fehlerhaft war, kann nach Tebligat Kanunu Art. 32 geltend gemacht werden, dass Fristen und Folgen nicht wirksam ausgelöst wurden. Je nach Lage kommen Neuzustellung, Wiedereinsetzung oder Angriffe gegen Abwesenheitsentscheidungen in Betracht."}],faqTR:[{question:"KDAE kararı nedir?",answer:"KDAE, Kamu Davasının Açılmasının Ertelenmesi demektir. TCK 191 kapsamındaki ilk kullanmak için uyuşturucu bulundurma dosyalarında savcılık çoğu zaman davayı 5 yıl erteler ve denetimli serbestlik yükümlülükleri belirler."},{question:"Haberim olmadan Türkiye'de TCK 191 dosyası yürüyebilir mi?",answer:"Evet. Tebligat eski Türkiye adresine gönderilmiş veya ilanen yapılmış olabilir. Kişi Almanya'da yaşadığı için fiilen haberdar olmayabilir."},{question:"Denetimli serbestlik yerine getirilmediyse ne olur?",answer:"Süre sonunda yükümlülüklerin yerine getirilmediği kabul edilirse savcılık TCK 191/4 kapsamında dava açabilir. Yakalama, zorla getirme veya yoklukta karar riski doğabilir."},{question:"Türkiye'ye gitmeden önce UYAP kontrolü gerekli mi?",answer:"Evet. Yetkili avukat UYAP üzerinden açık dosya, KDAE kararı veya yakalama kararı olup olmadığını kontrol edebilir."}],faqEN:[{question:"What is a KDAE decision?",answer:"KDAE stands for Kamu Davasının Açılmasının Ertelenmesi, or deferral of prosecution. In a first-time personal-use drug possession case under TCK Article 191, the prosecutor usually defers charges for 5 years and imposes probation conditions."},{question:"Can a TCK Article 191 case be running against me without my knowledge?",answer:"Yes. KDAE decisions are often served at an old Turkish address or by public notice. A person living in Germany may never actually learn about the decision, even though the file shows service as completed."},{question:"What happens if I did not fulfil the probation conditions?",answer:"If the 5-year deferral period expires and the conditions are recorded as unmet, the prosecutor may file charges under TCK Article 191/4. A sentence of 2 to 5 years imprisonment may be at stake."},{question:"Should I get a UYAP check before travelling to Turkey?",answer:"Yes. An authorised Avukat can check UYAP for open proceedings, arrest warrants and KDAE decisions before you travel. Once you are at a Turkish airport, the risk is already immediate."},{question:"What can be done if the KDAE decision was not validly served?",answer:"Defective service can be challenged under Tebligat Kanunu Article 32. Depending on the stage of the case, defence counsel may request proper re-service, reinstatement or challenge decisions made in absentia."}],ctaTitleDE:"Vor der Türkei-Reise: UYAP-Prüfung beauftragen",ctaTitleTR:"Türkiye Seyahatinden Önce UYAP Kontrolü",ctaTitleEN:"Before travelling to Turkey: request a UYAP check",ctaDescriptionDE:"Wir prüfen über UYAP, ob KDAE-Beschlüsse, Strafverfahren oder Haftbefehle gegen Sie vorliegen, und bewerten die Zustellung nach türkischem Recht.",ctaDescriptionTR:"UYAP üzerinden KDAE kararı, ceza dosyası veya yakalama kararı olup olmadığını kontrol ediyor ve tebligatı Türk hukuku açısından değerlendiriyoruz.",ctaDescriptionEN:"We check whether KDAE decisions, criminal proceedings or arrest warrants exist in UYAP and assess service of process under Turkish law."},{slug:"almanya-turkiye-miras-hukuku-rehberi",slugDE:"erbschaft-tuerkei-deutschland-ratgeber",slugTR:"almanya-turkiye-miras-hukuku-rehberi",slugEN:"turkish-inheritance-germany-guide",titleDE:"Erbschaft Türkei: Was Erben in Deutschland wirklich wissen müssen",titleTR:"Almanya'da Yaşarken Türkiye'de Miras Kaldı mı? Haklarınızı Kaybetmeden Bilmeniz Gereken Her Şey",titleEN:"Turkish Inheritance from Germany — The Complete Legal Guide 2026",excerptDE:"Von Nachlassspaltung und Erbschein über Doppelbesteuerung und Pflichtteilsklage bis zur verdeckten Vermögensverschiebung — der vollständige Leitfaden für deutsch-türkische Erbfälle 2026.",excerptTR:"Veraset ilamından muris muvazaasına, veraset vergisinden izale-i şuyuya — Almanya'dan Türkiye'deki mirası eksiksiz yönetme rehberi.",excerptEN:"From the split estate problem and Turkish probate certificate to inheritance tax, forced heirship claims, and fraudulent property transfers — everything you need to manage a Turkish inheritance from Germany without flying to Istanbul.",metaTitleDE:"Erbschaft Türkei: Vollständiger Leitfaden für Erben in Deutschland 2026",metaTitleTR:"Almanya'da Yaşarken Türkiye'de Miras: Eksiksiz Hukuki Rehber 2026",metaTitleEN:"Turkish Inheritance from Germany: The Complete Legal Guide 2026",metaDescriptionDE:"Immobilie in der Türkei geerbt? Erbschein, Erbschaftsteuer, Doppelbesteuerung, Nachlassspaltung, Erbausschlagung, Pflichtteilsklage und Muris Muvazaası — alles was Erben in Deutschland wissen müssen. Doğru Kanzlei.",metaDescriptionTR:"Almanya'dan Türkiye'deki mirası nasıl takip edersiniz? Veraset ilamı, tenkis davası, muris muvazaası, veraset vergisi, izale-i şuyu ve miras reddi — tüm süreçler adım adım. Doğru Kanzlei.",metaDescriptionEN:"Inherited property in Turkey while living in Germany? Learn about the split estate problem, Turkish probate certificate, inheritance tax, forced heirship claims, fraudulent transfers (Muris Muvazaası), and how to manage everything remotely. Doğru Kanzlei.",schemaHeadlineDE:"Erbschaft Türkei: Vollständiger Leitfaden für Erben in Deutschland 2026",schemaHeadlineTR:"Almanya'da Yaşarken Türkiye'de Miras: Eksiksiz Hukuki Rehber 2026",schemaHeadlineEN:"Turkish Inheritance from Germany: The Complete Legal Guide 2026",contentDE:`**RECHTLICHER HINWEIS:** Dieser Artikel befasst sich ausschließlich mit dem türkischen Recht. Die Doğru Kanzlei berät gemäß § 207 BRAO ausschließlich im türkischen Recht.
...
| Aspekt | Details |
|---|---|
| **Verfahrensdauer gesamt** | 6–12 Monate, abhängig von Zustellungsdauer und Gerichtsauslastung |
| **Internationale Zustellung** | 2–4 Monate bei Zustellung an die Gegenseite in Deutschland über internationalen Rechtshilfeweg |
| **Gerichtsgebühren Türkei** | Variable Festgebühr für Familiensachen; in der Regel zwischen 2.000 und 5.000 TL (Stand 2026) |
| **Anwaltskosten Türkei** | Abhängig von Komplexität; Mindestgebühren nach türkischer Anwaltskammergebührenordnung |
| **Apostille Deutschland** | Ausgestellt durch das zuständige Gericht oder die Behörde; Kosten meist ca. 10–30 EUR |
| **Beglaubigte Übersetzung** | 200–500 EUR je nach Seitenanzahl |
...
**RECHTLICHER HINWEIS:** Dieser Artikel befasst sich ausschließlich mit dem türkischen Recht. Die Doğru Kanzlei berät gemäß § 207 BRAO ausschließlich im türkischen Recht.`,contentTR:`**YASAL UYARI:** Bu makale yalnızca Türk hukukuna ilişkin genel bilgi amaçlıdır. Doğru Kanzlei, § 207 BRAO kapsamında yalnızca Türk hukuku konularında danışmanlık vermektedir.
...
Türkiye bağlantılı başka hukuki riskler için [Almanya'da Yaşarken Türkiye'de Miras Rehberi](/tr/blog/almanya-turkiye-miras-hukuku-rehberi) ve [Türkiye Ceza Davası Almanya Savunma](/tr/blog/turkiye-ceza-davasi-almanya-savunma) yazılarımıza da göz atabilirsiniz.

---

**YASAL UYARI:** Bu makale yalnızca Türk hukukuna ilişkin genel bilgi amaçlıdır. Doğru Kanzlei, § 207 BRAO kapsamında yalnızca Türk hukuku konularında danışmanlık vermektedir.`,contentEN:`> *This article addresses Turkish law exclusively. Doğru Kanzlei advises on Turkish law under § 207 BRAO and does not advise on German domestic law.*
...
| Aspect | Details |
|---|---|
| **Total duration** | 6–12 months (depending on service timelines and court workload) |
| **International service of process** | 2–4 months (delivering the Turkish lawsuit to the other party) |
| **Turkish court filing fees** | Fixed fee for family matters; approximately 2,000–5,000 TRY (2026) |
| **Turkish lawyer's fees** | Based on Turkish Bar minimum fee schedule; varies by case complexity |
| **Apostille (Germany/UK/NL)** | Issued by the relevant authority; typically EUR 10–50 per document |
| **Certified Turkish translation** | Approximately EUR 200–500 depending on volume |
...
For other Turkey-linked legal risks, see our [Turkish Inheritance Law Guide for Expats in Germany](/en/blog/turkish-inheritance-germany-guide) and our [Criminal Law](/en/services/strafrecht) service overview.

---

> *This article addresses Turkish law exclusively. Doğru Kanzlei advises on Turkish law under § 207 BRAO and does not advise on German domestic law.*`,category:"Aile Hukuku",categoryDE:"Familienrecht",categoryEN:"Family Law",image:l,dateDE:"3. Mai 2026",dateTR:"3 Mayıs 2026",dateEN:"May 3, 2026",readTimeDE:"14 Min. Lesezeit",readTimeTR:"14 dk okuma",readTimeEN:"14 min read",publishedAt:"2026-05-03",modifiedAt:"2026-05-03",publishedAtDE:"2026-05-03",modifiedAtDE:"2026-05-03",publishedAtTR:"2026-05-03",modifiedAtTR:"2026-05-03",publishedAtEN:"2026-05-03",modifiedAtEN:"2026-05-03",keywordsDE:"gemeinsames Sorgerecht Türkei Anerkennung, deutsches Sorgerecht Türkei, Tenfiz Klage Türkei, MÖHUK Familienrecht, Sorgerecht Türkei 2026, Sorgerechtsurteil Türkei anerkennen, Aufenthaltsbestimmungsrecht Türkei, türkisches Familienrecht Deutschland, Yargıtay Sorgerecht, Kindesentführung Türkei Haager Übereinkommen",keywordsTR:"ortak velayet tenfiz Türkiye, Almanya velayet kararı Türkiye, ortak velayet Yargıtay 2026, tenfiz davası velayet, MÖHUK velayet tenfiz, Alman mahkemesi velayet kararı Türkiye, apostil velayet belgesi, Lahey Sözleşmesi çocuk kaçırma Türkiye Almanya, ortak velayet tanıma tenfiz farkı, aile mahkemesi tenfiz",keywordsEN:"joint custody Germany Turkey, German custody order Turkey, enforce custody Turkey, Tenfiz Turkey custody, MÖHUK family law Germany, gemeinsames Sorgerecht Turkey recognised, Turkish court joint custody, Yargıtay custody ruling 2026, child abduction Turkey Hague Convention, custody enforcement Turkey 2026",faqDE:[{question:"Gilt ein deutsches Sorgerechtsurteil automatisch in der Türkei?",answer:"Nein. Ein deutsches Sorgerechtsurteil entfaltet in der Türkei keine automatische Rechtswirkung. Damit es dort bindend wird, muss vor einem türkischen Familiengericht eine Tenfiz-Klage (Vollstreckbarerklärungsklage) erhoben werden. Erst nach einem positiven Gerichtsbeschluss gilt das Urteil auch in der Türkei als verbindlich. Ohne dieses Verfahren kann die türkische Seite das deutsche Urteil schlicht ignorieren — selbst wenn das Sorgerecht eindeutig geregelt ist."},{question:"Was ist der Unterschied zwischen Tanıma und Tenfiz in der Türkei?",answer:"Tanıma (Anerkennung) bedeutet, dass ein türkisches Gericht dem ausländischen Urteil Rechtskraft im Inland zuerkennt — es wird also als gültig anerkannt, aber nicht zwingend vollstreckt. Tenfiz (Vollstreckbarerklärung) geht einen Schritt weiter: Das Urteil wird vollstreckbar gemacht, sodass z.B. Umgangsregelungen oder andere konkrete Pflichten tatsächlich durchgesetzt werden können. Bei Sorgerechtsurteilen mit konkreten Regelungen — insbesondere Umgangsrecht, Aufenthaltsbestimmungsrecht und Unterhalt — ist stets die Tenfiz-Klage notwendig."},{question:"Erkennt die Türkei gemeinsames Sorgerecht aus Deutschland an?",answer:"Ja, seit dem Grundsatzurteil des Yargıtay (türkischer Kassationshof) vom 20. Februar 2017 — Az. 2016/15771 E., 2017/1737 K. — ist gemeinsames Sorgerecht nicht mehr pauschal als Verstoß gegen die türkische öffentliche Ordnung (kamu düzeni) zu werten. Ausschlaggebend war das Gesetz Nr. 6684 vom März 2016, mit dem die Türkei das Zusatzprotokoll zur Europäischen Sorgerechtssatzung ratifiziert hat. Neuere Yargıtay-Entscheidungen aus den Jahren 2023 und 2024 bestätigen diesen Kurs. Eine Anerkennung ist dennoch nicht automatisch — sie setzt ein gerichtliches Verfahren voraus."},{question:"Welche Dokumente brauche ich für die Tenfiz-Klage in der Türkei?",answer:"Für die Tenfiz-Klage vor einem türkischen Familiengericht benötigen Sie: (1) das deutsche Sorgerechtsurteil im Original oder als beglaubigte Kopie, (2) eine Rechtskraftbescheinigung des deutschen Familiengerichts, (3) eine apostillierte und beglaubigte türkische Übersetzung aller Dokumente sowie (4) einen Nachweis, dass die Gegenseite ordnungsgemäß am deutschen Verfahren beteiligt wurde. Alle Übersetzungen müssen von einem in der Türkei zugelassenen vereidigten Übersetzer angefertigt und notariell beglaubigt sein."},{question:"Wie lange dauert ein Tenfiz-Verfahren in der Türkei?",answer:"Je nach Zustellungsdauer und Arbeitsbelastung des zuständigen türkischen Familiengerichts dauert ein Tenfiz-Verfahren in der Regel zwischen 6 und 12 Monaten. Entscheidend ist vor allem, wie schnell die Zustellung an die andere Partei in Deutschland erfolgt, da internationale Zustellungen erfahrungsgemäß 2 bis 4 Monate in Anspruch nehmen können. Mit einer vollständigen und fehlerfreien Klageschrift lässt sich der Prozess erheblich beschleunigen."},{question:"Kann die Türkei die Anerkennung meines deutschen Sorgerechtsurteils verweigern?",answer:"Ja, in bestimmten Fällen kann ein türkisches Gericht die Tenfiz verweigern. Die häufigsten Ablehnungsgründe nach MÖHUK Art. 54 sind: Das ausländische Gericht war nicht zuständig, die Gegenseite wurde im deutschen Verfahren nicht ordnungsgemäß gehört, das Urteil ist noch nicht rechtskräftig, oder das Ergebnis verstößt offensichtlich gegen die türkische öffentliche Ordnung. Außerdem kann ein laufendes Verfahren in der Türkei zur gleichen Sache (Derdestlik) die Tenfiz blockieren."},{question:"Darf ich mein Kind in die Türkei bringen, wenn ich gemeinsames Sorgerecht habe?",answer:"Bei gemeinsamem Sorgerecht ist für Reisen ins Ausland grundsätzlich die Zustimmung beider Elternteile erforderlich. Die Türkei ist Vertragsstaat des Haager Übereinkommens über internationale Kindesentführung von 1980. Wird ein Kind ohne Zustimmung des anderen sorgeberechtigten Elternteils dauerhaft in die Türkei verbracht, kann dies als internationale Kindesentführung gewertet werden — unabhängig davon, ob das Sorgerechtsurteil in der Türkei bereits anerkannt wurde oder nicht."},{question:"Was passiert, wenn in der Türkei bereits ein Sorgerechtsverfahren läuft?",answer:"Wenn in der Türkei zum gleichen Sachverhalt bereits ein Verfahren anhängig ist (sog. Derdestlik), kann dies die Tenfiz-Klage erheblich verzögern oder blockieren. Das Yargıtay hat in einer Entscheidung aus dem Jahr 2023 (2023/980 K.) bestätigt, dass ein laufendes türkisches Verfahren als Einwand gegen die Tenfiz gewertet werden kann. In solchen Fällen ist eine koordinierte Strategie zwischen dem deutschen und dem türkischen Verfahren unerlässlich."}],faqTR:[{question:"Almanya'da verilen ortak velayet kararı Türkiye'de otomatik olarak geçerli midir?",answer:"Hayır. Almanya'da verilen ortak velayet kararı, Türkiye'de kendiliğinden hüküm doğurmaz. Kararın Türkiye'de geçerli ve icra edilebilir hale gelmesi için Türk aile mahkemesinde tenfiz davası açılması zorunludur. Tenfiz kararı olmadan Türkiye'deki taraf Alman mahkeme kararını tamamen yok sayabilir; Türk makamları, okullar ve diğer kurumlar bu karara uymak zorunda değildir."},{question:"Tanıma ve tenfiz arasındaki fark nedir?",answer:"Tanıma, yabancı mahkeme kararının Türkiye'de geçerli sayılmasını sağlar — kararın varlığı kabul edilir, ancak zorunlu olarak icra edilebilir hale getirilmez. Tenfiz ise bir adım öteye gider: Karar icra edilebilir kılınır ve somut yükümlülükler — kişisel ilişki düzenlemesi (Umgangsrecht), ikamet yeri belirleme hakkı ve nafaka gibi — Türkiye'de fiilen uygulanabilir hale gelir. Somut düzenlemeler içeren velayet kararlarında her zaman tenfiz davası açılması gereklidir; yalnızca tanıma yeterli değildir."},{question:"Türkiye Almanya'dan verilen ortak velayet kararlarını tanıyor mu?",answer:"Evet, 2017'den bu yana tanıyabiliyor. Yargıtay 2. Hukuk Dairesi'nin 20 Şubat 2017 tarihli kararıyla (E. 2016/15771, K. 2017/1737) ortak velayet artık otomatik olarak kamu düzenine aykırı sayılmamaktadır. 2016 yılında 6684 sayılı Kanun'la onaylanan Avrupa Sözleşmesi Ek Protokolü bu değişimin hukuki dayanağını oluşturmaktadır. 2023 ve 2024 tarihli Yargıtay kararları bu tutumu pekiştirmiştir. Ancak tanıma otomatik değildir — her durumda dava yoluyla yapılması gerekir."},{question:"Tenfiz davası için hangi belgeler gereklidir?",answer:"Tenfiz davası için şu belgeler gerekmektedir: (1) Almanya'daki velayet kararının aslı veya onaylı örneği, (2) kararın kesinleştiğini gösteren Alman mahkemesinden alınan kesinleşme şerhi, (3) tüm belgeler için apostil tasdiki, (4) Türkiye'de yeminli tercüman tarafından yapılmış ve noter onaylı Türkçe çeviriler, (5) Türkiye'deki avukata verilecek konsolosluklarda düzenlenmiş noter onaylı vekâletname. Alman mahkeme sürecinde karşı tarafın usulüne uygun tebliğ edildiğine dair belgeler de talep edilebilir."},{question:"Türkiye'de tenfiz davası ne kadar sürer?",answer:"Tenfiz davası genellikle 6 ile 12 ay arasında sonuçlanmaktadır. En uzun süreyi uluslararası tebligat süreci oluşturmakta olup bu aşama 2 ile 4 ay alabilmektedir. Eksiksiz ve hatasız hazırlanmış bir dava dilekçesiyle süreç önemli ölçüde kısaltılabilir. Bizzat Türkiye'ye gitmenize gerek yoktur; vekiliniz tüm işlemleri sizin adınıza yürütebilir."},{question:"Türkiye'de ortak velayet tenfizim reddedilebilir mi?",answer:"Evet, belirli durumlarda reddedilebilir. MÖHUK m. 54 uyarınca en sık karşılaşılan red gerekçeleri şunlardır: yabancı mahkemenin yetkisiz olması, karşı tarafın Alman davaya usulüne uygun dahil edilmemesi, kararın henüz kesinleşmemiş olması ya da sonucun Türk kamu düzenine açıkça aykırı bulunması. Bunlara ek olarak, Türkiye'de aynı konuda derdest bir davanın bulunması (derdestlik itirazı) da tenfizi engelleyebilir."},{question:"Ortak velayet varken çocuğu Türkiye'ye götürebilir miyim?",answer:"Ortak velayette yurt dışı seyahatlerde kural olarak her iki ebeveynin rızası aranmaktadır. Türkiye, 1980 tarihli Lahey Uluslararası Çocuk Kaçırma Sözleşmesi'ne taraftır. Diğer velayetin rızası alınmadan çocuğun kalıcı olarak Türkiye'ye götürülmesi, Sözleşme kapsamında hukuka aykırı bir müdahale sayılır ve iade talebiyle sonuçlanabilir. Bu durum, Türkiye'de tenfiz kararı bulunup bulunmadığından bağımsız olarak geçerlidir."},{question:"Türkiye'de zaten devam eden bir velayet davası varsa tenfiz mümkün müdür?",answer:"Bu ciddi bir engeldir. Aynı konuda Türkiye'de derdest bir dava bulunması (derdestlik itirazı), tenfiz talebini önemli ölçüde geciktirebilir ya da tamamen engelleyebilir. Yargıtay 2. HD, 2023/980 K. sayılı kararında bu itirazın geçerli bir engel oluşturabileceğini açıkça teyit etmiştir. Bu tür durumlarda Almanya'daki ve Türkiye'deki süreçleri eş zamanlı koordine eden kapsamlı bir hukuki strateji zorunludur."}],faqEN:[{question:"Does a German joint custody order automatically apply in Turkey?",answer:"No. A German custody order has no automatic legal effect in Turkey. For it to become binding there, you must file a Tenfiz (enforcement) lawsuit before a Turkish Family Court. Until a Turkish court issues a Tenfiz ruling, the other parent in Turkey is under no legal obligation to comply with the German order — and Turkish authorities, schools and public bodies are not required to recognise it either."},{question:"What is Tenfiz and how is it different from Tanıma?",answer:"Tanıma (recognition) means a Turkish court accepts that a foreign judgment is valid — it confirms the judgment's existence without necessarily making it enforceable. Tenfiz (enforcement) goes further: it makes the foreign judgment executable in Turkey, so that specific obligations — such as visitation schedules, the right to determine the child's place of residence, and child maintenance — can actually be enforced by Turkish courts. For custody orders that contain specific arrangements beyond the bare divorce, Tenfiz is always required."},{question:"Does Turkey recognise joint custody orders from Germany?",answer:"Yes, since 2017. The Turkish Supreme Court (Yargıtay), in its landmark decision of 20 February 2017 (Case No. 2016/15771 E., 2017/1737 K.), ruled that foreign joint custody orders can no longer be automatically refused as contrary to Turkish public policy. This followed Turkey's ratification of the Additional Protocol to the European Convention on Contact Concerning Children in March 2016 (Law No. 6684). More recent Yargıtay decisions from 2023 and 2024 confirm this approach. However, recognition is not automatic — each case must go through proper court proceedings."},{question:"What documents do I need to enforce a German custody order in Turkey?",answer:"You will need: (1) the original German custody judgment or a certified copy, (2) a certificate of finality from the German family court confirming the judgment is no longer subject to appeal, (3) apostille certification on all German documents under the Hague Apostille Convention, (4) a certified Turkish translation of all documents prepared by a sworn translator registered in Turkey and notarised by a Turkish notary, and (5) a notarised power of attorney (Vekâletname) for your Turkish lawyer, issued at a Turkish consulate in your country."},{question:"How long does the Tenfiz process take in Turkey?",answer:"The Tenfiz process typically takes between 6 and 12 months. The most time-consuming stage is usually international service of process — delivering the lawsuit documents to the other party — which can take 2 to 4 months. A complete and error-free application significantly speeds up the timeline. You do not need to travel to Turkey at any point in the process."},{question:"Can Turkey refuse to enforce my German custody order?",answer:"Yes, in certain circumstances. Under Article 54 of MÖHUK (Turkish Private International Law), the most common grounds for refusal are: the German court lacked jurisdiction, the other party was not properly notified and heard in the German proceedings, the judgment is not yet final, or the outcome is manifestly contrary to Turkish public policy. An ongoing Turkish court case on the same matter (known as the Derdestlik objection) can also block or delay the Tenfiz."},{question:"Can I take my child to Turkey if we have joint custody in Germany?",answer:"With joint custody, both parents must normally agree to international travel. Turkey is a signatory to the 1980 Hague Convention on International Child Abduction (HCCH 1980). If one parent permanently relocates the child to Turkey without the other's consent, this constitutes a wrongful removal under the Convention — regardless of whether a Tenfiz order has been obtained. The left-behind parent can file a return application through the relevant Central Authority, and Turkish courts are obligated to order the child's return."},{question:"What happens if there is already a custody case running in Turkey?",answer:"This is a serious complication. If the other parent has already opened a custody or divorce case in Turkey covering the same subject matter, they can raise what is known as the Derdestlik objection — arguing that the Turkish proceedings take precedence. The Turkish Supreme Court confirmed in a 2023 decision (Case No. 2023/980 K.) that an ongoing Turkish case can block or significantly delay the Tenfiz. A coordinated strategy across both jurisdictions is essential in these situations."}],ctaTitleDE:"Brauchen Sie Anerkennung Ihres deutschen Sorgerechtsurteils in der Türkei?",ctaDescriptionDE:"Wir prüfen Ihre Unterlagen, bereiten Vollmacht, Apostille und Übersetzungen vor und führen die Tenfiz-Klage direkt vor türkischen Familiengerichten.",ctaTitleTR:"Ortak velayet kararınızın Türkiye'de tanınması mı gerekiyor?",ctaDescriptionTR:"Vekalet, apostil, tercüme ve tenfiz davası süreçlerinde Türkiye'deki aile mahkemeleri önünde doğrudan destek sunuyoruz.",ctaTitleEN:"Need to enforce a German custody order in Turkey?",ctaDescriptionEN:"We prepare the documents, power of attorney, apostilles and Turkish petition, then handle the Tenfiz case directly before Turkish Family Courts."},{slug:"almanya-muris-muvazaasi-tapu-iptali",slugDE:"deutschland-muris-muvazaasi-tapu-annullierung",slugTR:"almanya-muris-muvazaasi-tapu-iptali",titleDE:"Muris Muvazaası-Klage aus Deutschland | Erbschleicherei in der Türkei",titleTR:"Almanya'dan Türkiye'de Muris Muvazaası Davası | Mirastan Mal Kaçırma",excerptDE:"Haben Verwandte in der Türkei geerbte Immobilien übertragen? Erheben Sie eine Muris Muvazaası-Klage aus Deutschland, um die Eigentumsurkunde zurückzuerhalten. Wir erklären es anhand von BGH-Urteilen.",excerptTR:"Türkiye'de miras kalan taşınmazı akrabalarınız mı devretti? Almanya'dan muris muvazaası davası açarak tapuyu geri alabilirsiniz. Yargıtay kararlarıyla anlatıyoruz.",contentDE:`**RECHTLICHER HINWEIS:** Dieser Artikel befasst sich ausschließlich mit dem türkischen Recht. Eine Beratung zum deutschen Recht findet in unserer Kanzlei nicht statt.
...
**Neden Dogru Kanzlei?**
Türkiye'deki taşınmaz hukukuna hakimiz ve işlemlerinizi doğrudan Türk makamları nezdinde takip ediyoruz.`,category:"Gayrimenkul Hukuku",categoryDE:"Immobilienrecht",image:o,dateDE:"2. April 2026",dateTR:"2 Nisan 2026",readTimeDE:"8 Min. Lesezeit",readTimeTR:"8 dk okuma",publishedAt:"2026-04-02",keywordsDE:"Immobilienkauf Türkei Rechte, Tapu Prüfung Türkei, Grunderwerbsteuer Türkei, Vollmacht Immobilien Türkei, Immobilienrecht Anwalt Türkei",keywordsTR:"Türkiye'de taşınmaz edinimi yabancılar, tapu sorgulama nasıl yapılır, emlak vergisi Türkiye, vekaletle tapu devri, gayrimenkul avukatı"},{slug:"tanima-tenfiz-rehberi",slugDE:"anerkennung-scheidung-tuerkei-deutschland",slugTR:"tanima-tenfiz-rehberi",slugEN:"recognition-german-divorce-turkey-guide",titleDE:"In Deutschland geschieden — in der Türkei noch verheiratet? Das Tanıma Tenfiz-Verfahren 2026",titleTR:"Almanya'da Boşandınız, Türkiye'de Hala Evli mi Görünüyorsunuz? Tanıma ve Tenfiz Rehberi 2026",titleEN:"",excerptDE:"Warum das deutsche Scheidungsurteil in der Türkei nicht gilt, welche zwei Wege zur Anerkennung führen, was mit Unterhalt und Sorgerecht passiert — und was auf dem Spiel steht, wenn Sie nichts tun.",excerptTR:"Tanıma ile tenfiz arasındaki fark, dava açmadan konsolosluk yolu, MÖHUK şartları, nafaka ve velayet tenfizi — Almanya'dan Türkiye'ye gitmeden nasıl yapılır?",excerptEN:"",metaTitleDE:"Scheidung Türkei anerkennen Anwalt: Vollständiger Leitfaden 2026",metaTitleTR:"Tanıma ve Tenfiz: Almanya Boşanma Kararı Türkiye'de Nasıl Geçerli Olur? (2026)",metaTitleEN:"",metaDescriptionDE:"Scheidung Türkei anerkennen Anwalt und Tanıma Tenfiz Anwalt Deutschland: Unterlagen, Verwaltungsweg ohne Gericht, Unterhalt und Sorgerecht — alles was Sie wissen müssen.",metaDescriptionTR:"Almanya'da boşandınız, Türkiye'de hala evli mi görünüyorsunuz? Tanıma ve tenfiz davası nedir, şartları nelerdir, dava açmadan konsolosluktan nasıl yapılır, nafaka ve velayet tenfizi — adım adım rehber. Doğru Kanzlei.",metaDescriptionEN:"",schemaHeadlineDE:"Scheidung Türkei anerkennen Anwalt: Vollständiger Leitfaden 2026",schemaHeadlineTR:"Tanıma ve Tenfiz: Almanya Boşanma Kararı Türkiye'de Nasıl Geçerli Olur? (2026)",schemaHeadlineEN:"",contentDE:`**RECHTLICHER HINWEIS:** Dieser Artikel befasst sich ausschließlich mit dem türkischen Recht. Die Doğru Kanzlei berät gemäß § 207 BRAO ausschließlich im türkischen Recht.
...
*Bu makale genel bilgi amaçlıdır ve hukuki danışmanlık niteliği taşımaz. Büromuz yalnızca Türk hukuku alanında danışmanlık vermektedir.*`,contentEN:`**LEGAL NOTICE:** This article addresses Turkish law only. Doğru Kanzlei advises on Turkish law under § 207 BRAO and does not advise on German domestic family law.
...
İlk görüşme Almanca veya Türkçe yapılır — hangisi sizin için daha rahatsanız. Ardından net bir değerlendirme alırsınız: hukuki durumunuz ne anlama geliyor, gerçekçi seçenekler neler ve bir sonraki adım ne.`,category:"legal-info",categoryDE:"Rechtsinformationen",image:e,dateDE:"19. April 2026",dateTR:"19 Nisan 2026",readTimeDE:"8 Min. Lesezeit",readTimeTR:"8 dk okuma",publishedAt:"2026-04-19",keywordsDE:"türkischer anwalt mannheim, türkischer anwalt erstberatung, anwalt türkisches recht mannheim, türkischer rechtsanwalt erstgespräch, türkisch deutscher anwalt",keywordsTR:"mannheim türk avukat, türk avukat ilk görüşme, türk hukuku avukat mannheim, türk alman avukat ilk danışma",faqDE:[{question:"Was kostet die Erstberatung bei einem türkischen Anwalt in Mannheim?",answer:"Maximal 190 Euro plus Mehrwertsteuer nach dem RVG. Mit Beratungshilfeschein (beim Amtsgericht erhältlich) nur 15 Euro. Fragen Sie vorher, was konkret berechnet wird."},{question:"Was ist der Unterschied zwischen einem Anwalt mit türkischer Barosu-Zulassung und einem ohne?",answer:"Ein Anwalt mit Zulassung bei einer türkischen Barosu ist berechtigt, in der Türkei vor Gericht aufzutreten — nicht nur zu beraten. Das ist relevant, wenn Ihr Fall türkische Gerichtsverfahren erfordert, zum Beispiel Tanıma-Tenfiz oder türkische Erbschaftsangelegenheiten."},{question:"Welche Dokumente soll ich zur Erstberatung mitbringen?",answer:"Personalausweis oder Reisepass, türkischer Nüfus-Auszug falls vorhanden, und alle Dokumente, die direkt mit Ihrem Anliegen zusammenhängen — Testament, Scheidungsbeschluss, Mietvertrag, Vollmacht. Eine kurze Zeitlinie der Ereignisse hilft dem Anwalt, schneller einzusteigen."},{question:"Kann ich die Erstberatung auch auf Türkisch führen?",answer:"Bei der Doğru Kanzlei ja. Das Gespräch findet auf Deutsch oder Türkisch statt — je nachdem, was für Sie angenehmer ist."}],faqTR:[{question:"Mannheim'da Türk avukatla ilk görüşme ne kadar tutar?",answer:"RVG'ye göre maksimum 190 Euro + KDV. Beratungshilfe belgesiyle yalnızca 15 Euro. Önceden ne kadar ücret alındığını sormanızı öneririm."},{question:"Türk barosuna kayıtlı avukat ile kayıtsız arasındaki fark nedir?",answer:"Türk barosuna kayıtlı avukat Türkiye'de mahkemede temsil yetkisine sahiptir — yalnızca danışmanlık vermekle kalmaz. Tanıma-Tenfiz veya Türkiye'deki miras işlemleri gibi Türk mahkeme süreçleri gerekiyorsa bu önemlidir."},{question:"İlk görüşmeye hangi belgeleri getirmeliyim?",answer:"Pasaport veya kimlik belgesi, varsa Türk nüfus cüzdanı ve doğrudan ilginizi ilgilendiren tüm belgeler — vasiyetname, boşanma kararı, kira sözleşmesi, vekaletname. Olayların kısa bir zaman çizelgesi avukatın daha hızlı değerlendirme yapmasına yardımcı olur."},{question:"İlk görüşmeyi Türkçe yapabilir miyim?",answer:"Doğru Kanzlei'de evet. Görüşme Almanca veya Türkçe yapılabilir — hangisi sizin için daha rahatsanız."}],ctaTitleDE:"Erstgespräch mit einem türkischen Anwalt in Mannheim",ctaTitleTR:"Mannheim'da Türk Avukatla İlk Görüşme",ctaDescriptionDE:"Rechtsanwalt Hasan Doğru ist bei der Ankara Barosu und der Rechtsanwaltskammer Karlsruhe zugelassen. Erstberatung auf Deutsch oder Türkisch.",ctaDescriptionTR:"Avukat Hasan Doğru, Ankara Barosu ve Karlsruhe Barosu'na kayıtlıdır. İlk görüşme Almanca veya Türkçe yapılabilir."},{slug:"tuerkischer-anwalt-deutschland-liste",slugDE:"tuerkischer-anwalt-deutschland-liste",slugTR:"almanya-da-tuerk-avukat-listesi",slugEN:"turkish-lawyer-germany-list",titleDE:"Türkischer Anwalt in Deutschland: Die 6 besten Kanzleien im Vergleich (2026)",titleTR:"Almanya'da Türk Avukat: 2026'nın En İyi 6 Hukuk Bürosu Karşılaştırması",titleEN:"Turkish Lawyer in Germany: The 6 Best Law Firms Compared (2026)",excerptDE:"Welcher türkische Anwalt in Deutschland ist wirklich für türkisches Recht zugelassen? Der Unterschied zwischen Türkischkenntnissen und § 207 BRAO-Zulassung — und welche Kanzlei für welchen Fall die richtige ist.",excerptTR:"Almanya'da hangi Türk avukat gerçekten Türk hukuku için ruhsatlıdır? Türkçe konuşmak ile §207 BRAO yetkisi arasındaki fark — ve hangi büro hangi dava için doğru seçimdir.",excerptEN:"Which Turkish lawyer in Germany is actually licensed for Turkish law? The difference between speaking Turkish and holding a §207 BRAO licence — and which firm is right for your case.",metaTitleDE:"Türkischer Anwalt Deutschland 2026: 6 Kanzleien im Vergleich | Doğru Kanzlei",metaTitleTR:"Almanya'da Türk Avukat 2026: 6 Hukuk Bürosu Karşılaştırması | Doğru Kanzlei",metaTitleEN:"Turkish Lawyer Germany 2026: 6 Law Firms Compared | Doğru Kanzlei",metaDescriptionDE:"§207 BRAO vs. Türkischkenntnisse: Welcher Anwalt in Deutschland darf echtes türkisches Recht praktizieren? 6 Kanzleien aus Berlin, Frankfurt, Köln, Mannheim im Vergleich.",metaDescriptionTR:"§207 BRAO ile Türkçe bilmek arasındaki fark nedir? Almanya'da gerçek Türk hukuku uygulayabilen avukatlar: Berlin, Frankfurt, Köln, Mannheim'dan 6 büro karşılaştırması.",metaDescriptionEN:"§207 BRAO vs. speaking Turkish: which lawyer in Germany can actually practise Turkish law? 6 firms from Berlin, Frankfurt, Cologne, Mannheim compared.",keywordsDE:"türkischer Anwalt Deutschland, türkischsprachiger Rechtsanwalt, türkischer Anwalt Mannheim, türkischer Anwalt Berlin, §207 BRAO türkisches Recht, türkischer Familienanwalt Deutschland",keywordsTR:"almanya türk avukat, almanyada türk avukatlar listesi, türk avukat almanya, almanya türk hukuk bürosu, §207 BRAO türk hukuku, almanya türk aile avukatı",schemaHeadlineDE:"Türkischer Anwalt in Deutschland: Die 6 besten Kanzleien im Vergleich 2026",schemaHeadlineTR:"Almanya'da Türk Avukat: 2026'nın En İyi 6 Hukuk Bürosu Karşılaştırması",schemaHeadlineEN:"Turkish Lawyer in Germany: The 6 Best Law Firms Compared 2026",image:s,dateDE:"Mai 2026",dateTR:"Mayıs 2026",dateEN:"May 2026",readTimeDE:"12 Min. Lesezeit",readTimeTR:"12 dk okuma",readTimeEN:"12 min read",publishedAt:"2026-05-15",category:"Türk Hukuku · Almanya · Avukat Rehberi",categoryDE:"Türkisches Recht · Deutschland · Anwaltsguide",categoryEN:"Turkish Law · Germany · Lawyer Guide",contentDE:`**RECHTLICHER HINWEIS:** Dieser Artikel dient ausschließlich der allgemeinen Information. Die Doğru Kanzlei berät gemäß § 207 BRAO ausschließlich im türkischen Recht. Für eine individuelle Einschätzung Ihres Falls wenden Sie sich bitte direkt an einen Anwalt.
...
**Quellen:** Statistisches Bundesamt (Destatis), Ausländerzentralregister 2023 · Bundesrechtsanwaltsordnung § 207 BRAO · gueccuek.de · kanzlei-acar.de · migrationsrecht.law · anwalt.de/firdevs-uzun · avukat-almanya.eu · kanzlei-yildiz.de`,contentTR:`**YASAL UYARI:** Bu makale yalnızca genel bilgi amaçlıdır ve hukuki danışmanlık niteliği taşımaz. Doğru Kanzlei, §207 BRAO kapsamında yalnızca Türk hukuku alanında danışmanlık vermektedir. Bireysel değerlendirme için lütfen bir avukata başvurun.
...
**Kaynaklar:** Statistisches Bundesamt (Destatis), Ausländerzentralregister 2023 · BRAO §207 · gueccuek.de · kanzlei-acar.de · migrationsrecht.law · anwalt.de/firdevs-uzun · avukat-almanya.eu · kanzlei-yildiz.de`,contentEN:`**LEGAL NOTICE:** This article is for general information only and does not constitute legal advice. Doğru Kanzlei advises exclusively on Turkish law pursuant to § 207 BRAO.
...
📍 R1 2-3, 68161 Mannheim · 📞 +49 176 612 21210 · 💬 WhatsApp · ✉️ info@hasandogru.de`,faqDE:[{question:"Was ist der Unterschied zwischen einem türkischsprachigen und einem türkischrechtlich zugelassenen Anwalt in Deutschland?",answer:"Ein türkischsprachiger Anwalt spricht Türkisch, ist aber nur für deutsches Recht zugelassen. Ein nach § 207 BRAO zugelassener Anwalt darf türkisches Recht in Deutschland ausüben und Mandanten vor türkischen Gerichten vertreten — ohne einen zweiten Anwalt in der Türkei einschalten zu müssen."},{question:"Brauche ich für ein Tanıma-Tenfiz-Verfahren in der Türkei einen nach türkischem Recht zugelassenen Anwalt?",answer:"Ja. Das Anerkennungsverfahren für eine deutsche Scheidung in der Türkei richtet sich nach türkischem Prozessrecht. Ein Anwalt ohne türkische Zulassung kann Sie dabei nicht direkt vertreten — er kann allenfalls einen türkischen Anwalt vermitteln, was zusätzliche Kosten und Kommunikationsaufwand bedeutet."},{question:"Kann ich einen türkischen Anwalt in Deutschland beauftragen, ohne in die Türkei zu reisen?",answer:"Ja — wenn der Anwalt bei einer türkischen Anwaltskammer (z.B. Ankara Barosu) und in Deutschland nach § 207 BRAO zugelassen ist. Doğru Kanzlei führt Scheidungen, Erbschaftsverfahren und Tanıma-Tenfiz vollständig remote durch. Eine Reise in die Türkei ist in den meisten Fällen nicht erforderlich."},{question:"Welche Anwälte auf dieser Liste dürfen wirklich türkisches Recht ausüben?",answer:"Hasan Doğru (Mannheim) ist der einzige Anwalt auf dieser Liste mit nachweislicher Doppelzulassung: Ankara Barosu und Rechtsanwaltskammer Karlsruhe (§ 207 BRAO) sowie Büros in beiden Ländern. Firdevs Uzun (Frankfurt) ist ebenfalls als Rechtsanwältin im türkischen Recht tätig. Die übrigen Kanzleien beraten türkischsprachige Mandanten im deutschen Recht."},{question:"Wie finde ich den richtigen türkischen Anwalt für mein Anliegen?",answer:'Stellen Sie zwei Kontrollfragen: (1) "Sind Sie Mitglied einer türkischen Anwaltskammer?" und (2) "Sind Sie nach § 207 BRAO für türkisches Recht zugelassen?" Nur wer beide Fragen mit Ja beantwortet, kann Sie in türkischen Verfahren direkt vertreten. Für rein deutsche Verfahren auf Türkisch reicht ein deutschzugelassener, türkischsprachiger Anwalt.'}],faqTR:[{question:"Almanya'daki Türkçe konuşan avukat ile Türk hukuku ruhsatlı avukat arasındaki fark nedir?",answer:"Türkçe konuşan bir avukat Türkçe bilir ama yalnızca Alman hukukuna göre ruhsatlıdır. §207 BRAO kapsamında ruhsatlı avukat ise Almanya'da Türk hukukunu uygulayabilir ve müvekkillerini Türk mahkemelerinde doğrudan temsil edebilir — Türkiye'de ayrı bir avukata gerek kalmadan."},{question:"Tanıma-tenfiz davası için Türk hukuku uygulayan bir avukata ihtiyacım var mı?",answer:"Evet. Almanya'daki boşanma kararının Türkiye'de tanınması Türk yargılama hukukuna göre yürütülür. Türk hukuku ruhsatı olmayan bir avukat sizi bu davada doğrudan temsil edemez; en fazla bir Türk avukatlık bürosu yönlendirebilir — bu ise ek maliyet ve iletişim yükü demektir."},{question:"Türkiye'ye gitmeden Almanya'da bir Türk avukata danışabilir miyim?",answer:"Evet — avukat hem Türk barosuna (ör. Ankara Barosu) hem de Almanya'da §207 BRAO kapsamında ruhsatlıysa. Doğru Kanzlei, boşanma, miras ve tanıma-tenfiz davalarını tamamen uzaktan yürütmektedir. Çoğu durumda Türkiye'ye seyahat gerekmez."},{question:"Bu listedeki hangi avukatlar gerçekten Türk hukuku uygulayabilir?",answer:"Hasan Doğru (Mannheim), listede hem Ankara Barosu hem Karlsruhe Barosu (§207 BRAO) üyeliğini ve her iki ülkede fiziksel ofisi olan tek avukattır. Firdevs Uzun (Frankfurt) da Türk hukuku avukatı olarak listelenmiştir. Diğer bürolar ise Türkçe konuşan müvekkillere Alman hukuku kapsamında hizmet vermektedir."},{question:"Durumum için doğru avukatı nasıl bulurum?",answer:"İki kontrol sorusu sorun: (1) 'Türk barosuna üye misiniz?' ve (2) 'Almanya'da §207 BRAO kapsamında Türk hukuku uygulama ruhsatınız var mı?' Her ikisine de evet yanıtı veren avukat sizi Türk davalarında doğrudan temsil edebilir. Türkçe destekli Alman davalarında ise Almanca ruhsatlı, Türkçe konuşan avukat yeterlidir."}],ctaTitleDE:"Türkisches Recht in Deutschland — Jetzt Beratung anfragen",ctaTitleTR:"Almanya'da Türk Hukuku — Hemen Danışın",ctaDescriptionDE:"Doğru Kanzlei ist nach § 207 BRAO und bei der Ankara Barosu zugelassen. Erstberatung auf Deutsch oder Türkisch — auch per WhatsApp.",ctaDescriptionTR:"Doğru Kanzlei, §207 BRAO ve Ankara Barosu kapsamında ruhsatlıdır. İlk görüşme Almanca veya Türkçe — WhatsApp üzerinden de ulaşabilirsiniz."}],k=new Set(["tuerkischer-anwalt-deutschland-liste"]),D=[...d].sort((i,n)=>{const u=k.has(i.slug),c=k.has(n.slug);if(u!==c)return u?1:-1;const h=n.publishedAt.localeCompare(i.publishedAt);return h!==0?h:d.indexOf(i)-d.indexOf(n)});export{d as b,t as f,D as s};
