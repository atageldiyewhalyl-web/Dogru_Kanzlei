import{G as e,U as n,S as i,P as r,a as t,B as a,H as s}from"./ui-vendor-DHnGAZBI.js";const l={id:"forderungsvollstreckung-tuerkei",slugDE:"forderungsvollstreckung-tuerkei",slugTR:"turkiyede-alacak-tahsili",slugEN:"debt-enforcement-turkey",icon:e,title:"Forderungsvollstreckung Türkei",titleTR:"Türkiye'de Alacak Tahsili",titleEN:"Debt Enforcement in Turkey",description:"Alacaklılar, iflas idareleri, tahsilat şirketleri ve kamu kurumları için — Alman kararının tenfizi, mal varlığı araştırması, ihtiyati haciz ve icra takibinin doğrudan takibi.",descriptionDE:"Für Gläubiger, Insolvenzverwalter, Inkassounternehmen und öffentliche Stellen – Anerkennung deutscher Titel (Tenfiz), Vermögensermittlung, vorläufige Pfändung und Zwangsvollstreckung, direkt vor Ort geführt.",descriptionEN:"For creditors, insolvency administrators, collection agencies and public authorities – recognition of foreign judgments (tenfiz), asset tracing, preliminary attachment and enforcement, handled directly on the ground.",detail:"Tenfiz · İhtiyati Haciz · Mal Varlığı Araştırması · UYAP · Tapu ve Banka Haczi · Almanya'dan Vekaletle Takip",detailDE:"Tenfiz · İhtiyati Haciz · Vermögensermittlung · UYAP · Grundbuch- und Kontopfändung · Verfahren ohne Türkeireise",detailEN:"Tenfiz · Preliminary Attachment · Asset Tracing · UYAP · Real Estate and Bank Enforcement · No Travel to Turkey",seoTitleDE:"Forderungen in der Türkei vollstrecken | Anerkennung (Tenfiz)",seoTitleTR:"Türkiye'de Alacak Tahsili: Alman Kararının Tenfizi (2026)",seoTitleEN:"Debt Enforcement in Turkey | Recognition of Foreign Judgments",seoDescriptionDE:"Schuldner mit Vermögen in der Türkei? Anerkennung deutscher Titel, Vermögensermittlung und Zwangsvollstreckung – direkt vor Ort durch einen in Ankara und Deutschland zugelassenen Avukat.",seoDescriptionTR:"Borçlunun Türkiye'de malı mı var? Alman kararının tanınması-tenfizi, mal varlığı araştırması ve icra takibi — Mannheim ve Ankara'dan doğrudan takip.",seoDescriptionEN:"Debtor with assets in Turkey? Recognition of foreign judgments (tenfiz), asset tracing and enforcement — handled directly by a lawyer admitted in both Ankara and Germany.",expertiseTitleDE:"Warum Doğru Kanzlei für Forderungen in der Türkei?",expertiseTitleTR:"Türkiye'de Alacak Takibinde Neden Doğru Kanzlei?",expertiseTitleEN:"Why Doğru Kanzlei for Debt Enforcement in Turkey?",content:`Türkiye'de Alacak Tahsili — Alman Kararının Tanınması ve Tenfizi
Borçlunun Türkiye'de malı mı var? Kararınızı orada bizzat tahsile dönüştürüyoruz.

Bir Alman mahkeme kararı Türkiye'de kendiliğinden geçerli değildir. Borçlunun Antalya'da bir dairesi, İstanbul'da bir banka hesabı veya Ankara'da bir şirket payı varsa, bu varlıklara ulaşmak için önce Türk mahkemesinden tenfiz kararı alınması gerekir.

Alacaklılar, iflas idareleri, tahsilat şirketleri ve kamu kurumları (özellikle nafaka avansı ödeyen kurumlar) için bu süreci baştan sona Almanya'dan yürütüyoruz — muhabir avukat katmanı olmadan.

Sizin için neler yapıyoruz:
• Başlık ön incelemesi — Elinizdeki kararın Türkiye'de tenfize elverişli olup olmadığının değerlendirilmesi; ödeme emri (Vollstreckungsbescheid) gibi tenfize elverişsiz başlıklarda alternatif yolun belirlenmesi
• Mal varlığı araştırması — TAKBİS üzerinden tapu araştırması, ticaret sicili ve araç kaydı sorgusu, dava açmadan önce tahsil ihtimalinin netleştirilmesi
• İhtiyati haciz — Borçlu mal kaçırmadan önce tapuya şerh ve banka hesabı bloke talebi
• Tenfiz davası — MÖHUK m. 50 vd. uyarınca yetkili Türk mahkemesinde tanıma ve tenfiz davasının açılması ve takibi
• İlamsız icra takibi — Tenfize elverişsiz başlıklarda doğrudan icra dairesi üzerinden ödeme emri çıkarılması
• Nafaka ilamlarının tenfizi — Kamu nafaka kurumları için rücu alacaklarının tahsili
• Tasarrufun iptali davaları — Borçlunun yakınlarına devrettiği malların takibi ve devirlerin iptali
• Satış ve tahsil — Haciz, hesap bloke, maaş haczi, gerekirse taşınmaz satışı ile alacağın nakde dönüştürülmesi

Süreç nasıl işler:
Önce başlığınızı ve olay özetini inceliyoruz. Tenfize elverişliyse, mal varlığı araştırması ve ihtiyati haciz ile güvence altına alıyoruz; ardından tenfiz davasını açıp takip ediyoruz. Sürecin tamamı noter onaylı bir vekaletname ile yürütülür — Türkiye'ye gelmenize gerek yoktur. Tenfiz sürecinin işleyişini ayrıntılı anlatan yazımıza bloğumuzdan ulaşabilirsiniz: "Alman Mahkeme Kararının Türkiye'de Tenfizi".

Genel icra ve iflas işlemleriniz için (örn. zaten Türkiye'de bir başlığınız varsa veya Türk borçlulara karşı doğrudan icra takibi gerekiyorsa) İcra ve İflas hizmet sayfamıza da göz atabilirsiniz.

Ücretsiz ön inceleme: Başlığı ve kısa bir olay özetini gönderin; tenfize elverişli olup olmadığını, hangi yolun uygun olduğunu ve mal varlığı araştırmasının anlamlı olup olmadığını değerlendirelim.`,contentDE:`Forderungsvollstreckung Türkei — Anerkennung und Vollstreckung deutscher Titel (Tenfiz)
...
Was wir für Sie tun:
• Titelprüfung — Bewertung, ob Ihr Titel in der Türkei tenfizfähig ist; bei nicht anerkennungsfähigen Titeln wie dem Vollstreckungsbescheid Ermittlung des passenden Alternativwegs
• Vermögensermittlung — Grundbuchrecherche über das Tapu-System, Handelsregister- und Fahrzeugregisterauskünfte, damit Kosten nur bei realistischer Erlösaussicht entstehen
• İhtiyati Haciz — Vorläufige Pfändung und Grundbuchsperre, bevor der Schuldner Vermögen verschieben kann
• Tenfiz-Verfahren — Anerkennungs- und Vollstreckbarerklärungsklage nach Art. 50 ff. MÖHUK vor dem zuständigen türkischen Gericht
• İlamsız icra takibi — Bei nicht tenfizfähigen Titeln direkte Einleitung eines Vollstreckungsverfahrens ohne Titel
• Vollstreckung von Unterhaltstiteln — Rückgriffsforderungen öffentlicher Stellen nach § 7 UhVorschG
• Anfechtung von Vermögensübertragungen — Verfolgung von Übertragungen an Angehörige über die Grundbuchhistorie
• Verwertung — Pfändung, Kontenzugriff, Lohnpfändung, gegebenenfalls Zwangsversteigerung von Immobilien
...
Kostenlose Erstprüfung: Senden Sie uns den Titel und eine kurze Sachverhaltsdarstellung. Sie erhalten eine Einschätzung, ob der Titel in der Türkei anerkennungsfähig ist, welcher Verfahrensweg in Betracht kommt und ob eine Vermögensermittlung sinnvoll ist.`,contentEN:`Debt Enforcement in Turkey — Recognition and Enforcement of Foreign Judgments (Tenfiz)
Does the debtor hold assets in Turkey? We turn your judgment into actual recovery there.

A foreign judgment has no automatic effect in Turkey. If the debtor holds property, a bank account or a shareholding there, a Turkish court must first issue a declaration of enforceability (tenfiz) before that asset can be reached.

For creditors, insolvency administrators, collection agencies and public authorities — including maintenance-advance funds and youth welfare offices — we run this procedure entirely from outside Turkey, without a local correspondent firm in between.

What we do for you:
• Title assessment — evaluating whether your judgment is capable of recognition in Turkey; for titles that are not, such as a default payment order, identifying the right alternative route
• Asset tracing — land registry searches through the Tapu system, commercial register and vehicle register checks, so costs only arise where recovery is realistic
• İhtiyati Haciz — preliminary attachment and a land registry restriction before the debtor can move assets
• Tenfiz proceedings — the recognition and enforcement action under Articles 50 et seq. MÖHUK before the competent Turkish court
• Enforcement without a title — direct execution proceedings (ilamsız icra takibi) where the judgment itself is not recognisable
• Enforcement of maintenance orders — subrogated claims for public authorities under statutory maintenance-advance schemes
• Challenging asset transfers — tracing and contesting transfers to relatives through the land registry history
• Realisation — attachment, account access, wage attachment and real-estate auction where needed

How the process works:
We first review your title and the facts. If it is recognisable, we secure the assets through İhtiyati Haciz and then bring and conduct the tenfiz action. The whole procedure runs on a notarised power of attorney — you do not need to travel to Turkey. The full explanation of the tenfiz procedure is in our blog article "Enforcing a Foreign Judgment in Turkey".

For general enforcement and collection in Turkey — for example where a Turkish title already exists or you need to proceed directly against a Turkish debtor — see our Debt Enforcement in Turkey (general) service page.

Free initial assessment: send us the title and a brief summary of the facts. You will receive an assessment of whether the title is recognisable in Turkey, which procedural route applies, and whether asset tracing is worthwhile.`,faqDE:[{question:"Kann ein deutsches Urteil in der Türkei vollstreckt werden?",answer:"Nicht unmittelbar. Es bedarf nach Art. 50 ff. MÖHUK einer gesonderten Vollstreckbarerklärung (Tenfiz) durch ein türkisches Gericht. Wir prüfen kostenlos, ob Ihr Titel dafür geeignet ist."},{question:"Ist ein deutscher Vollstreckungsbescheid in der Türkei anerkennungsfähig?",answer:"Nein. Er wirkt dort allenfalls als Beweismittel. In diesem Fall prüfen wir, ob ein Vollstreckungsverfahren ohne Titel (ilamsız icra takibi) oder eine Klage in der Türkei der bessere Weg ist."},{question:"Wie lange dauert die Forderungsvollstreckung in der Türkei?",answer:"Das Anerkennungsverfahren dauert häufig acht Monate und mehr; entscheidend ist die Zustellung an den Schuldner. Die anschließende Vollstreckung wirkt bei Kontenpfändungen deutlich schneller."},{question:"Muss ich als Gläubiger in die Türkei reisen?",answer:"Nein. Das gesamte Verfahren wird auf Grundlage einer notariell beurkundeten Vollmacht geführt, die Sie beim türkischen Konsulat oder bei einem Notar mit Apostille errichten lassen."},{question:"Was unterscheidet diese Leistung von Ihrer allgemeinen Zwangsvollstreckungs-Seite?",answer:"Diese Seite ist auf die Anerkennung und Vollstreckung ausländischer (insbesondere deutscher) Titel in der Türkei spezialisiert — Tenfiz, İhtiyati Haciz und Vermögensermittlung für institutionelle Gläubiger. Für allgemeine Inkasso- und Vollstreckungsfragen mit bereits vorhandenem türkischem Titel steht unsere Seite Zwangsvollstreckung & Forderungsbeitreibung zur Verfügung."},{question:"Was kostet die Erstprüfung?",answer:"Nichts. Senden Sie uns den Titel und eine kurze Sachverhaltsdarstellung; Sie erhalten eine Einschätzung zur Anerkennungsfähigkeit, zum passenden Verfahrensweg und zu den zu erwartenden Kosten."}],faqTR:[{question:"Alman mahkeme kararı Türkiye'de doğrudan icra edilebilir mi?",answer:"Hayır. MÖHUK m. 50 vd. uyarınca önce Türk mahkemesinden tenfiz kararı alınmalıdır. Başlığınızı ücretsiz olarak inceliyoruz."},{question:"Alman ödeme emri (Vollstreckungsbescheid) tenfiz edilebilir mi?",answer:"Hayır, yalnızca delil değeri taşır. Bu durumda ilamsız icra takibi veya Türkiye'de dava açma seçeneklerini birlikte değerlendiriyoruz."},{question:"Süreç ne kadar sürer?",answer:"Tenfiz süreci çoğu zaman sekiz ayı aşar; belirleyici olan tebligattır. Sonrasında hesap haczi hızlı sonuç verir."},{question:"Alacaklı olarak Türkiye'ye gelmem gerekir mi?",answer:"Hayır. Süreç, konsolosluktan veya apostilli noterden alınan bir vekaletname ile yürütülür."},{question:"Bu hizmet, genel icra ve iflas sayfanızdan farkı nedir?",answer:"Bu sayfa, yabancı (özellikle Alman) kararların Türkiye'de tanınması ve tenfizine — kurumsal alacaklılar için tenfiz, ihtiyati haciz ve mal varlığı araştırmasına — odaklanır. Elinizde zaten bir Türk başlığı varsa veya doğrudan bir Türk borçluya karşı icra gerekiyorsa İcra ve İflas sayfamızı inceleyebilirsiniz."},{question:"Ön inceleme ücretli mi?",answer:"Hayır. Başlığı ve kısa bir olay özetini gönderin; tenfize elverişlilik, uygun yol ve öngörülen maliyet konusunda değerlendirme alın."}],faqEN:[{question:"Can a foreign judgment be enforced directly in Turkey?",answer:"No. A separate declaration of enforceability (tenfiz) by a Turkish court is required under Articles 50 et seq. MÖHUK. We assess your title free of charge."},{question:"Is a default payment order recognisable in Turkey?",answer:"No, it carries evidentiary weight at best. In that case we assess whether enforcement without a title (ilamsız icra takibi) or litigation in Turkey is the better route."},{question:"How long does the process take?",answer:"Recognition proceedings frequently take eight months or more; service on the debtor is the decisive factor. Enforcement afterwards is much faster for bank accounts."},{question:"Do I need to travel to Turkey as the creditor?",answer:"No. The entire procedure runs on a notarised power of attorney executed at a Turkish consulate or before a notary with an apostille."},{question:"How is this different from your general debt-enforcement service?",answer:"This page specialises in recognising and enforcing foreign (particularly German) judgments in Turkey — tenfiz, preliminary attachment and asset tracing for institutional creditors. If you already hold a Turkish title, or need to proceed directly against a Turkish debtor, see our Debt Enforcement in Turkey (general) service page."},{question:"Does the initial assessment cost anything?",answer:"No. Send us the title and a brief summary of the facts and you will receive an assessment of recognisability, the applicable route and expected costs."}]},o=[{id:"familienrecht",slugDE:"familienrecht",slugTR:"aile-hukuku",slugEN:"family-law",icon:n,title:"Familienrecht & Scheidung",titleTR:"Aile Hukuku ve Boşanma",titleEN:"Family Law & Divorce",descriptionEN:"Turkish-origin families across Germany often face a dual challenge with divorce and maintenance: two legal systems, two countries, one family. Turkish family law differs significantly from German law and requires a lawyer who understands both sides.",detailEN:"Turkish law only · Ankara Bar member and §207 BRAO registration · Full process without travel to Turkey · Advice in Turkish, German and English · Available throughout Germany by phone, video and WhatsApp · Mannheim and Ankara offices for direct coordination with Turkish courts",seoTitleEN:"Turkish Divorce Lawyer Germany | Family Law & Tanima Tenfiz | Hasan Doğru",seoDescriptionEN:"Turkish family law for clients in Germany: divorce in Turkey, maintenance and recognition of German divorce judgments. No travel to Turkey required.",expertiseTitleEN:"Why Doğru Kanzlei for Germany-Turkey Family Law?",contentEN:`Family Law & Divorce — Turkish Family Law from Mannheim
...
After a divorce, questions arise about name changes under Turkish law. We advise on your options and handle the name change process with Turkish authorities.`,faqEN:[{question:"Is my German divorce valid in Turkey?",answer:"No, not automatically. A German divorce decision usually needs to be recognised in Turkey before your marital status is updated there. Depending on the decision, Tanıma, Tenfiz or a combined procedure may be required."},{question:"Can maintenance be enforced in Turkey?",answer:"Yes, if the legal requirements are met. German maintenance decisions or arrangements often need to be made enforceable in Turkey through Tenfiz before enforcement measures can be considered."},{question:"How much does an initial consultation cost?",answer:"The cost depends on the scope of your case and the documents that need to be reviewed. Before the consultation, you receive clear information about the fee and what will be assessed."},{question:"Which documents do I need for Tanıma & Tenfiz?",answer:"Usually you need the German divorce decision, proof that it is final, an apostille, a certified Turkish translation and a suitable power of attorney. We check your specific decision and tell you which documents are required."}],seoTitleDE:"Türkisches Familienrecht Deutschland | Scheidung Türkei | Doğru Kanzlei",seoDescriptionDE:"Türkischer Anwalt für Scheidung & Familienrecht in Mannheim. Boşanma, Unterhalt und Tanıma Tenfiz mit Türkeibezug — deutschlandweit ohne Türkeireise.",seoTitleTR:"Almanya Türk Boşanma Avukatı | Aile Hukuku & Tanıma Tenfiz | Hasan Doğru",seoDescriptionTR:"Türkiye bağlantılı boşanma, nafaka ve tanıma tenfiz süreci — Almanya'dan seyahatsiz. Mannheim'dan Türkçe hukuki destek. Hemen WhatsApp'tan yazın.",description:"Almanya genelindeki Türk aileler; boşanma veya nafaka konularında sıklıkla çift taraflı bir zorlukla karşılaşır: iki hukuk sistemi, iki ülke, bir aile. Türk aile hukuku, Alman hukukundan önemli noktalarda ayrılır ve iki tarafı da bilen bir avukat gerektirir.",descriptionDE:"Türkischstämmige Familien in ganz Deutschland stehen bei Scheidung oder Unterhalt mit Türkeibezug oft vor einer besonderen Herausforderung: Zwei Rechtssysteme, zwei Länder, eine Familie. Das türkische Familienrecht unterscheidet sich in wesentlichen Punkten vom deutschen Recht — und erfordert einen Anwalt, der beide Seiten kennt.",detail:"Yalnızca Türk hukuku — tam uzmanlaşma · Ankara Barosu üyesi, § 207 BRAO kapsamında kayıtlı · Türkiye'ye seyahat etmeden süreç yönetimi · Türkçe ve Almanca danışmanlık · Almanya genelinde telefon, video ve WhatsApp ile ulaşılabilir · Mannheim ve Ankara ofisleriyle Türk mahkemeleriyle doğrudan iş birliği",detailDE:"Ausschließlich türkisches Recht — keine Kompromisse, volle Spezialisierung · Mitglied der Ankara Barosu und registriert gemäß § 207 BRAO · Verfahren vollständig ohne Reise in die Türkei möglich · Beratung auf Türkisch und Deutsch · Deutschlandweite Betreuung per Telefon oder Video · Standorte Mannheim und Ankara für direkte Zusammenarbeit mit türkischen Gerichten",expertiseTitleDE:"Warum Doğru Kanzlei für türkisches Familienrecht mit Deutschland-Türkei-Bezug?",expertiseTitleTR:"Türkiye Bağlantılı Aile Hukukunda Neden Doğru Kanzlei?",content:`Aile Hukuku ve Boşanma — Mannheim'da Türk Aile Hukuku
...
Nach einer Scheidung stellen sich Fragen zur Namensänderung nach türkischem Recht. Wir beraten Sie zu Ihren Optionen und übernehmen die Abwicklung der Namensänderung bei türkischen Behörden.`,faqDE:[{question:"Gilt meine deutsche Scheidung in der Türkei?",answer:"Nein, nicht automatisch. Eine in Deutschland ausgesprochene Scheidung muss in der Türkei anerkannt werden, damit Ihr Personenstand dort korrekt als geschieden eingetragen wird. Je nach Inhalt des deutschen Beschlusses kommt Tanıma, Tenfiz oder ein kombiniertes Verfahren in Betracht."},{question:"Kann ich Unterhalt in der Türkei durchsetzen?",answer:"Ja, wenn die rechtlichen Voraussetzungen erfüllt sind. Deutsche Unterhaltsentscheidungen oder Unterhaltsregelungen müssen in der Türkei regelmäßig über Tenfiz vollstreckbar gemacht werden. Danach können Vollstreckungsmaßnahmen in der Türkei geprüft und eingeleitet werden."},{question:"Was kostet eine Erstberatung?",answer:"Die Kosten hängen vom Umfang Ihres Falls ab. In der Erstberatung prüfen wir Ihre Ausgangslage, die relevanten Unterlagen und den sinnvollsten nächsten Schritt. Sie erhalten vorab eine klare Information zu den Kosten der Beratung."},{question:"Welche Unterlagen brauche ich für Tanıma & Tenfiz?",answer:"Typischerweise benötigen Sie den deutschen Scheidungsbeschluss, den Rechtskraftvermerk, eine Apostille, eine beglaubigte türkische Übersetzung und eine geeignete Vollmacht. Welche Dokumente genau erforderlich sind, prüfen wir anhand Ihres Beschlusses."}],faqTR:[{question:"Almanya'daki boşanma kararım Türkiye'de geçerli mi?",answer:"Hayır, otomatik olarak geçerli olmaz. Almanya'da verilen boşanma kararının Türkiye'de nüfus kayıtlarına işlenebilmesi için genellikle Tanıma veya Tenfiz süreci gerekir. Kararınızı inceleyerek hangi yolun gerekli olduğunu belirliyoruz."},{question:"Nafakayı Türkiye'de tahsil edebilir miyim?",answer:"Evet, hukuki şartlar sağlanıyorsa nafaka kararının Türkiye'de icrası mümkündür. Alman mahkemesi kararı veya nafaka düzenlemesi için çoğu zaman Tenfiz süreci gerekir; ardından Türkiye'deki icra yolları değerlendirilebilir."},{question:"İlk danışma ücreti ne kadar?",answer:"Ücret, dosyanın kapsamına ve incelenecek belgelere göre değişir. İlk değerlendirmede durumunuzu, mevcut kararları ve en doğru sonraki adımı netleştiririz. Danışma ücreti konusunda görüşmeden önce açık bilgi verilir."},{question:"Tanıma ve Tenfiz için hangi belgeler gerekir?",answer:"Genellikle boşanma kararı, kesinleşme şerhi, apostil, yeminli Türkçe tercüme ve uygun vekaletname gerekir. Dosyanızdaki kararın içeriğine göre ek belgeler gerekip gerekmediğini ayrıca kontrol ediyoruz."}]},{id:"vollmacht-apostille",slugDE:"vollmacht-apostille",slugTR:"vekaletname-ve-apostil",slugEN:"power-of-attorney",icon:i,title:"Vollmacht & Apostille",titleTR:"Vekaletname & Apostil",titleEN:"Power of Attorney & Apostille",descriptionEN:"Power of attorney for Turkey from Germany, notarised powers, apostilles and certified documents for Turkish authorities — prepared correctly and without unnecessary travel.",detailEN:"Notarisation · Legalisation · Apostille · Consular services · Translation · Legal advice",seoTitleEN:"Power of Attorney for Turkey | Apostille Documents | Doğru Kanzlei",seoDescriptionEN:"Power of attorney for Turkey, general powers, property and inheritance powers, apostille documents and Turkish document certification from Germany.",expertiseTitleEN:"Why Doğru Kanzlei for Powers of Attorney for Turkey?",contentEN:`Power of Attorney & Apostille — Power of Attorney for Turkey from Germany
...
We support you throughout the entire process — fast, reliable and with well-founded experience in German-Turkish legal practice.`,faqEN:[{question:"What is an apostille and why do I need one?",answer:"An apostille is an international certification that makes German documents legally valid for use in Turkey. Without an apostille, Turkish authorities, courts and banks generally do not recognise German documents."},{question:"Can I issue a power of attorney for Turkey in Germany?",answer:"Yes. You can have a power of attorney notarised by a German notary — followed by apostille and a certified Turkish translation. We coordinate the entire process and ensure the power of attorney meets the current requirements of Turkish authorities."},{question:"How long is a power of attorney for Turkey valid?",answer:"This depends on the type of power of attorney. Many Turkish authorities only accept powers of attorney that are no more than 6 months old. We advise you on the optimal validity period for your specific purpose."},{question:"What happens if my power of attorney is rejected by Turkish authorities?",answer:"This happens more often than one might think — usually because of outdated wording or missing specific powers. We ensure your power of attorney is correctly issued from the outset and meets all current requirements."},{question:"Can I also have a power of attorney certified through the Turkish consulate?",answer:"Yes. As an alternative to the apostille, certification can be done through the Turkish consulate in Germany. We advise which route is faster and more cost-effective for your situation."}],seoTitleDE:"Vollmacht Türkei erstellen | Konsulat, Notar, Apostille & Türkisch",seoDescriptionDE:"Vollmacht für die Türkei erstellen lassen: türkische Vollmacht, Konsulat oder deutscher Notar, Apostille, Übersetzung, Unterlagen und Kosten. Per WhatsApp prüfen lassen.",seoTitleTR:"Vekaletname Almanya | Konsolosluk, Noter, Apostil ve Ücretler",seoDescriptionTR:"Türkiye için vekaletname Almanya'da nasıl hazırlanır? Konsolosluk, Alman noteri, apostil, gerekli belgeler ve ücretler. Süreci WhatsApp'tan Hasan Doğru ile başlatın.",description:"Almanya'da Türkiye için vekaletname hazırlama hizmeti: konsolosluk veya Alman noteri yolunu seçiyor, apostil ve tercüme adımlarını netleştiriyor, tapu, miras, banka ve mahkeme işlemleri için kullanılabilir vekaletname metnini hazırlıyoruz.",descriptionDE:"Vollmacht für die Türkei erstellen lassen: Wir prüfen, ob türkisches Konsulat, deutscher Notar, Apostille oder beglaubigte Übersetzung der richtige Weg ist und bereiten die türkische Vollmacht für Immobilien, Erbschaft, Bank, Gericht oder Behörden praktisch verwendbar vor.",detail:"Noter Onayı · Tasdik · Apostil · Konsolosluk İşlemleri · Tercüme · Hukuki Danışmanlık",detailDE:"Beglaubigung · Notarielle Beurkundung · Apostille · Konsularische Dienste · Übersetzung · Rechtsberatung",content:`Vekaletname Almanya — Türkiye İçin Vekaletname Hazırlama Hizmeti

Konsolosluk, Alman noteri, apostil ve tercüme adımlarını sizin için netleştiriyoruz.

Almanya'da yaşıyor ve Türkiye'de tapu, miras, banka, mahkeme, boşanma, şirket veya resmi kurum işlemi yaptırmak istiyorsanız doğru hazırlanmış bir vekaletnameye ihtiyacınız olabilir. İnternette "vekaletname Almanya nasıl çıkarılır", "Almanya noter vekaletname ücreti", "konsolosluk vekaletname için ne lazım" veya "apostil Almanya Türkiye nereden alınır" diye arayan kişilerin asıl ihtiyacı çoğu zaman sadece bilgi değil, hatasız ve kullanılabilir bir belgedir.

Hasan Doğru olarak vekaletnamenin amacını inceliyor, konsolosluk mu Alman noteri mi daha doğru olur, apostil gerekir mi, tercüme ve tasdik hangi sırayla yapılmalı, hangi belgeler hazırlanmalı gibi soruları dosyanıza göre cevaplıyoruz. Amaç, Türkiye'de kabul edilebilir bir vekaletnameyle süreci baştan doğru kurmaktır.

Sizin için neler yapıyoruz:

- Türkiye İçin Vekaletname Metni
Tapu, miras, banka, mahkeme, boşanma, şirket ve resmi kurum işlemleri için gerekli yetkileri işlem amacına göre hazırlıyoruz.

- Konsolosluk veya Alman Noteri Yolunu Seçme
Türk konsolosluğu vekaletnamesi ile Alman noterinde düzenlenen vekaletname aynı süreç değildir. Hangi yolun daha hızlı ve uygun olduğunu değerlendiriyoruz.

- Apostil Almanya Türkiye
Alman noterinde düzenlenen belgeler için apostil, tercüme ve Türkiye'de kullanım adımlarını kontrol ediyoruz.

- Vekaletname Ücreti ve Gerekli Belgeler
Noter, konsolosluk, apostil, tercüme ve hukuki hazırlık masraflarının hangi kalemlerden oluştuğunu baştan netleştiriyoruz.

- Genel Vekaletname Türkiye
Genel vekaletnamenin uygun olup olmadığını ve hangi yetkilerin mutlaka açık yazılması gerektiğini değerlendiriyoruz.

- Tapu Vekaletname Almanya
Türkiye'de gayrimenkul alım, satım, devir veya tapu işlemleri için özel yetkileri doğru şekilde hazırlıyoruz.

- Miras Vekaletname Almanya
Veraset ilamı, miras paylaşımı, tapu devri ve banka işlemleri için vekaletname sürecini kuruyoruz.

- Banka ve Mahkeme İşlemleri
Türkiye'deki banka hesapları, dava dosyaları ve resmi kurum işlemleri için gereken temsil yetkilerini planlıyoruz.

Önemli Uyarı:
Türk makamlarının güncel gerekliliklerini karşılamayan bir vekaletname, noter onaylı olsa dahi reddedilebilir. En sık sorunlar eksik yetki, yanlış noter yolu, eksik apostil, hatalı tercüme, fotoğraf veya kimlik bilgilerindeki eksikliklerdir. Süreci WhatsApp üzerinden başlatabilir, hangi işlem için vekaletname gerektiğini anlatarak done-for-you destek alabilirsiniz.`,contentDE:`Vollmacht Türkei erstellen lassen — Konsulat, Notar, Apostille oder türkische Vollmacht?

Wenn Sie in Deutschland leben und eine Vollmacht für die Türkei benötigen, ist die wichtigste Frage nicht nur: "Wo bekomme ich eine Vollmacht?" Entscheidend ist, welcher Weg für Ihren Zweck akzeptiert wird: türkisches Konsulat, deutscher Notar, Apostille, beglaubigte Übersetzung oder eine speziell formulierte türkische Vollmacht.

Viele suchen nach "Vollmacht auf Türkisch", "türkischer Notar in der Nähe", "türkisches Konsulat Termin", "Apostille Türkei" oder "Vollmacht Türkei erstellen". Dahinter steht meist ein konkreter Vorgang: Immobilienverkauf, Tapu-Übertragung, Erbschaft, Bankkonto, Gerichtsverfahren, Scheidung oder ein Behördentermin in der Türkei.

Wir prüfen für Sie, ob der Konsularweg schneller und rechtssicherer ist oder ob eine deutsche notarielle Vollmacht mit Apostille und Übersetzung sinnvoll ist. Danach bereiten wir Wortlaut, Unterlagen und nächste Schritte so vor, dass die Vollmacht in der Türkei praktisch verwendet werden kann.
...
• Vollmacht auf Türkisch — wir achten nicht nur auf Übersetzung, sondern auf den richtigen rechtlichen Wortlaut
• Apostille Türkei — wir prüfen, ob Apostille und beglaubigte Übersetzung erforderlich sind
• Unterlagen und Kosten — wir nennen die typischen Dokumente und Kostenblöcke vorab
• Immobilien und Tapu — spezielle Vollmacht für Kauf, Verkauf, Übertragung oder Verwaltung
• Erbschaft und Bank — Vollmacht für Veraset İlamı, Nachlass, Tapu und Bankkonten
• Gericht und Behörden — Vollmacht für Verfahren, Anträge und behördliche Schritte in der Türkei
• Deutschlandweit — Unterstützung für Mandanten aus Hamburg, Köln, Düsseldorf, Nürnberg, Essen, Frankfurt, Stuttgart, Karlsruhe, Berlin, München und Mannheim

Wichtiger Hinweis:
Eine Vollmacht, die nicht den aktuellen Anforderungen türkischer Behörden entspricht, kann zurückgewiesen werden — selbst wenn sie notariell beglaubigt wurde. Gerade deshalb lohnt sich eine kurze Prüfung, bevor Sie einen Konsulatstermin buchen, zum deutschen Notar gehen oder Apostille und Übersetzung beauftragen.

Schildern Sie kurz per WhatsApp, wofür die Vollmacht in der Türkei benötigt wird. Wir prüfen Konsulat, Notar, Apostille, Übersetzung, Unterlagen, Kostenblöcke und den passenden nächsten Schritt.`,faqDE:[{question:"Wie kann ich eine Vollmacht für die Türkei in Deutschland erstellen lassen?",answer:"Zuerst wird geprüft, wofür die Vollmacht in der Türkei gebraucht wird. Danach entscheiden wir, ob türkisches Konsulat, deutscher Notar, Apostille und beglaubigte Übersetzung erforderlich sind. Der Wortlaut muss zum konkreten Zweck passen, etwa Immobilien, Erbschaft, Bank, Gericht oder Behörden."},{question:"Konsulat oder deutscher Notar: Welcher Weg ist richtig?",answer:"Das hängt vom Vorgang ab. Eine Konsularvollmacht wird direkt über das türkische Konsulat erstellt. Bei einer deutschen notariellen Vollmacht sind häufig Apostille und Übersetzung nötig. Wir prüfen, welcher Weg für Ihren Zweck, Ihre Frist und die zuständige Stelle in der Türkei sinnvoll ist."},{question:"Gibt es einen türkischen Notar in der Nähe?",answer:"In Deutschland handeln Notare nach deutschem Recht. Für türkische Vollmachten kommen in der Praxis meist das türkische Konsulat oder ein deutscher Notar mit Apostille und Übersetzung in Betracht. Der Begriff 'türkischer Notar' führt deshalb oft in die falsche Richtung; wichtig ist die Anerkennung in der Türkei."},{question:"Reicht eine Vollmacht auf Türkisch oder brauche ich eine spezielle Formulierung?",answer:"Eine bloße Übersetzung reicht oft nicht. Türkische Behörden verlangen konkrete Befugnisse. Für Tapu, Erbschaft, Bank oder Gericht muss die Vollmacht meist genau die Handlung abdecken, die später in der Türkei vorgenommen werden soll."},{question:"Wann brauche ich eine Apostille für die Türkei?",answer:"Bei deutschen Notar- oder Behördendokumenten ist für die Verwendung in der Türkei häufig eine Apostille erforderlich. Danach kann zusätzlich eine beglaubigte Übersetzung nötig sein. Bei Konsularvollmachten kann die Bewertung anders sein."},{question:"Welche Unterlagen brauche ich für eine türkische Vollmacht?",answer:"Typisch sind Ausweis oder Pass, Daten der bevollmächtigten Person, Zweck der Vollmacht, Aktenzeichen, Tapu-Daten, Bankdaten, vorhandene Schreiben der türkischen Behörde und je nach Vorgang Fotos. Die genaue Liste hängt vom Zweck ab."},{question:"Was kostet eine Vollmacht für die Türkei?",answer:"Die Kosten hängen vom Weg ab: Konsulat, deutscher Notar, Apostille, Übersetzung und anwaltliche Vorbereitung können unterschiedliche Kostenblöcke auslösen. Wenn Sie den Zweck kurz per WhatsApp schildern, prüfen wir, welche Kostenpunkte realistisch sind."},{question:"Unterstützen Sie auch Mandanten aus Hamburg, Köln, Düsseldorf, Nürnberg oder Essen?",answer:"Ja. Wir betreuen Mandanten deutschlandweit, unter anderem aus Hamburg, Köln, Düsseldorf, Nürnberg, Essen, Frankfurt, Stuttgart, Karlsruhe, Berlin, München und Mannheim. Viele Schritte können per WhatsApp, Telefon und Video vorbereitet werden."},{question:"Welche Vollmacht brauche ich für Immobilien oder Erbschaft in der Türkei?",answer:"Für Immobilien, Tapu-Übertragung, Kauf, Verkauf, Erbschaft, Veraset İlamı, Nachlass und Bankkonten sind meist konkrete Sonderbefugnisse erforderlich. Wir prüfen, welche Befugnisse im Einzelfall aufgenommen werden müssen."}],faqTR:[{question:"Vekaletname Almanya nasıl çıkarılır?",answer:"Önce vekaletnamenin Türkiye'de hangi işlem için kullanılacağı netleştirilir. Sonra konsolosluk yolunun mu, Alman noteri + apostil + tercüme yolunun mu daha doğru olduğu belirlenir. Tapu, miras, banka veya mahkeme işlemi için metindeki yetkilerin açık ve Türkiye'de kabul edilebilir şekilde yazılması gerekir."},{question:"Almanya'da vekaletname ücreti ne kadar?",answer:"Vekaletname ücreti; işlemin türüne, konsolosluk veya Alman noteri yoluna, noter ücretine, apostil ihtiyacına, tercüme masrafına ve hukuki metin hazırlığına göre değişir. WhatsApp üzerinden işlem amacınızı yazarsanız hangi masraf kalemlerinin oluşacağını netleştiriyoruz."},{question:"Konsolosluk mu Alman noteri mi daha doğru?",answer:"Her dosyada cevap aynı değildir. Konsoloslukta düzenlenen vekaletname Türk makamları için doğrudan daha pratik olabilir. Alman noterinde düzenlenen vekaletnamede ise çoğu zaman apostil ve tercüme adımları gerekir. İşlem türüne, randevu durumuna ve Türkiye'deki kurumun beklentisine göre doğru yolu seçiyoruz."},{question:"Apostil Almanya Türkiye işlemi ne zaman gerekir?",answer:"Alman makamı veya Alman noteri tarafından düzenlenen bir belgenin Türkiye'de kullanılabilmesi için çoğu zaman apostil gerekir. Konsoloslukta düzenlenen vekaletname için durum farklı olabilir. Apostil gerekip gerekmediğini belgenin kaynağına ve kullanım amacına göre kontrol ediyoruz."},{question:"Vekaletname için hangi belgeler gerekir?",answer:"Genellikle kimlik veya pasaport bilgileri, Türkiye'de vekil olacak kişinin kimlik bilgileri, işlem konusu, tapu veya dosya bilgileri, gerekirse fotoğraf ve Türkiye'deki kurumdan gelen metin ya da talep gerekir. Tapu, araç, boşanma, miras veya mahkeme işlemlerinde belge listesi değişebilir."},{question:"Tapu vekaletname Almanya'dan çıkarılabilir mi?",answer:"Evet. Türkiye'deki taşınmaz alım, satım veya devir işlemleri için Almanya'dan tapu vekaletnamesi hazırlanabilir. Vekaletnamede taşınmaz işlemleri için gerekli yetkilerin açık ve Türk makamlarınca kabul edilebilir şekilde yer alması gerekir."},{question:"Miras vekaletname Almanya'da nasıl hazırlanır?",answer:"Veraset ilamı, miras paylaşımı, tapu devri veya banka işlemleri için miras vekaletnamesi Almanya'da hazırlanabilir. Hangi yetkilerin gerekli olduğunu dosyanızdaki miras işlemlerine göre kontrol ediyoruz."},{question:"Stuttgart, Karlsruhe, Frankfurt veya Köln konsolosluğu için vekaletname hazırlıyor musunuz?",answer:"Evet. Almanya'nın farklı şehirlerindeki müvekkiller için konsolosluk veya Alman noteri yolunu değerlendiriyoruz. Randevuya gitmeden önce vekaletname amacını, gerekli belgeleri ve metindeki yetkileri hazırlayarak hata riskini azaltıyoruz."},{question:"Tapu, miras, banka ve mahkeme için aynı vekaletname yeterli mi?",answer:"Her zaman yeterli değildir. Bazı işlemler özel yetki gerektirir. Tapu, miras, banka veya mahkeme dosyasında eksik yetki varsa Türkiye'deki kurum vekaletnameyi kabul etmeyebilir. Bu yüzden metni işlem amacına göre hazırlıyoruz."},{question:"Hasan Doğru vekaletname sürecinde neyi üstleniyor?",answer:"Dosyanızın amacını değerlendiriyor, doğru yol haritasını çıkarıyor, vekaletname metnini ve gerekli belge listesini hazırlıyor, apostil-tercüme-tasdik adımlarını açıklıyor ve Türkiye'de kullanılabilir bir belge için süreci baştan doğru kurmanıza yardımcı oluyoruz."},{question:"Vekaletname reddedilirse ne olur?",answer:"Vekaletname Türk makamlarınca reddedilirse işlem gecikir ve çoğu zaman belgenin yeniden hazırlanması gerekir. En sık nedenler eksik yetki, hatalı tercüme, eksik apostil veya güncel olmayan metindir."}]},{id:"migrationsrecht",slugDE:"migrationsrecht",slugTR:"goc-hukuku",slugEN:"migration-law",icon:r,title:"Migrationsrecht",titleTR:"Göç Hukuku",titleEN:"Migration Law",descriptionEN:"Planning a move to Turkey, considering retirement there, or have questions about your Mavi Kart? Turkish migration law is complex — especially for people of Turkish origin with a German passport or dual citizenship.",seoTitleEN:"Turkish Migration Law Mannheim | Mavi Kart & Residence in Turkey | Doğru Kanzlei",seoDescriptionEN:"Residence permit, Mavi Kart and relocation to Turkey — legally guided from Mannheim. Avukat Hasan Doğru advises on Turkish migration law.",expertiseTitleEN:"Why Doğru Kanzlei for Turkish Migration Law?",contentEN:`Migration Law — Turkish Migration Law from Mannheim
...
- Türkçe ve Almanca danışmanlık
- Mannheim'da yüz yüze görüşme imkânı
- Ankara'da ikinci ofis — Türk ceza mahkemeleri ve makamlarına doğrudan erişim`,contentDE:`Türkisches Strafrecht Anwalt Deutschland — Strafverteidigung in der Türkei aus Deutschland
...
- Beratung auf Türkisch und Deutsch
- Standort Mannheim — persönliche Beratung im Rhein-Neckar-Raum
- Zweiter Standort Ankara — direkter Zugang zu türkischen Strafgerichten und Behörden`,faqDE:[{question:"Was tun bei einer Vorladung Türkei Deutschland?",answer:"Reisen Sie nicht vorschnell in die Türkei und antworten Sie nicht ohne Prüfung. Wir analysieren die Vorladung, prüfen den Aktenstand und klären, ob ein Haftbefehl, Reiseverbot oder weiteres Risiko besteht."},{question:"Wie prüfe ich einen Haftbefehl Türkei?",answer:"Ein Haftbefehl Türkei sollte über anwaltliche Akteneinsicht und offizielle Wege geprüft werden. Wir klären, ob eine Tutuklama Müzekkeresi, ein Reiseverbot oder ein anderer Eintrag vorliegt und welche Schritte vor einer Reise sinnvoll sind."},{question:"Was macht ein Interpol Red Notice Anwalt?",answer:"Ein Interpol Red Notice Anwalt prüft die Grundlage der Ausschreibung, bereitet Anträge auf Überprüfung, Sperrung oder Löschung vor und koordiniert die Verteidigung gegenüber Interpol, deutschen Stellen und türkischen Behörden."},{question:"Wie läuft Auslieferung Türkei Deutschland ab?",answer:"Bei Auslieferung Türkei Deutschland müssen deutsche Behörden und das türkische Strafverfahren parallel betrachtet werden. Wir prüfen den türkischen Hintergrund, koordinieren die Verteidigungsstrategie und klären, welche Unterlagen und Einwände relevant sind."},{question:"Brauche ich einen Militärdienst Türkei Anwalt?",answer:"Wenn Bakaya, Yoklama Kaçağı oder ein offener Militärdienststatus im Raum steht, sollte der Status vor jeder Türkei-Reise geprüft werden. Wir klären die Lage und besprechen die Optionen für eine sichere Lösung."},{question:"Kann ich türkisches Strafrecht ohne Reise klären?",answer:"Viele erste Schritte sind ohne Reise möglich: Statusprüfung, Akteneinsicht, Dokumentenprüfung, Vollmacht und strategische Vorbereitung. Ob eine persönliche Anwesenheit später nötig wird, hängt vom konkreten Verfahren ab."},{question:"Was kostet eine Strafverteidigung nach türkischem Recht?",answer:"Die Kosten hängen vom Umfang des Verfahrens, der Anzahl der Instanzen und der Komplexität des Falls ab. Nach einer ersten Analyse erstellen wir Ihnen ein transparentes Angebot — ohne versteckte Kosten."}],faqTR:[{question:"Türkiye hakaret davası Almanya'dan takip edilebilir mi?",answer:"Evet, birçok hakaret dosyasında ilk statü kontrolü, şikayet süresi, uzlaşma ihtimali, delil incelemesi ve savunma hazırlığı Almanya'dan yapılabilir. Türkiye'ye gitmeden önce UYAP ve yakalama kararı riski kontrol edilmelidir."},{question:"Sosyal medyada hakaret Türkiye avukat Almanya desteği ne sağlar?",answer:"WhatsApp, Instagram, Facebook veya diğer sosyal medya içerikleri nedeniyle Türkiye'de hakaret şikayeti varsa, mesajların bağlamı, deliller, şikayet süresi ve uzlaşma seçeneği incelenir. Almanya'dan avukat desteğiyle dosya stratejisi hazırlanabilir."},{question:"Türkiye uyuşturucu davası veya dolandırıcılık davası Almanya'dan savunulabilir mi?",answer:"Uyuşturucu, dolandırıcılık, tehdit, sahtecilik, hırsızlık veya yağma dosyalarında ilk adım suç vasfını, dosya aşamasını ve yakalama riskini kontrol etmektir. Birçok hazırlık ve temsil adımı vekaletname ile Almanya'dan yürütülebilir."},{question:"Türkiye yakalama kararı Almanya'da nasıl kontrol edilir?",answer:"Yakalama kararı riski avukat aracılığıyla dosya ve UYAP statüsü incelenerek değerlendirilir. Kişi Türkiye'ye gitmeden önce mahkeme celbi, tutuklama müzekkeresi, adli kontrol veya seyahat riski netleştirilmelidir."},{question:"Kırmızı bülten avukatı Almanya'da ne yapar?",answer:"Kırmızı bülten veya Interpol arama kaydı varsa avukat, bültenin dayanağını, Türkiye'deki dosyanın durumunu ve itiraz/kaldırma imkanlarını inceler. Almanya ve Türkiye tarafındaki strateji birlikte planlanmalıdır."},{question:"Türkiye ceza davası vekalet Almanya üzerinden yürütülebilir mi?",answer:"Birçok Türk ceza dosyasında vekaletname ile dosya inceleme, başvuru, dilekçe ve savunma hazırlığı mümkündür. Ancak ifade veya duruşmada kişisel katılım gerekip gerekmediği dosyanın türüne, mahkemeye ve aşamaya göre ayrıca değerlendirilir."},{question:"Ceza avukatı Almanya'dan Türkiye'de beni temsil edebilir mi?",answer:"Birçok Türk ceza dosyasında ilk değerlendirme, statü kontrolü, vekaletname ve savunma hazırlığı Almanya'dan yapılabilir. Kişisel katılım gerekip gerekmediği dosyanın aşamasına ve mahkemenin kararına bağlıdır."},{question:"Interpol arama bülteni Almanya'da ne anlama gelir?",answer:"Interpol arama bülteni seyahat özgürlüğünüzü etkileyebilir ve sınır geçişlerinde gözaltı riskine yol açabilir. Bültenin hukuki dayanağını inceliyor, gerekli hallerde inceleme veya kaldırma başvuruları için strateji hazırlıyoruz."},{question:"Tutuklama müzekkeresi varsa Türkiye'ye girebilir miyim?",answer:"Tutuklama müzekkeresi veya seyahat yasağı varsa Türkiye'ye girişte havalimanında gözaltı riski doğabilir. Seyahat etmeden önce statünüzün avukat aracılığıyla kontrol edilmesi gerekir."},{question:"Askerlik kaçağı Almanya avukat desteği ne sağlar?",answer:"Askerlik kaçağı, bakaya veya yoklama kaçağı durumunda Türkiye'ye giriş riskleri ve resmi kayıtlar kontrol edilmelidir. Avukat desteğiyle statünüz netleştirilir ve sonraki adımlar planlanır."},{question:"Bakaya Almanya durumunda ne olur?",answer:"Bakaya kaydı olan kişiler Türkiye'ye girişte idari veya adli risklerle karşılaşabilir. Önce resmi durumun tespit edilmesi, ardından yükümlülüklerin ve güvenli hareket planının belirlenmesi gerekir."},{question:"Türkiye ceza davası Almanya'dan takip edilebilir mi?",answer:"Evet, birçok işlem vekaletname, dijital dosya takibi ve avukat temsili ile Almanya'dan hazırlanabilir. Ancak duruşmaya katılım veya ifade gerekip gerekmediği dosyanın türüne göre ayrıca değerlendirilir."},{question:"Türk ceza savunmasının maliyeti nedir?",answer:"Maliyet, davanın kapsamına, yargılama aşaması sayısına ve karmaşıklığına bağlıdır. İlk değerlendirmenin ardından şeffaf bir teklif sunuyoruz — gizli ücret olmaksızın."}]},{id:"tanima-ve-tenfiz",slugDE:"tanima-ve-tenfiz",slugTR:"tanima-ve-tenfiz",slugEN:"recognition-enforcement",icon:n,title:"Tanıma & Tenfiz",titleTR:"Tanıma ve Tenfiz",titleEN:"Recognition & Enforcement",descriptionEN:"Your German divorce is not automatically valid in Turkey. We handle recognition and enforcement of German divorce decisions in Turkey — fully from Germany, without travel.",seoTitleEN:"Recognise German Divorce in Turkey | Tanima Tenfiz | Doğru Kanzlei",seoDescriptionEN:"Still considered married in Turkey after a German divorce? We handle the Tanıma & Tenfiz procedure from Germany, without travel to Turkey.",expertiseTitleEN:"Why Doğru Kanzlei for Recognition & Enforcement?",contentEN:`Recognition & Enforcement — Having a German Divorce Recognised in Turkey
...
- Türkçe ve Almanca danışmanlık
- Mannheim'da yüz yüze görüşme imkânı
- Ankara'da ikinci ofis — Türk mahkemeleriyle doğrudan iş birliği`,contentDE:`Tanıma Tenfiz Anwalt Deutschland — Deutsche Scheidung in der Türkei anerkennen lassen
...
Hukuk büromuz, Türk ve Türk-Alman hukukunda derin uzmanlığıyla yanınızda — her iki ülkeyle hukuki bağınızı güvenle korumak için.`,contentDE:`Mavi Kart Rechte Türkei — Erbrecht, Immobilien und Aufenthalt für ehemalige türkische Staatsbürger
...
Sonuç:
Çıkarlarınızı kararlılıkla savunuyor ve Türkiye'deki alacaklarınızı takip ediyoruz — güvenilir, şeffaf ve Almanya'dan tam hizmetle.`,contentDE:`Forderung Türkei eintreiben — Zwangsvollstreckung und İcra Takibi aus Deutschland
...
Fazit:
Wir vertreten Ihre Interessen konsequent und verfolgen Ihre Forderungen in der Türkei — zuverlässig, transparent und mit vollem Service aus Deutschland.`},l,{id:"erbrecht",slugDE:"erbrecht",slugTR:"miras-hukuku",slugEN:"inheritance-law",icon:a,title:"Erbrecht",titleTR:"Miras Hukuku",titleEN:"Inheritance Law",descriptionEN:"Inherited property, land or bank accounts in Turkey? We manage Turkish inheritance law matters from Germany, including certificate of inheritance, rejection deadlines, tax and land registry transfer.",seoTitleEN:"Turkish Inheritance Lawyer Germany | Estate in Turkey | Doğru Kanzlei",seoDescriptionEN:"Turkish inheritance lawyer in Germany — estate in Turkey, certificate of inheritance, compulsory share & rejection deadline. No travel to Turkey needed.",expertiseTitleEN:"Why Doğru Kanzlei for Turkish Inheritance Law?",contentEN:`Inheritance Law — Turkish Inheritance Law from Mannheim
...
Türk hukukuna göre miras paylaşımının önceden planlanması — bağışlar veya miras sözleşmeleri yoluyla — konusunda danışmanlık veriyor, hukuki güvenlik ve vergisel sonuçlar açısından değerlendirme yapıyoruz.`,contentDE:`Erbrecht Türkei Anwalt Deutschland — Immobilie in der Türkei geerbt
...
Vorweggenommene Erbfolge durch Schenkungen oder Erbverträge nach türkischem Recht — wir beraten Sie zur rechtssicheren Gestaltung und zu den steuerlichen Konsequenzen.`,faqDE:[{question:"Wie kann ich einen Erbschein Türkei beantragen?",answer:"Der türkische Erbschein heißt Veraset İlamı. Er weist aus, wer nach türkischem Recht Erbe ist und zu welchem Anteil. Ohne dieses Dokument können Sie in der Türkei meist weder auf Bankkonten noch auf Immobilien zugreifen. Wir beantragen den Erbschein Türkei für Sie, ohne dass Sie dafür reisen müssen."},{question:"Wie lang ist die Erbausschlagung Türkei Frist?",answer:"Die Frist zur Erbausschlagung in der Türkei beträgt nach türkischem Recht regelmäßig 3 Monate ab Kenntnis des Erbfalls. Diese Frist ist streng. Wer sie versäumt, kann als Erbe gelten und im schlimmsten Fall für Schulden des Erblassers haften."},{question:"Muss ich für das Erbverfahren in die Türkei reisen?",answer:"Nein. Mit einer notariellen Vollmacht können wir das türkische Erbverfahren von Deutschland aus für Sie führen, darunter Veraset İlamı, Grundbuchübertragung, Bankkonten, Erbschaftssteuer Türkei und gerichtliche Schritte."},{question:"Was bedeutet Pflichtteil Türkei?",answer:"Das türkische Erbrecht schützt bestimmte Angehörige durch Pflichtteilsrechte. Wenn Pflichtteilsberechtigte übergangen wurden oder Schenkungen den Pflichtteil verletzen, kann eine Tenkis Davası in Betracht kommen. Wir prüfen Ihre Ansprüche nach türkischem Recht."},{question:"Welche Erbschaftssteuer Türkei fällt an?",answer:"Bei Erbschaften in der Türkei kann Veraset ve İntikal Vergisi anfallen. Höhe, Fristen und Erklärungspflichten hängen vom Nachlass, Verwandtschaftsgrad und Wohnsitz ab. Wir prüfen die steuerlichen Pflichten im Rahmen des Erbverfahrens."}],faqTR:[{question:"Veraset ilamı Almanya'dan alınabilir mi?",answer:"Evet. Veraset ilamı, Türk hukukuna göre kimin mirasçı olduğunu ve hangi oranda pay aldığını gösteren belgedir. Türkiye'deki banka hesapları, tapu ve miras işlemleri için gereklidir. Seyahat etmeden sizin adınıza süreci yürütebiliyoruz."},{question:"Reddi miras Almanya'dan yapılabilir mi?",answer:"Evet, ancak süre çok önemlidir. Türk hukukuna göre reddi miras süresi genellikle mirasın öğrenilmesinden itibaren 3 aydır. Süre kaçırılırsa, borç olsa bile mirasçı sayılma riski doğabilir."},{question:"Miras işlemleri için Türkiye'ye gitmem gerekiyor mu?",answer:"Hayır. Noter tasdikli vekaletname ile veraset ilamı, tapu devri, banka hesapları, veraset vergisi ve mahkeme işlemleri dahil birçok Türk miras sürecini Almanya'dan yürütebiliyoruz."},{question:"Saklı pay Almanya'da yaşayan mirasçılar için geçerli mi?",answer:"Türkiye'deki miras malları bakımından Türk saklı pay kuralları önemli olabilir. Saklı pay ihlali varsa tenkis davası gündeme gelebilir. Dosyanıza göre hangi hakların ileri sürülebileceğini inceliyoruz."},{question:"Veraset vergisi Almanya'da yaşayan mirasçılar için nasıl işler?",answer:"Türkiye'deki miraslarda veraset ve intikal vergisi gündeme gelebilir. Süreler, beyanname ve ödeme yükümlülükleri mirasın içeriğine ve mirasçının durumuna göre değişir. Bu süreci miras dosyasıyla birlikte değerlendiriyoruz."}]},{id:"immobilienrecht",slugDE:"immobilienrecht",slugTR:"gayrimenkul-hukuku",slugEN:"property-law",icon:s,title:"Immobilienrecht",titleTR:"Gayrimenkul Hukuku",titleEN:"Real Estate Law in Turkey",descriptionEN:"Expert legal support for German-Turks buying, selling, registering or disputing property in Turkey.",detailEN:"Property purchase · Sale · Land registry · Ownership disputes",seoTitleEN:"Real Estate Law in Turkey | Property Purchase & Disputes | Doğru Kanzlei",seoDescriptionEN:"Expert legal support for German-Turks buying, selling, registering or disputing property in Turkey. Avukat Hasan Doğru — Mannheim.",expertiseTitleEN:"Why Doğru Kanzlei for Real Estate in Turkey?",contentEN:`Real Estate Law in Turkey — Buying, Selling and Protecting Property
...
- Türkçe ve Almanca danışmanlık
- Mannheim'da yüz yüze görüşme imkânı
- Ankara'da ikinci ofis — Türk makamlarıyla doğrudan iş birliği`,contentDE:`Immobilienrecht Türkei Anwalt — Tapu, Kauf, Verkauf und geerbte Immobilien
...
Yasal uyarı: Türk hukukuna dair bilirkişi mütalaası hizmeti, Türkiye’de kayıtlı bir avukat ve Türk hukuku bilirkişisi sıfatıyla yürütülmektedir. Bu hizmet, Alman hukuku alanında bir danışmanlık içermez (§ 207 BRAO). Bu sayfa yalnızca Türk hukukuna ilişkin genel bilgi amaçlıdır.`,contentEN:`Turkish Law Expert Legal Opinion — For Courts, Lawyers, and Notaries
...
Notice: Expert legal opinions on Turkish law are provided in the capacity of a lawyer licensed in Turkey and a registered expert on Turkish law. This service does not involve legal advice on German law (§ 207 BRAO). This page addresses Turkish law exclusively.`,faqDE:[{question:"Was kostet ein Rechtsgutachten zum türkischen Recht?",answer:"Für gerichtlich beauftragte Gutachten gilt das JVEG. Für private Aufträge von Kanzleien oder Notariaten erhalten Sie vorab ein transparentes Festpreisangebot; eine kurze Ersteinschätzung zur Machbarkeit ist kostenfrei."},{question:"Wie lange dauert die Erstellung eines Rechtsgutachtens?",answer:"Die Bearbeitungszeit hängt vom Umfang der Rechtsfrage ab und wird im Angebot verbindlich genannt. Kurzfristige Bearbeitung ist möglich, insbesondere bei laufenden Gerichtsverfahren mit Fristen."},{question:"Wer kann ein Rechtsgutachten zum türkischen Recht in Auftrag geben?",answer:"Deutsche Gerichte im Rahmen von § 293 ZPO, Rechtsanwältinnen und Rechtsanwälte mit einem Mandat mit Türkeibezug sowie Notariate bei Beurkundungen mit Auslandsbezug."},{question:"Was ist der Unterschied zwischen einem Rechtsgutachten und einer Rechtsberatung?",answer:"Ein Rechtsgutachten beantwortet schriftlich und begründet eine konkrete Rechtsfrage nach türkischem Recht, meist für ein Gericht, eine Kanzlei oder ein Notariat. Es ersetzt keine individuelle Rechtsberatung im deutschen Recht, die gemäß § 207 BRAO nicht Teil dieser Tätigkeit ist."},{question:"Warum ist ein bei einem deutschen Gericht gelisteter Sachverständiger sinnvoller als eine allgemeine Anfrage an eine türkische Kanzlei?",answer:"Die Eintragung in die Sachverständigenliste des Amtsgerichts Mannheim ist ein unabhängiger Nachweis der Fachkunde und schafft für deutsche Gerichte und Anwälte eine verlässliche, direkt verwertbare Quelle statt einer losen Zweitmeinung."},{question:"Werden auch familienrechtliche Fragen wie Nafaka oder Velayet begutachtet?",answer:"Ja. Typische familienrechtliche Gutachtenthemen umfassen Güterrecht und Zugewinnausgleich, Unterhaltsrecht, Anerkennung von Eheschließungen und Scheidungen sowie Sorgerecht nach türkischem Recht."},{question:"Kann ein Gutachten auch die Anerkennung eines deutschen Urteils in der Türkei betreffen?",answer:"Ja, Fragen der Anerkennung und Vollstreckung (Tanıma/Tenfiz) nach dem türkischen IPR-Gesetz (MÖHUK) gehören zu den regelmäßigen Gutachtenthemen."},{question:"In welcher Sprache wird das Gutachten erstellt?",answer:"Die Gutachten werden auf Deutsch erstellt, mit Fundstellen aus türkischem Gesetzestext und Rechtsprechung, damit deutsche Gerichte und Rechtsanwälte sie direkt verwenden können."}],faqTR:[{question:"Alman mahkemesi neden Türk hukuku hakkında bir rapora ihtiyaç duyar?",answer:"Almanya'daki bir dava Türkiye ile bağlantılıysa, Alman kanunlar ihtilafı kuralları çoğu zaman Türk hukukunun uygulanmasını gerektirir. § 293 ZPO uyarınca mahkeme, yabancı hukukun içeriğini resen araştırmakla yükümlüdür."},{question:"Bu mütalaa hangi durumlarda isteniyor?",answer:"En sık miras davalarında, aile hukuku davalarında ve Türkiye'deki gayrimenkullerle ilgili uyuşmazlıklarda talep edilir."},{question:"Mütalaayı kimler talep edebilir?",answer:"Alman mahkemeleri, Türkiye bağlantılı bir dosyayla ilgilenen Alman avukatlar ve yurt dışı bağlantılı işlemler yapan noterler."},{question:"Bilirkişi mütalaası ile hukuki danışmanlık arasındaki fark nedir?",answer:"Bilirkişi mütalaası, somut bir hukuki soruyu Türk kanun ve içtihadına dayanarak yazılı ve gerekçeli şekilde cevaplayan, genellikle bir Alman mahkemesine, avukata veya noterlik makamına hitap eden bir belgedir."},{question:"Almanya'da yaşayan bir Türk vatandaşı olarak neden bu hizmetle karşılaşabilirim?",answer:"Türkiye bağlantılı bir miras veya boşanma davanız Alman mahkemesindeyse, mahkeme veya Alman avukatınız Türk hukukunun içeriğini netleştirmek için böyle bir mütalaa talep edebilir."},{question:"Mütalaa ne kadar sürede hazırlanır ve maliyeti nedir?",answer:"Süre, sorunun kapsamına göre değişir ve teklif aşamasında netleştirilir. Mahkeme tarafından talep edilen mütalaalarda JVEG uygulanır; özel taleplerde önceden sabit fiyat teklifi sunulur."},{question:"Mütalaa hangi dilde hazırlanır?",answer:"Mütalaalar Almanca hazırlanır; Türk kanun metinlerine ve Yargıtay içtihatlarına atıfla desteklenir."}],faqEN:[{question:"Why would a German court need an expert opinion on Turkish law?",answer:"When a German case touches Turkey, German conflict-of-laws rules often point to Turkish substantive law. Under Section 293 ZPO, the court must establish the content of that foreign law, typically by commissioning a written expert opinion."},{question:"What is the difference between an expert legal opinion and legal advice?",answer:"An expert legal opinion answers a specific legal question under Turkish law in writing, with reasoning and citations, usually addressed to a German court, law firm, or notary. It is not individual legal advice and does not involve advice on German law."},{question:"Who can commission this kind of expert opinion?",answer:"German courts under Section 293 ZPO, lawyers handling a case connected to Turkey, and notaries handling matters with a foreign element."},{question:"What topics are typically covered?",answer:"Most requests involve inheritance law, family law and disputes over property located in Turkey."},{question:"How long does it take to prepare an expert opinion, and what does it cost?",answer:"Turnaround depends on the scope of the legal question and is confirmed at the quote stage. Court-commissioned opinions are billed under Germany's JVEG statute; private requests receive a transparent fixed-fee quote in advance."},{question:"In what language is the opinion written?",answer:"In German, with citations to Turkish statutes and case law, so that German courts and lawyers can use it directly without further translation."},{question:"I'm a Turkish citizen living in Germany — why would this service matter to me?",answer:"If your inheritance or divorce case connected to Turkey is being heard in a German court, the court or your German lawyer may commission this kind of opinion to establish how Turkish law applies."}]}];export{o as s};
