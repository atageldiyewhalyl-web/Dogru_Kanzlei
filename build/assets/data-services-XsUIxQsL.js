import{U as e,S as n,P as a,G as r,a as i,B as t,H as s,b as l}from"./ui-vendor-Dz51URPF.js";const u=[{id:"familienrecht",slugDE:"familienrecht",slugTR:"aile-hukuku",slugEN:"family-law",icon:e,title:"Familienrecht & Scheidung",titleTR:"Aile Hukuku ve Boşanma",titleEN:"Family Law & Divorce",descriptionEN:"Turkish-origin families across Germany often face a dual challenge with divorce, custody, or maintenance: two legal systems, two countries, one family. Turkish family law differs significantly from German law and requires a lawyer who understands both sides.",detailEN:"Turkish law only · Ankara Bar member and §207 BRAO registration · Full process without travel to Turkey · Advice in Turkish, German and English · Available throughout Germany by phone, video and WhatsApp · Mannheim and Ankara offices for direct coordination with Turkish courts",seoTitleEN:"Turkish Divorce Lawyer Germany | Family Law & Tanima Tenfiz | Hasan Doğru",seoDescriptionEN:"Turkish family law for clients in Germany: divorce in Turkey, custody, maintenance and recognition of German divorce judgments. No travel to Turkey required.",expertiseTitleEN:"Why Doğru Kanzlei for Germany-Turkey Family Law?",contentEN:`Family Law & Divorce — Turkish Family Law from Mannheim
...
After a divorce, questions arise about name changes under Turkish law. We advise on your options and handle the name change process with Turkish authorities.`,faqEN:[{question:"Is my German divorce valid in Turkey?",answer:"No, not automatically. A German divorce decision usually needs to be recognised in Turkey before your marital status is updated there. Depending on the decision, Tanıma, Tenfiz or a combined procedure may be required."},{question:"Do I need to travel to Turkey for a custody case?",answer:"In many cases, no. With the right power of attorney, we can prepare filings, coordinate documents and communicate with Turkish courts. Whether personal attendance is required depends on the facts of the case and the competent court."},{question:"Can maintenance be enforced in Turkey?",answer:"Yes, if the legal requirements are met. German maintenance decisions or arrangements often need to be made enforceable in Turkey through Tenfiz before enforcement measures can be considered."},{question:"How much does an initial consultation cost?",answer:"The cost depends on the scope of your case and the documents that need to be reviewed. Before the consultation, you receive clear information about the fee and what will be assessed."},{question:"Which documents do I need for Tanıma & Tenfiz?",answer:"Usually you need the German divorce decision, proof that it is final, an apostille, a certified Turkish translation and a suitable power of attorney. We check your specific decision and tell you which documents are required."}],seoTitleDE:"Türkisches Familienrecht Deutschland | Scheidung Türkei | Doğru Kanzlei",seoDescriptionDE:"Türkischer Anwalt für Scheidung & Familienrecht in Mannheim. Boşanma, Sorgerecht, Unterhalt mit Türkeibezug — deutschlandweit ohne Türkeireise. Jetzt beraten.",seoTitleTR:"Almanya Türk Boşanma Avukatı | Aile Hukuku & Tanıma Tenfiz | Hasan Doğru",seoDescriptionTR:"Türkiye bağlantılı boşanma, velayet ve nafaka davası — Almanya'dan seyahatsiz. Mannheim'dan Türkçe hukuki destek. Hemen WhatsApp'tan yazın.",description:"Almanya genelindeki Türk aileler; boşanma, velayet veya nafaka konularında sıklıkla çift taraflı bir zorlukla karşılaşır: iki hukuk sistemi, iki ülke, bir aile. Türk aile hukuku, Alman hukukundan önemli noktalarda ayrılır ve iki tarafı da bilen bir avukat gerektirir.",descriptionDE:"Türkischstämmige Familien in ganz Deutschland stehen bei Scheidung, Sorgerecht oder Unterhalt mit Türkeibezug oft vor einer besonderen Herausforderung: Zwei Rechtssysteme, zwei Länder, eine Familie. Das türkische Familienrecht unterscheidet sich in wesentlichen Punkten vom deutschen Recht — und erfordert einen Anwalt, der beide Seiten kennt.",detail:"Yalnızca Türk hukuku — tam uzmanlaşma · Ankara Barosu üyesi, § 207 BRAO kapsamında kayıtlı · Türkiye'ye seyahat etmeden süreç yönetimi · Türkçe ve Almanca danışmanlık · Almanya genelinde telefon, video ve WhatsApp ile ulaşılabilir · Mannheim ve Ankara ofisleriyle Türk mahkemeleriyle doğrudan iş birliği",detailDE:"Ausschließlich türkisches Recht — keine Kompromisse, volle Spezialisierung · Mitglied der Ankara Barosu und registriert gemäß § 207 BRAO · Verfahren vollständig ohne Reise in die Türkei möglich · Beratung auf Türkisch und Deutsch · Deutschlandweite Betreuung per Telefon oder Video · Standorte Mannheim und Ankara für direkte Zusammenarbeit mit türkischen Gerichten",expertiseTitleDE:"Warum Doğru Kanzlei für türkisches Familienrecht mit Deutschland-Türkei-Bezug?",expertiseTitleTR:"Türkiye Bağlantılı Aile Hukukunda Neden Doğru Kanzlei?",content:`Aile Hukuku ve Boşanma — Mannheim'da Türk Aile Hukuku
