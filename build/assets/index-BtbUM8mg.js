...
Kapanış cümlesi:
Tüm süreç boyunca yanınızdayız — güvenilir, şeffaf ve Türk-Alman ceza hukuku alanında derin deneyimle.`,contentDE:`Strafverteidigung in der Türkei aus Deutschland
...
Türkiye'deki işlemleriniz için gerekli olan yetki belgesidir.`,category:"Hukuki Danışmanlık",categoryDE:"Rechtsberatung",image:Xe,dateDE:"2. April 2026",dateTR:"2 Nisan 2026",readTimeDE:"6 Min. Lesezeit",readTimeTR:"6 dk okuma",publishedAt:"2026-04-02"}],ce=c.createContext(void 0);function Qe(n,i,t){var l,a;let r=n.replace(`/${i}`,`/${t}`);i==="tr"&&t==="de"?(r=r.replace("/hizmetler","/leistungen"),r=r.replace("/gizlilik-politikasi","/datenschutz"),r=r.replace("/yasal-bilgiler","/impressum"),r=r.replace("/hakkimizda","/ueber-uns")):i==="de"&&t==="tr"&&(r=r.replace("/leistungen","/hizmetler"),r=r.replace("/datenschutz","/gizlilik-politikasi"),r=r.replace("/impressum","/yasal-bilgiler"),r=r.replace("/ueber-uns","/hakkimizda"));const s=t==="de"?"/leistungen/":"/hizmetler/";if(r.includes(s)){const o=(l=r.split(s)[1])==null?void 0:l.split(/[?#]/)[0];if(o){const u=S.find(h=>i==="de"?h.slugDE===o:h.slugTR===o);if(u){const h=t==="de"?u.slugDE:u.slugTR;r=r.replace(o,h)}}}const d="/blog/";if(r.includes(d)){const o=(a=r.split(d)[1])==null?void 0:a.split(/[?#]/)[0];if(o){const u=N.find(h=>i==="de"?h.slugDE===o:h.slugTR===o);if(u){const h=t==="de"?u.slugDE:u.slugTR;r=r.replace(o,h)}}}return r}const en=({language:n,children:i})=>{const t=K(),r=H(),s=a=>{if(a===n)return;const o=Qe(r.pathname,n,a)+r.search+r.hash;t(o)},d=a=>Le[n][a]||a,l=c.useMemo(()=>{const a=`/${n}`,o=n==="de"?"leistungen":"hizmetler";return{home:a,services:`${a}/${o}`,service:u=>{const h=S.find(m=>m.id===u),g=h?n==="de"?h.slugDE:h.slugTR:u;return`${a}/${o}/${g}`},blog:`${a}/blog`,blogPost:u=>{const h=N.find(m=>m.slug===u),g=h?n==="de"?h.slugDE:h.slugTR:u;return`${a}/blog/${g}`},datenschutz:n==="de"?`${a}/datenschutz`:`${a}/gizlilik-politikasi`,impressum:n==="de"?`${a}/impressum`:`${a}/yasal-bilgiler`,about:n==="de"?`${a}/ueber-uns`:`${a}/hakkimizda`,whyUs:`${a}/#neden-biz`,blogSection:`${a}/#blog`,contact:`${a}/#iletisim`}},[n]);return e.jsx(ce.Provider,{value:{language:n,setLanguage:s,t:d,paths:l},children:i})},T=()=>{const n=c.useContext(ce);if(n===void 0)throw new Error("useLanguage must be used within a LanguageProvider");return n},me="/assets/logo-eRLlm_XN.avif",q="https://calendly.com/hasand9366/30min";function nn(){const[n,i]=c.useState(!1),[t,r]=c.useState(!1),{language:s,setLanguage:d,t:l,paths:a}=T(),{pathname:o,hash:u}=H(),h=K(),g=[{label:l("nav_home"),href:a.home},{label:l("nav_about"),href:a.about},{label:l("nav_services"),href:a.services},{label:l("nav_why_us"),href:a.whyUs},{label:l("nav_blog"),href:a.blog},{label:l("nav_contact"),href:a.contact}],m=o===`/${s}`||o===`/${s}/`;c.useEffect(()=>{const k=()=>i(window.scrollY>40);return window.addEventListener("scroll",k),()=>window.removeEventListener("scroll",k)},[]),c.useEffect(()=>{if(u){const k=u.replace("#",""),z=document.getElementById(k);if(z){const R=setTimeout(()=>{z.scrollIntoView({behavior:"smooth"})},150);return()=>clearTimeout(R)}}},[u]),c.useEffect(()=>(t?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[t]);const x=k=>{r(!1);const z=k.indexOf("#");if(z!==-1){const R=k.substring(0,z),ge=k.substring(z+1),fe=o.replace(/\/$/,""),W=R.replace(/\/$/,"");if(fe===W||m&&W===`/${s}`){const C=document.getElementById(ge);if(C){C.scrollIntoView({behavior:"smooth"});return}}h(k)}else h(k),window.scrollTo({top:0,behavior:"smooth"})},p=(n||!m)&&!t;return e.jsxs("header",{style:{position:"fixed",top:0,left:0,right:0,zIndex:100,transition:"background 0.3s, box-shadow 0.3s",background:p?"#ffffff":"transparent",boxShadow:p?"0 1px 24px rgba(0,0,0,0.07)":"none",borderBottom:p?"1px solid #f0f0f0":"1px solid rgba(255,255,255,0.1)"},children:[e.jsxs("div",{className:"relative z-50 max-w-[1400px] mx-auto px-6 lg:px-8 flex items-center justify-between h-[80px]",children:[e.jsxs(v,{to:a.home,"aria-label":`Doğru Kanzlei - ${l("nav_home")}`,onClick:k=>{m&&(k.preventDefault(),window.scrollTo({top:0,behavior:"smooth"}))},style:{textDecoration:"none",display:"flex",alignItems:"center",gap:12},children:[e.jsx("img",{src:me,alt:"Doğru Kanzlei Logo",width:44,height:44,style:{height:44,width:"auto",display:"block",filter:p?"none":"brightness(0) invert(1)",transition:"filter 0.3s"}}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:20,fontWeight:600,color:p?"#1C3829":"#ffffff",letterSpacing:"0.05em",textTransform:"uppercase",transition:"color 0.3s",lineHeight:1},children:"DOGRU"}),e.jsx("span",{style:{fontFamily:"'Lato', sans-serif",fontSize:9,fontWeight:700,color:"#7A5F20",letterSpacing:"0.2em",textTransform:"uppercase",marginTop:2},children:"Kanzlei"})]})]}),e.jsxs("nav",{className:"hidden lg:flex items-center gap-8","aria-label":s==="de"?"Hauptnavigation":"Ana navigasyon",children:[g.map(k=>e.jsx("button",{onClick:()=>x(k.href),"aria-label":k.label,style:{background:"none",border:"none",cursor:"pointer",fontFamily:"var(--font-sans)",fontSize:10,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",color:p?"#3a3a3a":"rgba(255,255,255,0.9)",textDecoration:"none",transition:"color 0.2s",padding:"8px 0"},onMouseEnter:z=>z.target.style.color="#7A5F20",onMouseLeave:z=>z.target.style.color=p?"#3a3a3a":"rgba(255,255,255,0.9)",children:k.label},k.href)),e.jsx("div",{style:{width:1,height:18,background:p?"#e0e0e0":"rgba(255,255,255,0.2)"}}),e.jsxs("button",{onClick:()=>d(s==="tr"?"de":"tr"),"aria-label":s==="de"?"Sprache zu Türkisch wechseln":"Dili Almanca yap",style:{display:"flex",alignItems:"center",gap:5,background:"none",border:"none",cursor:"pointer",fontFamily:"var(--font-sans)",fontSize:11,fontWeight:700,color:p?"#3a3a3a":"#ffffff",textTransform:"uppercase"},children:[e.jsx(oe,{size:13,color:"#7A5F20","aria-hidden":"true"}),s==="de"?"TR":"DE"]}),e.jsx("button",{onClick:()=>window.open(q,"_blank"),style:{fontFamily:"var(--font-sans)",fontSize:10,fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase",color:"#ffffff",background:"#8B6E2A",padding:"12px 24px",textDecoration:"none",transition:"transform 0.2s, background 0.2s",border:"none",cursor:"pointer"},onMouseEnter:k=>{k.target.style.background="#7A5F20",k.target.style.transform="translateY(-1px)"},onMouseLeave:k=>{k.target.style.background="#8B6E2A",k.target.style.transform="translateY(0)"},children:l("nav_cta")})]}),e.jsxs("div",{className:"flex items-center gap-4 lg:hidden",children:[e.jsx("button",{onClick:()=>d(s==="tr"?"de":"tr"),"aria-label":s==="de"?"Sprache zu Türkisch wechseln":"Dili Almanca yap",style:{display:"flex",alignItems:"center",gap:4,background:"none",border:"none",cursor:"pointer",fontFamily:"'Lato', sans-serif",fontSize:12,fontWeight:700,color:p?"#3a3a3a":"#ffffff",textTransform:"uppercase"},children:s==="de"?"TR":"DE"}),e.jsx("button",{onClick:()=>r(!t),"aria-label":t?"Hauptmenü schließen":"Hauptmenü öffnen",style:{background:"none",border:"none",cursor:"pointer",color:p?"#1C3829":"#ffffff",padding:4},children:t?e.jsx(ue,{size:24}):e.jsx(De,{size:24})})]})]}),e.jsx("div",{className:`fixed inset-0 bg-[#1C3829] z-40 transition-transform duration-500 ease-in-out lg:hidden ${t?"translate-x-0":"translate-x-full"}`,style:{top:0,height:"100vh"},children:e.jsxs("div",{className:"flex flex-col h-full pt-28 px-8 pb-12 overflow-y-auto",children:[e.jsx("div",{className:"flex flex-col gap-6 flex-grow",children:g.map((k,z)=>e.jsx("button",{onClick:()=>x(k.href),style:{transitionDelay:`${z*100}ms`},className:`text-left font-serif text-3xl font-medium text-white hover:text-[#8B6E2A] transition-all duration-300 ${t?"opacity-100 translate-y-0":"opacity-0 translate-y-4"}`,children:k.label},k.href))}),e.jsxs("div",{className:`mt-auto pt-8 border-t border-white/10 transition-all duration-500 delay-500 ${t?"opacity-100 translate-y-0":"opacity-0 translate-y-4"}`,children:[e.jsx("p",{className:"font-sans text-[11px] text-white/50 tracking-[0.2em] uppercase mb-4",children:s==="de"?"Direkter Kontakt":"Doğrudan İletişim"}),e.jsx("p",{className:"font-sans text-white mb-1",children:"info@hasandogru.de"}),e.jsx("p",{className:"font-sans text-white mb-2",children:"Avukat.hasandogru@outlook.de"}),e.jsx("p",{className:"font-sans text-white mb-8",children:"+4917661221210"}),e.jsx("button",{onClick:()=>window.open(q,"_blank"),className:"w-full bg-[#8B6E2A] text-white font-sans text-xs font-bold tracking-[0.15em] uppercase py-5 text-center transition-colors hover:bg-[#7A5F20]",children:l("nav_cta")})]})]})})]})}const Y="dogru_kanzlei_consent",Z="1";function an(){const[n,i]=c.useState("pending"),[t,r]=c.useState({essential:!0,functional:!1,analytics:!1}),[s,d]=c.useState(!1);c.useEffect(()=>{try{const g=localStorage.getItem(Y);if(g){const m=JSON.parse(g);if(m.version===Z){r(m.consent),i(m.status),d(!1);return}}}catch{}d(!0)},[]);const l=(g,m)=>{const x={version:Z,consent:g,status:m};localStorage.setItem(Y,JSON.stringify(x)),r(g),i(m),d(!1)};return{showBanner:s,status:n,consent:t,acceptAll:()=>{l({essential:!0,functional:!0,analytics:!0},"accepted")},rejectAll:()=>{l({essential:!0,functional:!1,analytics:!1},"rejected")},saveCustom:(g,m)=>{l({essential:!0,functional:g,analytics:m},"custom")},openSettings:()=>{d(!0)}}}const ke=c.createContext(null);function rn({children:n}){const i=an();return e.jsx(ke.Provider,{value:i,children:n})}function V(){const n=c.useContext(ke);if(!n)throw new Error("useConsent must be used within ConsentProvider");return n}function tn(){const{t:n,language:i,paths:t}=T(),{openSettings:r}=V(),s=new Date().getFullYear(),d=[{label:n("nav_about"),href:t.about},{label:n("nav_services"),href:t.services},{label:n("nav_why_us"),href:t.whyUs},{label:n("nav_blog"),href:t.blog},{label:n("nav_contact"),href:t.contact}],l=i==="de"?[{label:"Familienrecht",href:t.service("familienrecht")},{label:"Erbrecht",href:t.service("erbrecht")},{label:"Mietrecht",href:t.service("mietrecht")},{label:"Strafrecht",href:t.service("strafrecht")},{label:"Türkisches Recht",href:t.service("tuerkisches-recht")}]:[{label:"Aile Hukuku",href:t.service("familienrecht")},{label:"Miras Hukuku",href:t.service("erbrecht")},{label:"Kira Hukuku",href:t.service("mietrecht")},{label:"Ceza Hukuku",href:t.service("strafrecht")},{label:"Türk Hukuku",href:t.service("tuerkisches-recht")}];return e.jsxs("footer",{style:{background:"#111d17",padding:"64px 32px 32px"},children:[e.jsxs("div",{style:{maxWidth:1100,margin:"0 auto"},children:[e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"2.5fr 1fr 1fr 1.5fr",gap:48,paddingBottom:48,borderBottom:"1px solid rgba(255,255,255,0.06)"},className:"footer-grid",children:[e.jsxs("div",{children:[e.jsxs(v,{to:t.home,"aria-label":`Doğru Kanzlei - ${n("nav_home")}`,style:{marginBottom:20,display:"flex",alignItems:"center",gap:10,textDecoration:"none"},children:[e.jsx("img",{src:me,alt:"Doğru Kanzlei Logo",width:48,height:48,style:{height:48,width:"auto",display:"block",filter:"brightness(0) invert(1)"}}),e.jsx("span",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:22,fontWeight:600,color:"#ffffff",letterSpacing:"0.05em",textTransform:"uppercase"},children:"DOGRU Kanzlei"})]}),e.jsx("p",{style:{fontFamily:"'Lato', sans-serif",fontSize:13,fontWeight:400,color:"rgba(255,255,255,0.55)",lineHeight:1.7,maxWidth:320,marginBottom:24},children:n("footer_description")}),e.jsxs("div",{style:{display:"flex",gap:14},children:[e.jsx("div",{style:{width:28,height:28,borderRadius:"50%",background:"rgba(184,150,62,0.1)",display:"flex",alignItems:"center",justifyContent:"center",border:"1px solid rgba(184,150,62,0.2)"},children:e.jsx("div",{style:{width:6,height:6,borderRadius:"50%",background:"#B8963E"}})}),e.jsx("span",{style:{fontFamily:"var(--font-sans)",fontSize:14,fontWeight:500,color:"rgba(255,255,255,0.6)",letterSpacing:"0.05em"},children:"Mannheim · Ankara"})]})]}),e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"'Lato', sans-serif",fontSize:10,fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",color:"#B8963E",marginBottom:24},children:n("footer_quick_links")}),d.map(a=>e.jsx(v,{to:a.href,style:{display:"block",fontFamily:"var(--font-sans)",fontSize:13,fontWeight:500,color:"rgba(255,255,255,0.7)",textDecoration:"none",marginBottom:12,transition:"color 0.2s"},onMouseEnter:o=>o.target.style.color="#ffffff",onMouseLeave:o=>o.target.style.color="rgba(255,255,255,0.7)",children:a.label},a.label))]}),e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"'Lato', sans-serif",fontSize:10,fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",color:"#B8963E",marginBottom:24},children:n("hero_cta_secondary")}),l.map(a=>e.jsx(v,{to:a.href,style:{display:"block",fontFamily:"var(--font-sans)",fontSize:13,fontWeight:500,color:"rgba(255,255,255,0.7)",textDecoration:"none",marginBottom:12,transition:"color 0.2s"},onMouseEnter:o=>o.target.style.color="#ffffff",onMouseLeave:o=>o.target.style.color="rgba(255,255,255,0.7)",children:a.label},a.label))]}),e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"'Lato', sans-serif",fontSize:10,fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",color:"#8B6E2A",marginBottom:24},children:n("footer_contact_info")}),e.jsxs("div",{style:{fontFamily:"'Lato', sans-serif",fontSize:13,fontWeight:400,color:"rgba(255,255,255,0.7)",lineHeight:1.7},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:10,marginBottom:14},children:[e.jsx(he,{size:14,color:"#8B6E2A",style:{marginTop:4}}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:4},children:[e.jsx("a",{href:"mailto:info@hasandogru.de",style:{color:"inherit",textDecoration:"none"},children:"info@hasandogru.de"}),e.jsx("a",{href:"mailto:Avukat.hasandogru@outlook.de",style:{color:"inherit",textDecoration:"none"},children:"Avukat.hasandogru@outlook.de"})]})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:14},children:[e.jsx(B,{size:14,color:"#8B6E2A"}),e.jsx("a",{href:"https://wa.me/4917661221210","aria-label":"Kontakt per WhatsApp",style:{color:"inherit",textDecoration:"none"},target:"_blank",rel:"noopener noreferrer",children:"+4917661221210"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:14},children:[e.jsx(B,{size:14,color:"#8B6E2A"}),e.jsx("span",{children:"+905332375918"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:10,marginBottom:14},children:[e.jsx(M,{size:14,color:"#8B6E2A",style:{marginTop:4}}),e.jsx("span",{children:"R1 2,3, 68161 Mannheim, Deutschland"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:10},children:[e.jsx(M,{size:14,color:"#8B6E2A",style:{marginTop:4}}),e.jsx("span",{children:"Aşağı Öveçler Mahallesi 1322 Cadde 45/9, Çankaya Ankara"})]})]})]})]}),e.jsx("div",{style:{marginTop:80,marginBottom:20},children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:40},className:"footer-disclaimer-grid",children:[e.jsxs("div",{children:[e.jsx("span",{style:{color:"#C9A84C",fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:"0.2em",display:"block",marginBottom:16,opacity:.9},children:"Rechtlicher Hinweis"}),e.jsx("p",{style:{color:"rgba(255,255,255,0.6)",fontSize:11,lineHeight:1.8,margin:0,fontFamily:"'Lato', sans-serif"},children:"Die Kanzlei berät ausschließlich im türkischen Recht. Eine Beratung oder Vertretung im deutschen Recht findet nicht statt. Registriert als ausländischer Rechtsanwalt gemäß § 207 BRAO."})]}),e.jsxs("div",{lang:"tr",children:[e.jsx("span",{style:{color:"#C9A84C",fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:"0.2em",display:"block",marginBottom:16,opacity:.9},children:"Yasal Uyarı"}),e.jsx("p",{style:{color:"rgba(255,255,255,0.6)",fontSize:11,lineHeight:1.8,margin:0,fontFamily:"'Lato', sans-serif"},children:"Büromuz yalnızca Türk hukuku alanında danışmanlık vermektedir. Alman hukuku konusunda danışmanlık veya temsil hizmeti verilmemektedir. § 207 BRAO uyarınca kayıtlı yabancı avukat."})]}),e.jsxs("div",{children:[e.jsx("span",{style:{color:"#C9A84C",fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:"0.2em",display:"block",marginBottom:16,opacity:.9},children:"Legal Notice"}),e.jsx("p",{style:{color:"rgba(255,255,255,0.6)",fontSize:11,lineHeight:1.8,margin:0,fontFamily:"'Lato', sans-serif"},children:"The firm provides legal advice exclusively in Turkish law. We do not provide advice or representation in German law. Registered as a foreign lawyer according to § 207 BRAO."})]})]})}),e.jsxs("div",{style:{paddingTop:24,display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:16},children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[e.jsxs("span",{style:{fontFamily:"'Lato', sans-serif",fontSize:11,fontWeight:400,color:"rgba(255,255,255,0.2)"},children:["© ",s," DOGRU Kanzlei · ",n("hero_title_pre")," Hasan Dogru. ",n("footer_rights")]}),e.jsxs("a",{href:"https://nüll.com",target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:"4px",fontFamily:"'Lato', sans-serif",fontSize:10,fontWeight:400,color:"rgba(255,255,255,0.4)",textDecoration:"none",transition:"all 0.2s ease"},onMouseEnter:a=>{const o=a.currentTarget;o.style.color="rgba(255,255,255,0.7)"},onMouseLeave:a=>{const o=a.currentTarget;o.style.color="rgba(255,255,255,0.4)"},children:["Site made by",e.jsxs("span",{style:{display:"flex",alignItems:"center",color:"rgba(255,255,255,0.8)",fontWeight:800,marginLeft:2,letterSpacing:"-0.02em",fontFamily:"var(--font-sans)"},children:["nüll",e.jsx("span",{style:{color:"#3B82F6"},children:"."}),"com"]})]})]}),e.jsxs("div",{style:{display:"flex",gap:24},children:[[{label:"Impressum",href:t.impressum},{label:"Datenschutz",href:t.datenschutz}].map(a=>e.jsx(v,{to:a.href,style:{fontFamily:"'Lato', sans-serif",fontSize:11,fontWeight:400,color:"rgba(255,255,255,0.6)",textDecoration:"none",transition:"color 0.2s"},onMouseEnter:o=>o.target.style.color="rgba(255,255,255,0.4)",onMouseLeave:o=>o.target.style.color="rgba(255,255,255,0.2)",children:a.label},a.label)),e.jsx("button",{onClick:r,style:{fontFamily:"'Lato', sans-serif",fontSize:11,fontWeight:400,color:"rgba(255,255,255,0.2)",textDecoration:"none",background:"none",border:"none",padding:0,cursor:"pointer",transition:"color 0.2s"},onMouseEnter:a=>a.target.style.color="rgba(255,255,255,0.4)",onMouseLeave:a=>a.target.style.color="rgba(255,255,255,0.2)",children:i==="de"?"Cookie-Einstellungen":"Çerez Ayarları"})]})]})]}),e.jsx("style",{children:`
      ...
      `})]})}function sn(){const{t:n}=T(),[i,t]=c.useState(!1);return e.jsxs("a",{href:"https://wa.me/4917661221210",target:"_blank",rel:"noopener noreferrer","aria-label":"Kontakt per WhatsApp",onMouseEnter:()=>t(!0),onMouseLeave:()=>t(!1),className:"fixed z-[200] flex items-center gap-3 bg-[#25D366] text-white no-underline rounded-full shadow-[0_6px_25px_rgba(37,211,102,0.45)] transition-all duration-300 bottom-6 right-6 md:bottom-8 md:right-8",style:{padding:i?"14px 26px":"14px 14px",transform:i?"scale(1.05)":"scale(1)"},children:[e.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor",width:22,height:22,style:{flexShrink:0},children:e.jsx("path",{d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"})}),e.jsx("span",{style:{fontFamily:"var(--font-sans)",fontSize:"12px",fontWeight:"600",letterSpacing:"0.1em",textTransform:"uppercase",whiteSpace:"nowrap",maxWidth:i?180:0,opacity:i?1:0,overflow:"hidden",transition:"max-width 0.3s ease, opacity 0.2s ease",display:"inline-block"},children:n("contact_whatsapp_btn")})]})}const $={de:{title:"Ihre Privatsphäre",subtitle:"Wir respektieren Ihre Daten",description:"Diese Website verwendet Cookies und ähnliche Technologien. Einige sind notwendig, andere helfen uns, Ihnen einen besseren Service zu bieten. Gemäß §25 TDDDG und DSGVO benötigen wir Ihre Einwilligung.",essential:"Technisch notwendig",essentialDesc:"Erforderlich für die Grundfunktionen der Website. Kann nicht deaktiviert werden.",functional:"Funktional",functionalDesc:"Ermöglicht externe Dienste wie Calendly (Terminbuchung) und WhatsApp.",analytics:"Analyse",analyticsDesc:"Hilft uns, die Nutzung der Website zu verstehen (z.B. Google Analytics). Aktuell nicht aktiv.",acceptAll:"Alle akzeptieren",rejectAll:"Nur notwendige",saveCustom:"Auswahl speichern",customize:"Anpassen",alwaysOn:"Immer aktiv",privacyLink:"Datenschutzerklärung",imprintLink:"Impressum"},tr:{title:"Gizliliğiniz",subtitle:"Verilerinize saygı duyuyoruz",description:"Bu web sitesi çerezler ve benzer teknolojiler kullanmaktadır. Bazıları zorunlu, bazıları daha iyi hizmet sunmamıza yardımcı olmaktadır. GDPR ve §25 TDDDG kapsamında onayınızı talep ediyoruz.",essential:"Teknik Zorunlu",essentialDesc:"Web sitesinin temel işlevleri için gereklidir. Devre dışı bırakılamaz.",functional:"İşlevsel",functionalDesc:"Calendly (randevu) ve WhatsApp gibi harici hizmetlere olanak tanır.",analytics:"Analitik",analyticsDesc:"Web sitesi kullanımını anlamamıza yardımcı olur (örn. Google Analytics). Şu anda aktif değil.",acceptAll:"Tümünü kabul et",rejectAll:"Yalnızca zorunlu",saveCustom:"Seçimi kaydet",customize:"Özelleştir",alwaysOn:"Her zaman aktif",privacyLink:"Gizlilik Politikası",imprintLink:"Künye"}};function ln(){const{showBanner:n,consent:i,acceptAll:t,rejectAll:r,saveCustom:s}=V(),{language:d,paths:l}=T(),a=$[d]??$.de,[o,u]=c.useState(!1),[h,g]=c.useState(i.functional),[m,x]=c.useState(i.analytics);return n?e.jsxs("div",{className:"fixed inset-0 z-[9999] flex items-end justify-center pointer-events-none",style:{paddingBottom:"0",animation:"cookieFadeIn 0.2s ease forwards"},children:[e.jsx("div",{className:"absolute inset-0 bg-black/20 pointer-events-auto"}),e.jsx("div",{className:"relative pointer-events-auto w-full max-w-4xl mx-auto bg-white shadow-2xl border-t-4 border-[#8B6E2A]",style:{maxHeight:"90vh",overflowY:"auto",animation:"cookieSlideUp 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards"},children:e.jsxs("div",{className:"p-8 lg:p-12",children:[e.jsx("div",{className:"flex items-start justify-between gap-6 mb-8",children:e.jsxs("div",{className:"flex items-start gap-5",children:[e.jsx("div",{className:"w-12 h-12 bg-[#1C3829] flex items-center justify-center shrink-0",children:e.jsx(de,{size:22,className:"text-[#8B6E2A]"})}),e.jsxs("div",{children:[e.jsx("div",{className:"flex items-center gap-3 mb-1",children:e.jsx("span",{className:"font-sans text-[10px] font-bold tracking-[0.2em] uppercase text-[#7A5F20]",children:"Doğru Kanzlei"})}),e.jsx("h2",{className:"font-serif text-2xl lg:text-3xl text-[#1C3829] font-medium leading-tight",children:a.title}),e.jsx("p",{className:"font-sans text-sm text-[#6a6a6a] mt-1",children:a.subtitle})]})]})}),e.jsx("p",{className:"font-sans text-[14px] text-[#4a4a4a] leading-relaxed mb-8 max-w-2xl",children:a.description}),e.jsxs("button",{onClick:()=>u(!o),className:"flex items-center gap-2 font-sans text-[12px] font-bold tracking-widest text-[#7A5F20] uppercase mb-6 hover:text-[#1C3829] transition-colors",children:[o?e.jsx(_e,{size:14}):e.jsx(Be,{size:14}),a.customize]}),e.jsx("div",{className:"overflow-hidden mb-8 transition-all duration-300 ease-in-out",style:{maxHeight:o?"500px":"0px",opacity:o?1:0},children:e.jsxs("div",{className:"space-y-4 border border-[#1C3829]/5 p-6 bg-[#F7F5F0]",children:[e.jsx(j,{title:a.essential,description:a.essentialDesc,checked:!0,disabled:!0,alwaysOnLabel:a.alwaysOn,onChange:()=>{}}),e.jsx(j,{title:a.functional,description:a.functionalDesc,checked:h,onChange:g}),e.jsx(j,{title:a.analytics,description:a.analyticsDesc,checked:m,onChange:x})]})}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-3 mb-6",children:[e.jsxs("button",{onClick:t,className:"flex-1 flex items-center justify-center gap-2 py-4 bg-[#1C3829] text-white font-sans text-[11px] font-bold tracking-[0.2em] uppercase hover:bg-[#8B6E2A] transition-colors",children:[e.jsx(L,{size:14}),a.acceptAll]}),o?e.jsxs("button",{onClick:()=>s(h,m),className:"flex-1 flex items-center justify-center gap-2 py-4 border border-[#1C3829] text-[#1C3829] font-sans text-[11px] font-bold tracking-[0.2em] uppercase hover:bg-[#F7F5F0] transition-colors",children:[e.jsx(L,{size:14}),a.saveCustom]}):e.jsxs("button",{onClick:r,className:"flex-1 flex items-center justify-center gap-2 py-4 border border-[#1C3829]/30 text-[#6a6a6a] font-sans text-[11px] font-bold tracking-[0.2em] uppercase hover:border-[#1C3829] hover:text-[#1C3829] transition-colors",children:[e.jsx(ue,{size:14}),a.rejectAll]})]}),e.jsxs("div",{className:"flex gap-4 font-sans text-[11px] text-[#6a6a6a]",children:[e.jsx(v,{to:l.datenschutz,className:"hover:text-[#7A5F20] transition-colors underline-offset-2 hover:underline",onClick:r,children:a.privacyLink}),e.jsx("span",{children:"·"}),e.jsx(v,{to:l.impressum,className:"hover:text-[#7A5F20] transition-colors underline-offset-2 hover:underline",onClick:r,children:a.imprintLink})]})]})}),e.jsx("style",{children:`
...
`;function yn(n){c.useEffect(()=>{const i=n.current;if(!i)return;const t=i.querySelectorAll(".fade-in-card"),r=new IntersectionObserver(s=>{s.forEach(d=>{d.isIntersecting&&(d.target.classList.add("visible"),r.unobserve(d.target))})},{threshold:.1});return t.forEach(s=>r.observe(s)),()=>r.disconnect()},[n])}function vn(){const{t:n,language:i,paths:t}=T(),r=c.useRef(null);yn(r);const s=S.find(u=>u.id==="migrationsrecht"),d=S.find(u=>u.id==="tanima-ve-tenfiz"),l=S.find(u=>u.id==="strafrecht"),a=S.find(u=>u.id==="erbrecht"),o=S.find(u=>u.id==="sorgerecht");return e.jsxs("section",{id:"hizmetler",className:"bg-[#FDFCFB] py-16 md:py-24 px-6",children:[e.jsx("style",{children:bn}),e.jsxs("div",{className:"max-w-[1200px] mx-auto",children:[e.jsxs("div",{className:"flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16",children:[e.jsxs("div",{className:"max-w-xl",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-6",children:[e.jsx("div",{className:"w-8 h-[1px] bg-[#8B6E2A]"}),e.jsx("span",{className:"font-sans text-[9px] font-bold tracking-[0.25em] text-[#7A5F20] uppercase",children:n("practice_badge")})]}),e.jsxs("h2",{className:"font-serif text-4xl md:text-5xl text-[#1C3829] leading-tight",children:[n("practice_title")," ",e.jsx("br",{})," ",e.jsx("em",{className:"italic font-normal",children:n("practice_subtitle")})]})]}),e.jsxs(v,{to:t.services,className:"group inline-flex items-center gap-3 font-sans text-[10px] font-bold tracking-[0.2em] text-[#1C3829] uppercase border-b border-black/10 pb-1 hover:border-[#8B6E2A] transition-all",children:[n("practice_view_all")," ",e.jsx(Re,{size:14,className:"group-hover:translate-x-1 transition-transform"})]})]}),e.jsxs("div",{ref:r,className:"grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 auto-rows-[minmax(260px,auto)]",children:[d&&e.jsx(v,{to:t.service(d.id),className:"md:col-span-3 group block",children:e.jsxs("div",{className:"fade-in-card h-full bg-white p-10 md:p-14 border-l-[3px] border-[#8B6E2A] flex flex-col justify-center relative transition-all duration-500 hover:shadow-xl hover:shadow-black/[0.02] overflow-hidden",children:[e.jsxs("div",{className:"md:hidden absolute inset-0 z-0","aria-hidden":"true",children:[e.jsx("img",{src:cn,alt:i==="tr"?"Tanıma ve Tenfiz hizmeti görseli":"Anerkennung und Vollstreckung Dienstleistungsbild",width:600,height:400,loading:"lazy",decoding:"async",className:"w-full h-full object-cover opacity-60"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-[#1C3829] via-[#1C3829]/70 to-transparent"})]}),e.jsxs("div",{className:"relative z-10",children:[e.jsx("div",{className:"mb-8",children:(()=>{const u=d.icon;return u?e.jsx(u,{size:32,strokeWidth:1,className:"text-[#8B6E2A]","aria-hidden":"true"}):null})()}),e.jsx("h3",{className:"font-serif text-3xl md:text-4xl text-white md:text-[#1C3829] mb-6",children:i==="tr"?d.titleTR:d.title}),e.jsx("p",{className:"font-sans text-[15px] text-white/90 md:text-[#6a6a6a] leading-relaxed font-light max-w-2xl",children:i==="tr"?d.description:d.descriptionDE}),e.jsx("div",{className:"absolute bottom-10 right-10 text-white md:text-[#1C3829] opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:translate-x-1",children:e.jsx(A,{size:20,"aria-hidden":"true"})})]})]})}),s&&e.jsx(v,{to:t.service(s.id),className:"md:col-span-1 group block",children:e.jsxs("div",{className:"fade-in-card h-full bg-[#F2F2F0] p-8 flex flex-col justify-center relative transition-all duration-500 hover:bg-[#ebebe9] overflow-hidden",children:[e.jsxs("div",{className:"md:hidden absolute inset-0 z-0","aria-hidden":"true",children:[e.jsx("img",{src:mn,alt:"",width:600,height:400,loading:"lazy",decoding:"async",className:"w-full h-full object-cover opacity-60"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-[#1C3829] via-[#1C3829]/70 to-transparent"})]}),e.jsxs("div",{className:"relative z-10",children:[e.jsx("h3",{className:"font-serif text-xl text-white md:text-[#1C3829] mb-4",children:i==="tr"?s.titleTR:s.title}),e.jsx("p",{className:"font-sans text-[13px] text-white/90 md:text-[#6a6a6a] leading-relaxed font-light line-clamp-4",children:i==="tr"?s.description:s.descriptionDE}),e.jsx("div",{className:"mt-6 text-white md:text-[#1C3829] group-hover:text-[#B8963E] transition-all duration-500 group-hover:translate-x-1",children:e.jsx(A,{size:18,strokeWidth:1,"aria-hidden":"true"})})]})]})}),a&&e.jsx(v,{to:t.service(a.id),className:"md:col-span-1 group block",children:e.jsxs("div",{className:"fade-in-card h-full bg-[#F2F2F0] p-8 flex flex-col justify-center relative transition-all duration-500 hover:bg-[#ebebe9] overflow-hidden",children:[e.jsxs("div",{className:"md:hidden absolute inset-0 z-0","aria-hidden":"true",children:[e.jsx("img",{src:kn,alt:"",width:600,height:400,loading:"lazy",decoding:"async",className:"w-full h-full object-cover opacity-60"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-[#1C3829] via-[#1C3829]/70 to-transparent"})]}),e.jsxs("div",{className:"relative z-10",children:[e.jsx("h3",{className:"font-serif text-xl text-white md:text-[#1C3829] mb-4",children:i==="tr"?a.titleTR:a.title}),e.jsx("p",{className:"font-sans text-[13px] text-white/90 md:text-[#6a6a6a] leading-relaxed font-light line-clamp-4",children:i==="tr"?a.description:a.descriptionDE}),e.jsx("div",{className:"mt-6 text-white md:text-[#1C3829] group-hover:text-[#B8963E] transition-all duration-500 group-hover:translate-x-1",children:e.jsx(A,{size:18,strokeWidth:1,"aria-hidden":"true"})})]})]})}),o&&e.jsx(v,{to:t.service(o.id),className:"md:col-span-1 group block",children:e.jsxs("div",{className:"fade-in-card h-full bg-[#F2F2F0] p-8 flex flex-col justify-center relative transition-all duration-500 hover:bg-[#ebebe9] overflow-hidden",children:[e.jsxs("div",{className:"md:hidden absolute inset-0 z-0","aria-hidden":"true",children:[e.jsx("img",{src:gn,alt:"",width:600,height:400,loading:"lazy",decoding:"async",className:"w-full h-full object-cover opacity-60"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-[#1C3829] via-[#1C3829]/70 to-transparent"})]}),e.jsxs("div",{className:"relative z-10",children:[e.jsx("h3",{className:"font-serif text-xl text-white md:text-[#1C3829] mb-4",children:i==="tr"?o.titleTR:o.title}),e.jsx("p",{className:"font-sans text-[13px] text-white/90 md:text-[#6a6a6a] leading-relaxed font-light line-clamp-4",children:i==="tr"?o.description:o.descriptionDE}),e.jsx("div",{className:"mt-6 text-white md:text-[#1C3829] group-hover:text-[#B8963E] transition-all duration-500 group-hover:translate-x-1",children:e.jsx(A,{size:18,strokeWidth:1,"aria-hidden":"true"})})]})]})}),l&&e.jsx(v,{to:t.service(l.id),className:"md:col-span-2 group block",children:e.jsxs("div",{className:"fade-in-card h-full bg-[#1C3829] p-10 md:p-12 flex flex-col justify-center relative overflow-hidden transition-all duration-500 hover:brightness-110",children:[e.jsx("div",{className:"absolute right-[-20px] bottom-[-20px] opacity-[0.03] text-white pointer-events-none hidden md:block",children:(()=>{const u=l.icon;return u?e.jsx(u,{size:200,strokeWidth:.5,"aria-hidden":"true"}):null})()}),e.jsxs("div",{className:"md:hidden absolute inset-0 z-0","aria-hidden":"true",children:[e.jsx("img",{src:fn,alt:"",width:600,height:400,loading:"lazy",decoding:"async",className:"w-full h-full object-cover opacity-60"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-[#1C3829] via-[#1C3829]/70 to-transparent"})]}),e.jsxs("div",{className:"relative z-10",children:[e.jsx("h3",{className:"font-serif text-2xl md:text-3xl text-white mb-6",children:i==="tr"?l.titleTR:l.title}),e.jsx("p",{className:"font-sans text-[14px] text-white/70 leading-relaxed font-light max-w-md",children:i==="tr"?l.description:l.descriptionDE}),e.jsxs("div",{className:"mt-8 inline-flex items-center gap-3 text-[#B8963E] font-sans text-[9px] font-bold tracking-widest uppercase hover:text-white transition-all duration-500 group-hover:translate-x-1",children:[n("practice_view_detail")," ",e.jsx(A,{size:14,"aria-hidden":"true"})]})]})]})})]})]})]})}function pn(){const{t:n}=T(),i=[{icon:je,title:n("why_us_point_01_title"),description:n("why_us_point_01_desc")},{icon:Me,title:n("why_us_point_02_title"),description:n("why_us_point_02_desc")},{icon:Ie,title:n("why_us_point_03_title"),description:n("why_us_point_03_desc")},{icon:oe,title:n("why_us_point_04_title"),description:n("why_us_point_04_desc")}];return e.jsxs("section",{id:"neden-biz",className:"whyus-section",style:{background:"#1C3829",position:"relative",overflow:"hidden"},children:[e.jsx("div",{style:{position:"absolute",top:0,right:0,width:400,height:400,borderRadius:"50%",background:"radial-gradient(circle, rgba(184,150,62,0.07) 0%, transparent 70%)",transform:"translate(30%, -30%)",pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",bottom:0,left:0,width:300,height:300,borderRadius:"50%",background:"radial-gradient(circle, rgba(184,150,62,0.05) 0%, transparent 70%)",transform:"translate(-30%, 30%)",pointerEvents:"none"}}),e.jsxs("div",{style:{maxWidth:1100,margin:"0 auto",position:"relative"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:64},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:12,marginBottom:20},children:[e.jsx("div",{style:{width:32,height:1,background:"#B8963E"}}),e.jsx("span",{style:{fontFamily:"var(--font-sans)",fontSize:10,fontWeight:800,letterSpacing:"0.22em",color:"#B8963E",textTransform:"uppercase"},children:n("why_us_badge")}),e.jsx("div",{style:{width:32,height:1,background:"#B8963E"}})]}),e.jsxs("h2",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:"clamp(32px, 3.5vw, 44px)",fontWeight:500,color:"#ffffff",lineHeight:1.15,margin:"0 0 20px",textAlign:"center"},children:[n("why_us_title"),e.jsx("br",{}),e.jsx("em",{style:{fontStyle:"italic",fontWeight:400},children:n("why_us_subtitle")})]}),e.jsx("p",{style:{fontFamily:"var(--font-sans)",fontSize:15,fontWeight:500,color:"rgba(255,255,255,0.85)",lineHeight:1.8,maxWidth:500,margin:"0 auto"},children:n("why_us_description")})]}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gap:2},className:"why-grid",children:i.map((t,r)=>{const s=t.icon;return e.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.06)",padding:"44px 40px",position:"relative",transition:"background 0.3s, border-color 0.3s"},className:`why-item-${r+1}`,onMouseEnter:d=>{d.currentTarget.style.background="rgba(255,255,255,0.06)",d.currentTarget.style.borderColor="rgba(184,150,62,0.3)"},onMouseLeave:d=>{d.currentTarget.style.background="rgba(255,255,255,0.03)",d.currentTarget.style.borderColor="rgba(255,255,255,0.06)"},children:[e.jsx("div",{style:{position:"absolute",top:28,right:32,fontFamily:"'Cormorant Garamond', serif",fontSize:14,fontWeight:300,color:"rgba(255,255,255,0.85)",lineHeight:1,userSelect:"none"},children:String(r+1).padStart(2,"0")}),e.jsx("div",{style:{width:52,height:52,border:"1px solid rgba(184,150,62,0.35)",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:28},children:e.jsx(s,{size:22,style:{color:"#B8963E",strokeWidth:1.5}})}),e.jsx("h3",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:26,fontWeight:600,color:"#ffffff",lineHeight:1.2,marginBottom:16},children:t.title}),e.jsx("p",{style:{fontFamily:"var(--font-sans)",fontSize:14,fontWeight:500,color:"rgba(255,255,255,0.8)",lineHeight:1.8,margin:0},children:t.description})]},t.title)})})]}),e.jsx("style",{children:`
      ...
      `})]})}const D=[5,1,2,3,4,6];function zn(){const{t:n}=T(),[i,t]=c.useState(0),r=()=>t(l=>l===0?D.length-1:l-1),s=()=>t(l=>l===D.length-1?0:l+1),d=D[i];return e.jsxs("section",{className:"testimonials-section",style:{background:"#F7F5F0"},children:[e.jsxs("div",{style:{maxWidth:1100,margin:"0 auto"},children:[e.jsxs("div",{style:{marginBottom:64},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12,marginBottom:20},children:[e.jsx("div",{style:{width:32,height:1,background:"#B8963E"}}),e.jsx("span",{style:{fontFamily:"var(--font-sans)",fontSize:14,fontWeight:500,letterSpacing:"0.22em",color:"#B8963E",textTransform:"uppercase"},children:n("testimonials_badge")})]}),e.jsxs("h2",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:"clamp(32px, 3.5vw, 44px)",fontWeight:500,color:"#1C3829",lineHeight:1.15,margin:0},children:[n("testimonials_title"),e.jsx("br",{}),e.jsx("em",{style:{fontStyle:"italic",fontWeight:400},children:n("testimonials_subtitle")})]})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 2fr",gap:64,alignItems:"center"},className:"testimonial-grid",children:[e.jsxs("div",{className:"testimonial-nav",children:[e.jsx("div",{className:"testimonial-nav-list",style:{marginBottom:40},children:D.map((l,a)=>e.jsxs("button",{onClick:()=>t(a),className:`testimonial-nav-button ${a===i?"active":""}`,style:{display:"block",width:"100%",background:"none",border:"none",borderLeft:`2px solid ${a===i?"#B8963E":"#d4cfc6"}`,padding:"12px 20px",textAlign:"left",cursor:"pointer",marginBottom:4,transition:"border-color 0.2s"},children:[e.jsx("div",{style:{fontFamily:"var(--font-sans)",fontSize:13,fontWeight:a===i?700:500,color:a===i?"#1C3829":"#9a9a8a",transition:"color 0.2s, font-weight 0.2s"},children:n(`testimonial_${l}_name`)}),e.jsx("div",{style:{fontFamily:"var(--font-sans)",fontSize:11,color:a===i?"#B8963E":"#bbb8b0",marginTop:2,transition:"color 0.2s"},children:n(`testimonial_${l}_area`)})]},l))}),e.jsxs("div",{className:"testimonial-nav-controls",style:{display:"flex",gap:8},children:[e.jsx("button",{onClick:r,"aria-label":"Vorheriges Testimonial",style:{width:44,height:44,border:"1px solid #d4cfc6",background:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"border-color 0.2s, background 0.2s"},onMouseEnter:l=>{var a;l.currentTarget.style.borderColor="#1C3829",l.currentTarget.style.background="#1C3829",(a=l.currentTarget.querySelector("svg"))==null||a.setAttribute("color","#fff")},onMouseLeave:l=>{var a;l.currentTarget.style.borderColor="#d4cfc6",l.currentTarget.style.background="none",(a=l.currentTarget.querySelector("svg"))==null||a.setAttribute("color","#1C3829")},children:e.jsx(Ke,{size:18,color:"#1C3829"})}),e.jsx("button",{onClick:s,"aria-label":"Nächstes Testimonial",style:{width:44,height:44,border:"1px solid #d4cfc6",background:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"border-color 0.2s, background 0.2s"},onMouseEnter:l=>{var a;l.currentTarget.style.borderColor="#1C3829",l.currentTarget.style.background="#1C3829",(a=l.currentTarget.querySelector("svg"))==null||a.setAttribute("color","#fff")},onMouseLeave:l=>{var a;l.currentTarget.style.borderColor="#d4cfc6",l.currentTarget.style.background="none",(a=l.currentTarget.querySelector("svg"))==null||a.setAttribute("color","#1C3829")},children:e.jsx(He,{size:18,color:"#1C3829"})})]})]}),e.jsxs("div",{className:"testimonial-active-card",style:{background:"#ffffff",position:"relative",borderLeft:"3px solid #B8963E"},children:[e.jsx("div",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:120,fontWeight:400,color:"#f0ece4",lineHeight:.7,marginBottom:24,userSelect:"none"},children:'"'}),e.jsx("div",{style:{display:"flex",gap:4,marginBottom:24},children:Array.from({length:5}).map((l,a)=>e.jsx(Ne,{size:14,style:{fill:"#B8963E",color:"#B8963E"}},a))}),e.jsxs("p",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:"clamp(20px, 2.5vw, 22px)",fontWeight:400,fontStyle:"italic",color:"#2a2a2a",lineHeight:1.6,marginBottom:36},children:['"',n(`testimonial_${d}_text`),'"']}),e.jsxs("div",{style:{borderTop:"1px solid #f0ece4",paddingTop:24},children:[e.jsx("div",{style:{fontFamily:"var(--font-sans)",fontSize:13,fontWeight:700,color:"#1C3829",letterSpacing:"0.04em"},children:n(`testimonial_${d}_name`)}),e.jsx("div",{style:{fontFamily:"'Lato', sans-serif",fontSize:13,fontWeight:600,color:"#555555",marginTop:4,letterSpacing:"0.06em"},children:n(`testimonial_${d}_area`)})]})]},i)]})]}),e.jsx("style",{children:`
      ...
      `})]})}function xn(){const{t:n,language:i}=T(),{consent:t,openSettings:r}=V(),s=[{city:"Mannheim",country:i==="tr"?"Almanya":"Deutschland",address:`R1 2,3
...
Çankaya / Ankara, Türkiye`,phone:"+905332375918",emails:["info@hasandogru.de","Avukat.hasandogru@outlook.de"],hours:i==="tr"?"Pzt–Cum: 09:00 – 18:00":"Mo–Fr: 09:00 – 18:00",mapLink:"https://www.google.com/maps/search/?api=1&query=Aşağı+Öveçler+Mahallesi+1322+Cadde+45/9+Çankaya+Ankara+Türkiye"}];return e.jsxs("section",{id:"iletisim",className:"contact-section",style:{background:"#ffffff"},children:[e.jsxs("div",{style:{maxWidth:1100,margin:"0 auto"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:80},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:12,marginBottom:20},children:[e.jsx("div",{style:{width:32,height:1,background:"#B8963E"}}),e.jsx("span",{style:{fontFamily:"var(--font-sans)",fontSize:14,fontWeight:500,letterSpacing:"0.22em",color:"#B8963E",textTransform:"uppercase"},children:n("contact_badge")}),e.jsx("div",{style:{width:32,height:1,background:"#B8963E"}})]}),e.jsxs("h2",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:"clamp(32px, 4vw, 52px)",fontWeight:500,color:"#1C3829",lineHeight:1.1,margin:"0 0 16px"},children:[n("contact_title"),e.jsx("br",{}),e.jsx("em",{style:{fontStyle:"italic",fontWeight:400},children:n("contact_subtitle")})]}),e.jsx("p",{style:{fontFamily:"var(--font-sans)",fontSize:16,color:"#6a6a6a",lineHeight:1.8,maxWidth:600,margin:"0 auto"},children:n("contact_description")})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:64,alignItems:"start"},className:"contact-grid",children:[e.jsxs("div",{style:{background:"#F7F5F0",padding:48,borderLeft:"4px solid #B8963E"},children:[e.jsx("h3",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:32,color:"#1C3829",marginBottom:16},children:n("contact_direct_title")}),e.jsx("p",{style:{fontFamily:"var(--font-sans)",fontSize:15,color:"#6a6a6a",marginBottom:40,lineHeight:1.6},children:n("contact_direct_p")}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16},children:[t.functional?e.jsxs("a",{href:"https://calendly.com/hasand9366/30min",target:"_blank",rel:"noopener noreferrer","aria-label":n("contact_calendly_btn"),style:{display:"flex",alignItems:"center",justifyContent:"center",gap:12,background:"#1C3829",color:"#ffffff",padding:"18px 32px",fontFamily:"var(--font-sans)",fontSize:13,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",textDecoration:"none",transition:"all 0.3s ease"},onMouseEnter:a=>a.currentTarget.style.background="#8B6E2A",onMouseLeave:a=>a.currentTarget.style.background="#1C3829",children:[e.jsx(P,{size:18}),n("contact_calendly_btn")]}):e.jsxs("button",{onClick:r,"aria-label":"Cookie-Einstellungen öffnen",style:{display:"flex",alignItems:"center",justifyContent:"center",gap:12,background:"#e8e4dc",color:"#6a6a6a",padding:"18px 32px",fontFamily:"var(--font-sans)",fontSize:13,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",border:"none",cursor:"pointer",width:"100%"},children:[e.jsx(Ve,{size:18}),i==="de"?"Cookie-Einwilligung erforderlich":"Çerez izni gerekli"]}),e.jsxs("a",{href:"https://wa.me/4917661221210",target:"_blank",rel:"noopener noreferrer","aria-label":"Kontakt per WhatsApp",style:{display:"flex",alignItems:"center",justifyContent:"center",gap:12,background:"#ffffff",border:"1px solid #1C3829",color:"#1C3829",padding:"18px 32px",fontFamily:"var(--font-sans)",fontSize:13,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",textDecoration:"none",transition:"all 0.3s ease"},onMouseEnter:a=>{a.currentTarget.style.background="#1C3829",a.currentTarget.style.color="#ffffff"},onMouseLeave:a=>{a.currentTarget.style.background="#ffffff",a.currentTarget.style.color="#1C3829"},children:[e.jsx(B,{size:18}),n("contact_whatsapp_btn")]})]}),e.jsxs("div",{style:{marginTop:48,borderTop:"1px solid #d4cfc6",paddingTop:32},children:[e.jsx("div",{style:{fontFamily:"var(--font-sans)",fontSize:11,fontWeight:700,color:"#B8963E",letterSpacing:"0.14em",textTransform:"uppercase",marginBottom:16},children:n("contact_languages_badge")}),e.jsx("div",{style:{display:"flex",gap:12},children:["Türkçe","Deutsch","English"].map(a=>e.jsx("span",{style:{fontFamily:"'Lato', sans-serif",fontSize:13,color:"#1C3829",background:"#ffffff",padding:"6px 16px",border:"1px solid #e0ddd5"},children:a},a))})]})]}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr",gap:32},children:s.map((a,o)=>e.jsxs("div",{style:{paddingBottom:o===0?32:0,borderBottom:o===0?"1px solid #f0ece4":"none"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"baseline",gap:10,marginBottom:16},children:[e.jsx("h4",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:24,fontWeight:500,color:"#1C3829",margin:0},children:a.city}),e.jsx("span",{style:{fontFamily:"'Lato', sans-serif",fontSize:11,color:"#B8963E",textTransform:"uppercase",letterSpacing:"0.1em"},children:a.country})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16},children:[e.jsxs("div",{style:{display:"flex",gap:12},children:[e.jsx(M,{size:16,color:"#B8963E",style:{flexShrink:0,marginTop:4}}),e.jsx("div",{style:{fontFamily:"'Lato', sans-serif",fontSize:14,color:"#6a6a6a",lineHeight:1.6,whiteSpace:"pre-line"},children:a.address})]}),e.jsxs("div",{style:{display:"flex",gap:12},children:[e.jsx(B,{size:16,color:"#B8963E",style:{flexShrink:0}}),e.jsx("a",{href:`tel:${a.phone.replace(/\s/g,"")}`,style:{fontFamily:"'Lato', sans-serif",fontSize:14,color:"#4a4a4a",textDecoration:"none",fontWeight:500},children:a.phone})]}),e.jsxs("div",{style:{display:"flex",gap:12},children:[e.jsx(he,{size:16,color:"#B8963E",style:{flexShrink:0}}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:a.emails.map(u=>e.jsx("a",{href:`mailto:${u}`,style:{fontFamily:"'Lato', sans-serif",fontSize:14,color:"#4a4a4a",textDecoration:"none",transition:"color 0.2s ease"},onMouseEnter:h=>h.currentTarget.style.color="#B8963E",onMouseLeave:h=>h.currentTarget.style.color="#4a4a4a",children:u},u))})]}),e.jsxs("div",{style:{display:"flex",gap:12},children:[e.jsx(P,{size:16,color:"#B8963E",style:{flexShrink:0}}),e.jsx("div",{style:{fontFamily:"'Lato', sans-serif",fontSize:14,color:"#6a6a6a"},children:a.hours})]})]})]},o))})]})]}),e.jsx("style",{children:`
        .contact-section {
          padding: 120px 32px;
        }
      ...
      `})]})}const I="https://www.hasandogru.de";function b(n,i,t=!1){const r=t?"name":"property";let s=document.querySelector(`meta[${r}="${n}"]`);s||(s=document.createElement("meta"),s.setAttribute(r,n),document.head.appendChild(s)),s.content=i}function _(n,i,t={}){const r=Object.entries(t).map(([d,l])=>`[${d}="${l}"]`).join("");let s=document.querySelector(`link[rel="${n}"]${r}`);s||(s=document.createElement("link"),s.rel=n,Object.entries(t).forEach(([d,l])=>s.setAttribute(d,l)),document.head.appendChild(s)),s.href=i}function An(n){c.useEffect(()=>{var d;document.title=n.title,b("description",n.description,!0);const i=n.canonical||window.location.origin+window.location.pathname;_("canonical",i),b("og:title",n.title),b("og:description",n.description),b("og:url",i),b("og:type",n.ogType||"website"),b("og:locale",n.lang==="de"?"de_DE":"tr_TR"),b("og:locale:alternate",n.lang==="de"?"tr_TR":"de_DE"),b("og:site_name","Doğru Kanzlei");const t=`${I}/logo.png`,r=n.ogImage||t;b("og:image",r),b("twitter:card","summary_large_image",!0),b("twitter:title",n.title,!0),b("twitter:description",n.description,!0),b("twitter:image",r,!0),n.lang,n.alternateLang&&(_("alternate",n.alternateLang.href,{hreflang:n.alternateLang.lang}),_("alternate",i,{hreflang:n.lang}));const s=n.xDefault||(n.lang==="de"?i:(d=n.alternateLang)==null?void 0:d.href);s&&_("alternate",s,{hreflang:"x-default"}),n.noindex?b("robots","noindex, nofollow",!0):b("robots","index, follow",!0)},[n.title,n.description,n.canonical,n.ogImage,n.ogType,n.lang,n.alternateLang,n.noindex])}function ee(){const{language:n}=T();return An({title:n==="de"?"Avukat Hasan Doğru | Doğru Kanzlei Mannheim":"Avukat Hasan Doğru | Türk Hukuku Uzmanı Mannheim",description:n==="de"?"Avukat Hasan Doğru für türkisches und deutsches Recht in Mannheim. Spezialisiert auf Familienrecht, Erbrecht, Mietrecht und grenzüberschreitende Rechtsberatung. Professionelle Rechtsberatung.":"Mannheim'da Türk ve Alman hukuku alanında uzman avukatlık bürosu. Aile hukuku, miras hukuku, kira hukuku ve uluslararası hukuki danışmanlık. Profesyonel hukuki danışmanlık.",lang:n,canonical:`${I}/${n}`,alternateLang:{lang:n==="de"?"tr":"de",href:`${I}/${n==="de"?"tr":"de"}`}}),e.jsxs(e.Fragment,{children:[e.jsx(hn,{}),e.jsx(vn,{}),e.jsx(pn,{}),e.jsx(zn,{}),e.jsx(Tn,{}),e.jsx(xn,{})]})}const ne=c.lazy(()=>w(()=>import("./Hizmetler-DmLufXp9.js"),__vite__mapDeps([0,1,2,3])).then(n=>({default:n.Hizmetler}))),ae=c.lazy(()=>w(()=>import("./ServiceDetail-vP1_pmSb.js"),__vite__mapDeps([4,1,2,3])).then(n=>({default:n.ServiceDetail}))),ie=c.lazy(()=>w(()=>import("./BlogPage-qAanSTiR.js"),__vite__mapDeps([5,1,2,3])).then(n=>({default:n.BlogPage}))),re=c.lazy(()=>w(()=>import("./BlogPost-CFdpXPse.js"),__vite__mapDeps([6,1,2,3])).then(n=>({default:n.BlogPost}))),te=c.lazy(()=>w(()=>import("./Datenschutz-DtXxxakD.js"),__vite__mapDeps([7,1,2,3])).then(n=>({default:n.Datenschutz}))),se=c.lazy(()=>w(()=>import("./Impressum-C_JAszHM.js"),__vite__mapDeps([8,1,2,3])).then(n=>({default:n.Impressum}))),le=c.lazy(()=>w(()=>import("./AboutPage-BfBCvXt_.js"),__vite__mapDeps([9,1,2,3])).then(n=>({default:n.AboutPage}))),wn=c.lazy(()=>w(()=>import("./NotFound-B4HgYd1J.js"),__vite__mapDeps([10,1,2,3])).then(n=>({default:n.NotFound}))),y=n=>i=>e.jsx(c.Suspense,{fallback:e.jsx("div",{className:"min-h-screen bg-[#1C3829]"}),children:e.jsx(n,{...i})}),Sn=ze([{path:"/",loader:()=>f("/de")},{path:"/familienrecht",loader:()=>f("/de/leistungen/familienrecht")},{path:"/erbrecht",loader:()=>f("/de/leistungen/erbrecht")},{path:"/immobilienrecht",loader:()=>f("/de/leistungen/immobilienrecht")},{path:"/scheidungsverfahren",loader:()=>f("/de/leistungen")},{path:"/schuldrecht",loader:()=>f("/de/leistungen")},{path:"/mietrecht",loader:()=>f("/de/leistungen")},{path:"/kontakt",loader:()=>f("/de/#iletisim")},{path:"/meine-vision",loader:()=>f("/de/#hakkimizda")},{path:"/blog",loader:()=>f("/de/blog")},{path:"/blogartikel",loader:()=>f("/de/blog")},{path:"/datenschutz",loader:()=>f("/de/datenschutz")},{path:"/impressum",loader:()=>f("/de/impressum")},{path:"/book-online",loader:()=>f("/de/#iletisim")},{path:"/treffen",loader:()=>f("/de/#iletisim")},{path:"/schlüsselthemen",loader:()=>f("/de/leistungen")},{path:"/de",Component:X,children:[{index:!0,Component:ee},{path:"leistungen",Component:y(ne)},{path:"leistungen/:id",Component:y(ae)},{path:"blog",Component:y(ie)},{path:"blog/:slug",Component:y(re)},{path:"datenschutz",Component:y(te)},{path:"impressum",Component:y(se)},{path:"ueber-uns",Component:y(le)}]},{path:"/tr",Component:X,children:[{index:!0,Component:ee},{path:"hizmetler",Component:y(ne)},{path:"hizmetler/:id",Component:y(ae)},{path:"blog",Component:y(ie)},{path:"blog/:slug",Component:y(re)},{path:"gizlilik-politikasi",Component:y(te)},{path:"yasal-bilgiler",Component:y(se)},{path:"hakkimizda",Component:y(le)}]},{path:"*",Component:y(wn)}]);function En(){return e.jsx(Te,{router:Sn})}Ce.createRoot(document.getElementById("root")).render(e.jsx(En,{}));setTimeout(()=>{document.dispatchEvent(new Event("render-event"))},3e3);export{I as S,An as a,N as b,S as s,T as u};
